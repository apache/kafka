...
public class RecordProcessor extends Thread implements ConsumerRebalanceListener {
    ...
    public RecordProcessor(String threadName,
        ...
        // consumer can optionally set groupInstanceId to avoid unnecessary rebalances
    ...
    public void run() {
        ...
        KafkaProducer<Integer, String> producer = new Producer(
            "processor-producer", bootstrapServers, outputTopic, true, transactionalId, true, -1, transactionTimeoutMs, null)
                .createKafkaProducer();
