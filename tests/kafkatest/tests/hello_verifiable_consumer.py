...
from kafkatest.services.verifiable_consumer import VerifiableConsumer, TopicPartition
...
class HelloVerifiableConsumerTest(KafkaTest):
    ...
    def _setup_consumer(self, topic):
        return VerifiableConsumer(self.test_context, self.num_consumers, self.kafka,
                                  topic, self.GROUP_ID, session_timeout=10000)
    ...
    def test_consumer_failure(self):
        ...
        consumer.kill_consumer(partition_owner)
        time.sleep(10)
