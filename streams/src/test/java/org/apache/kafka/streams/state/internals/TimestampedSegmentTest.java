...
public class TimestampedSegmentTest {
    ...
    public void shouldDeleteStateDirectoryOnDestroy() throws Exception {
        final TimestampedSegment segment = new TimestampedSegment("segment", "window", 0L, SynchronizedPosition.emptyPosition(), metricsRecorder);
    ...
    public void shouldBeEqualIfIdIsEqual() {
        final TimestampedSegment segment = new TimestampedSegment("anyName", "anyName", 0L, SynchronizedPosition.emptyPosition(), metricsRecorder);
        final TimestampedSegment segmentSameId =
            new TimestampedSegment("someOtherName", "someOtherName", 0L, SynchronizedPosition.emptyPosition(), metricsRecorder);
        final TimestampedSegment segmentDifferentId =
            new TimestampedSegment("anyName", "anyName", 1L, SynchronizedPosition.emptyPosition(), metricsRecorder);
    ...
    public void shouldCompareSegmentIdOnly() {
        final TimestampedSegment segment1 = new TimestampedSegment("a", "C", 50L, SynchronizedPosition.emptyPosition(), metricsRecorder);
        final TimestampedSegment segment2 = new TimestampedSegment("b", "B", 100L, SynchronizedPosition.emptyPosition(), metricsRecorder);
        final TimestampedSegment segment3 = new TimestampedSegment("c", "A", 0L, SynchronizedPosition.emptyPosition(), metricsRecorder);
