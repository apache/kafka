...
public class AbstractCoordinatorTest {
    ...
    private void setupCoordinator(long retryBackoffMs) {
        ...
        this.consumerClient = new ConsumerNetworkClient(new KafkaLoggerFactory(), mockClient, metadata, mockTime,
    ...
    public static class DummyCoordinator extends AbstractCoordinator {
        ...
        public DummyCoordinator(ConsumerNetworkClient client,
                                Metrics metrics,
                                Time time) {
            super(new KafkaLoggerFactory(), client, GROUP_ID, REBALANCE_TIMEOUT_MS, SESSION_TIMEOUT_MS,
