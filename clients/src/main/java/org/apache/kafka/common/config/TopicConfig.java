...
public class TopicConfig {
    ...
    public static final String REMOTE_LOG_DISABLE_POLICY_DOC = "Determines whether tiered data for a topic should be retained or " +
            "deleted after tiered storage disablement on a topic. The two valid options are \"retain\" and \"delete\". If retain is " +
