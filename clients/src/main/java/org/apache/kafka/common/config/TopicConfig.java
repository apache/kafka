...
public class TopicConfig {
    ...
    public static final String MESSAGE_FORMAT_VERSION_DOC = "[DEPRECATED] Specify the message format version the broker " +
        ...
        "particular message format version, the user is certifying that all the existing messages on disk are smaller or equal " +
        "than the specified version. Setting this value incorrectly will cause consumers with older versions to break as " +
