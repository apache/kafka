...
public class RepartitionOptimizingIntegrationTest {
    ...
    private static final String EXPECTED_OPTIMIZED_TOPOLOGY = "Topologies:\n"
                                                              ...
                                                              + "    TypedProcessor: KSTREAM-MAP-0000000001 (stores: [])\n"
                                                              + "      --> KSTREAM-FILTER-0000000002, KSTREAM-FILTER-0000000040\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000000\n"
                                                              + "    TypedProcessor: KSTREAM-FILTER-0000000002 (stores: [])\n"
                                                              + "      --> KSTREAM-MAPVALUES-0000000003\n"
                                                              + "      <-- KSTREAM-MAP-0000000001\n"
                                                              + "    TypedProcessor: KSTREAM-FILTER-0000000040 (stores: [])\n"
                                                              + "      --> KSTREAM-SINK-0000000039\n"
                                                              + "      <-- KSTREAM-MAP-0000000001\n"
                                                              + "    TypedProcessor: KSTREAM-MAPVALUES-0000000003 (stores: [])\n"
                                                              + "      --> KSTREAM-PROCESSOR-0000000004\n"
                                                              + "      <-- KSTREAM-FILTER-0000000002\n"
                                                              + "    TypedProcessor: KSTREAM-PROCESSOR-0000000004 (stores: [])\n"
                                                              + "      --> none\n"
                                                              + "      <-- KSTREAM-MAPVALUES-0000000003\n"
                                                              ...
                                                              + "    TypedProcessor: KSTREAM-AGGREGATE-0000000007 (stores: [KSTREAM-AGGREGATE-STATE-STORE-0000000006])\n"
                                                              + "      --> KTABLE-TOSTREAM-0000000011\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000041\n"
                                                              + "    TypedProcessor: KTABLE-TOSTREAM-0000000011 (stores: [])\n"
                                                              + "      --> KSTREAM-SINK-0000000012, KSTREAM-WINDOWED-0000000034\n"
                                                              + "      <-- KSTREAM-AGGREGATE-0000000007\n"
                                                              + "    TypedProcessor: KSTREAM-FILTER-0000000020 (stores: [])\n"
                                                              + "      --> KSTREAM-PEEK-0000000021\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000041\n"
                                                              + "    TypedProcessor: KSTREAM-FILTER-0000000029 (stores: [])\n"
                                                              + "      --> KSTREAM-WINDOWED-0000000033\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000041\n"
                                                              + "    TypedProcessor: KSTREAM-PEEK-0000000021 (stores: [])\n"
                                                              + "      --> KSTREAM-REDUCE-0000000023\n"
                                                              + "      <-- KSTREAM-FILTER-0000000020\n"
                                                              + "    TypedProcessor: KSTREAM-WINDOWED-0000000033 (stores: [KSTREAM-JOINTHIS-0000000035-store])\n"
                                                              + "      --> KSTREAM-JOINTHIS-0000000035\n"
                                                              + "      <-- KSTREAM-FILTER-0000000029\n"
                                                              + "    TypedProcessor: KSTREAM-WINDOWED-0000000034 (stores: [KSTREAM-JOINOTHER-0000000036-store])\n"
                                                              + "      --> KSTREAM-JOINOTHER-0000000036\n"
                                                              + "      <-- KTABLE-TOSTREAM-0000000011\n"
                                                              + "    TypedProcessor: KSTREAM-AGGREGATE-0000000014 (stores: [KSTREAM-AGGREGATE-STATE-STORE-0000000013])\n"
                                                              + "      --> KTABLE-TOSTREAM-0000000018\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000041\n"
                                                              + "    TypedProcessor: KSTREAM-JOINOTHER-0000000036 (stores: [KSTREAM-JOINTHIS-0000000035-store])\n"
                                                              + "      --> KSTREAM-MERGE-0000000037\n"
                                                              + "      <-- KSTREAM-WINDOWED-0000000034\n"
                                                              + "    TypedProcessor: KSTREAM-JOINTHIS-0000000035 (stores: [KSTREAM-JOINOTHER-0000000036-store])\n"
                                                              + "      --> KSTREAM-MERGE-0000000037\n"
                                                              + "      <-- KSTREAM-WINDOWED-0000000033\n"
                                                              + "    TypedProcessor: KSTREAM-REDUCE-0000000023 (stores: [KSTREAM-REDUCE-STATE-STORE-0000000022])\n"
                                                              + "      --> KTABLE-TOSTREAM-0000000027\n"
                                                              + "      <-- KSTREAM-PEEK-0000000021\n"
                                                              + "    TypedProcessor: KSTREAM-MERGE-0000000037 (stores: [])\n"
                                                              + "      --> KSTREAM-SINK-0000000038\n"
                                                              + "      <-- KSTREAM-JOINTHIS-0000000035, KSTREAM-JOINOTHER-0000000036\n"
                                                              + "    TypedProcessor: KTABLE-TOSTREAM-0000000018 (stores: [])\n"
                                                              + "      --> KSTREAM-SINK-0000000019\n"
                                                              + "      <-- KSTREAM-AGGREGATE-0000000014\n"
                                                              + "    TypedProcessor: KTABLE-TOSTREAM-0000000027 (stores: [])\n"
    ...
    private static final String EXPECTED_UNOPTIMIZED_TOPOLOGY = "Topologies:\n"
                                                                ...
                                                                + "      <-- KSTREAM-FILTER-0000000020\n"
                                                                + "    TypedProcessor: KSTREAM-FILTER-0000000009 (stores: [])\n"
                                                                + "      --> KSTREAM-SINK-0000000008\n"
                                                                + "      <-- KSTREAM-MAP-0000000001\n"
                                                                + "    TypedProcessor: KSTREAM-FILTER-0000000016 (stores: [])\n"
                                                                + "      --> KSTREAM-SINK-0000000015\n"
                                                                + "      <-- KSTREAM-MAP-0000000001\n"
                                                                + "    TypedProcessor: KSTREAM-FILTER-0000000025 (stores: [])\n"
                                                                + "      --> KSTREAM-SINK-0000000024\n"
                                                                + "      <-- KSTREAM-PEEK-0000000021\n"
                                                                + "    TypedProcessor: KSTREAM-FILTER-0000000031 (stores: [])\n"
