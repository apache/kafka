...
public class KafkaEmbedded {
    ...
    private Properties effectiveConfigFrom(final Properties initialConfig) {
        ...
        effectiveConfig.put(KafkaServerConfigs.BROKER_ID_CONFIG, 0);
        effectiveConfig.put(NUM_PARTITIONS_CONFIG, 1);
        effectiveConfig.put(AUTO_CREATE_TOPICS_ENABLE_CONFIG, true);
        effectiveConfig.put(KafkaServerConfigs.MESSAGE_MAX_BYTES_CONFIG, 1000000);
        effectiveConfig.put(KafkaServerConfigs.CONTROLLED_SHUTDOWN_ENABLE_CONFIG, true);
