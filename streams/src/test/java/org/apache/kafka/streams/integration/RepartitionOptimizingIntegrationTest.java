...
public class RepartitionOptimizingIntegrationTest {
    ...
    private void runIntegrationTest(final String optimizationConfig,
        ...
        final KStream<String, Long> countStream = mappedStream.groupByKey().count(Materialized.with(Serdes.String(), null)).toStream();
    ...
    private static final String EXPECTED_OPTIMIZED_TOPOLOGY = "Topologies:\n"
                                                              ...
                                                              + "      --> none\n"
                                                              + "      <-- KSTREAM-MAPVALUES-0000000003\n"
                                                              + "    Sink: KSTREAM-SINK-0000000039 (topic: KSTREAM-AGGREGATE-STATE-STORE-0000000006-repartition, keySerde: StringSerializer, valueSerde: StringSerializer)\n"
                                                              + "      <-- KSTREAM-FILTER-0000000040\n"
                                                              + "\n"
                                                              + "  Sub-topology: 1\n"
                                                              + "    Source: KSTREAM-SOURCE-0000000041 (topics: [KSTREAM-AGGREGATE-STATE-STORE-0000000006-repartition], keySerde: StringDeserializer, valueSerde: StringDeserializer)\n"
                                                              ...
                                                              + "      <-- KTABLE-TOSTREAM-0000000027\n"
                                                              + "    Sink: KSTREAM-SINK-0000000038 (topic: joinedOutputTopic, keySerde: StringSerializer, valueSerde: null)\n"
                                                              + "      <-- KSTREAM-MERGE-0000000037\n\n";
    ...
    private static final String EXPECTED_UNOPTIMIZED_TOPOLOGY = "Topologies:\n"
                                                                ...
                                                                + "      --> none\n"
                                                                + "      <-- KSTREAM-MAPVALUES-0000000003\n"
                                                                + "    Sink: KSTREAM-SINK-0000000008 (topic: KSTREAM-AGGREGATE-STATE-STORE-0000000006-repartition, keySerde: null, valueSerde: null)\n"
                                                                + "      <-- KSTREAM-FILTER-0000000009\n"
                                                                + "    Sink: KSTREAM-SINK-0000000015 (topic: KSTREAM-AGGREGATE-STATE-STORE-0000000013-repartition, keySerde: null, valueSerde: null)\n"
                                                                + "      <-- KSTREAM-FILTER-0000000016\n"
                                                                + "    Sink: KSTREAM-SINK-0000000024 (topic: KSTREAM-REDUCE-STATE-STORE-0000000022-repartition, keySerde: null, valueSerde: null)\n"
                                                                + "      <-- KSTREAM-FILTER-0000000025\n"
                                                                + "    Sink: KSTREAM-SINK-0000000030 (topic: KSTREAM-FILTER-0000000029-repartition, keySerde: StringSerializer, valueSerde: StringSerializer)\n"
                                                                + "      <-- KSTREAM-FILTER-0000000031\n"
                                                                + "\n"
                                                                + "  Sub-topology: 1\n"
                                                                + "    Source: KSTREAM-SOURCE-0000000010 (topics: [KSTREAM-AGGREGATE-STATE-STORE-0000000006-repartition], keySerde: null, valueSerde: null)\n"
                                                                + "      --> KSTREAM-AGGREGATE-0000000007\n"
                                                                + "    Processor: KSTREAM-AGGREGATE-0000000007 (stores: [(KSTREAM-AGGREGATE-STATE-STORE-0000000006, serdes: [StringSerde, LongSerde])])\n"
                                                                + "      --> KTABLE-TOSTREAM-0000000011\n"
                                                                ...
                                                                + "      --> KSTREAM-SINK-0000000012, KSTREAM-WINDOWED-0000000034\n"
                                                                + "      <-- KSTREAM-AGGREGATE-0000000007\n"
                                                                + "    Source: KSTREAM-SOURCE-0000000032 (topics: [KSTREAM-FILTER-0000000029-repartition], keySerde: StringDeserializer, valueSerde: StringDeserializer)\n"
                                                                + "      --> KSTREAM-WINDOWED-0000000033\n"
                                                                + "    Processor: KSTREAM-WINDOWED-0000000033 (stores: [(KSTREAM-JOINTHIS-0000000035-store, serdes: [StringSerde, StringSerde])])\n"
                                                                + "      --> KSTREAM-JOINTHIS-0000000035\n"
                                                                ...
                                                                + "\n"
                                                                + "  Sub-topology: 2\n"
                                                                + "    Source: KSTREAM-SOURCE-0000000017 (topics: [KSTREAM-AGGREGATE-STATE-STORE-0000000013-repartition], keySerde: null, valueSerde: null)\n"
                                                                + "      --> KSTREAM-AGGREGATE-0000000014\n"
                                                                + "    Processor: KSTREAM-AGGREGATE-0000000014 (stores: [(KSTREAM-AGGREGATE-STATE-STORE-0000000013, serdes: [StringSerde, IntegerSerde])])\n"
                                                                + "      --> KTABLE-TOSTREAM-0000000018\n"
                                                                ...
                                                                + "\n"
                                                                + "  Sub-topology: 3\n"
                                                                + "    Source: KSTREAM-SOURCE-0000000026 (topics: [KSTREAM-REDUCE-STATE-STORE-0000000022-repartition], keySerde: null, valueSerde: null)\n"
                                                                + "      --> KSTREAM-REDUCE-0000000023\n"
                                                                + "    Processor: KSTREAM-REDUCE-0000000023 (stores: [(KSTREAM-REDUCE-STATE-STORE-0000000022, serdes: [StringSerde, StringSerde])])\n"
                                                                + "      --> KTABLE-TOSTREAM-0000000027\n"
