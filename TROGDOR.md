...
### ConsumeBench
ConsumeBench starts a Kafka consumer on a single agent node. Depending on the passed in configuration, the consumer either subscribes to a set of topics (leveraging consumer group functionality) or manually assigns partitions to itself.
