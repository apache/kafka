...
public final class RemoteLogManagerConfig {
    ...
    public RemoteLogManagerConfig(AbstractConfig config) {
        this(config.getBoolean(REMOTE_LOG_STORAGE_SYSTEM_ENABLE_PROP),
             ...
             config.originalsWithPrefix(config.getString(REMOTE_LOG_METADATA_MANAGER_CONFIG_PREFIX_PROP) == null ? "" : config.getString(REMOTE_LOG_METADATA_MANAGER_CONFIG_PREFIX_PROP)));
    }
