...
~~~~
$ ./bin/kafka-storage.sh format -t xtzWWN4bTjitpL3kfd9s5g -c ./config/raft-combined.properties
...
# Debugging
If you encounter an issue, you might want to take a look at the metadata log.  You can check it out with the kafka-dump-log.sh tool, like so:
