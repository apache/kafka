...
public abstract class TimestampConverter<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    private static class Config {
        Config(List<String> fields, String type, String inputFormatPattern, String outputFormatPattern) {
            ...
            if (type.equals(TYPE_STRING) && Utils.isBlank(outputFormatPattern)) {
            ...
            if (!Utils.isBlank(outputFormatPattern)) {
                try {
            ...
            if (!Utils.isBlank(inputFormatPattern)) {
                try {
    ...
    public void configure(Map<String, ?> configs) {
        ...
        if (!Utils.isBlank(formatPattern)) {
            if (Utils.isBlank(inputFormatPattern) && Utils.isBlank(outputFormatPattern)) {
