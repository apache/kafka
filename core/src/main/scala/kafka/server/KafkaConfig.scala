...
object KafkaConfig {
  ...
  private[server] val configDef = {
    ...
    new ConfigDef()
      ...
      .define(RaftConfig.QUORUM_REPLICA_FETCH_RESPONSE_MAX_BYTES_CONFIG, INT, Defaults.ReplicaFetchResponseMaxBytes, null, LOW, RaftConfig.QUORUM_REPLICA_FETCH_RESPONSE_MAX_BYTES_DOC)
  }
