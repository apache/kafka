...
import org.apache.kafka.castle.cluster.MiniCastleCluster;
...
public class ActionSchedulerTest {
    ...
    public void testCreateDestroy() throws Throwable {
        MiniCastleCluster.Builder clusterBuilder =
            new MiniCastleCluster.Builder().addNodes("node0", "node1");
        try (MiniCastleCluster miniCluster = clusterBuilder.build()) {
    ...
    public void testRunActions() throws Throwable {
        MiniCastleCluster.Builder clusterBuilder =
            new MiniCastleCluster.Builder().addNodes("node0", "node1", "node2");
