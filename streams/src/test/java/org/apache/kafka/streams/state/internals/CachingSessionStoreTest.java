...
public class CachingSessionStoreTest {
    ...
    public void setUp() throws Exception {
        underlying = new RocksDBSegmentedBytesStore("test", 60000, 3, new RocksDBSessionStore.SessionKeySchema());
    ...
    public void shouldFlushItemsToStoreOnEviction() throws Exception {
        ...
        assertEquals(added.get(0).key, SessionKeyBinaryConverter.from(next.key.get(), Serdes.String().deserializer()));
