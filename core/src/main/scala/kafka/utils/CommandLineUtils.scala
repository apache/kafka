...
object CommandLineUtils extends Logging {
  /**
    ...
    */
  def checkHelpArg(commandOpts: CommandDefaultOptions): Boolean = {
  ...
  /**
    ...
    */
  def checkHelpArgAndPrintUsageAndDie(commandOpts: CommandDefaultOptions, message: String) = {
    if (checkHelpArg(commandOpts))
