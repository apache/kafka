...
public class KGroupedStreamImplTest {
    ...
    public void shouldNotHaveNullReducerWithWindowedReduce() {
        groupedStream.windowedBy(TimeWindows.of(ofMillis(10))).reduce(null, Materialized.as("store"));
    }
    ...
    public void shouldNotHaveInvalidStoreNameWithWindowedReduce() {
        groupedStream.windowedBy(TimeWindows.of(ofMillis(10))).reduce(MockReducer.STRING_ADDER, Materialized.as(INVALID_STORE_NAME));
    }
    ...
    public void shouldNotHaveInvalidStoreNameOnWindowedAggregate() {
        groupedStream.windowedBy(TimeWindows.of(ofMillis(10))).aggregate(MockInitializer.STRING_INIT, MockAggregator.TOSTRING_ADDER, Materialized.as(INVALID_STORE_NAME));
    }
    ...
    public void shouldAcceptNullStoreNameWhenAggregatingSessionWindows() {
        groupedStream
            ...
            .aggregate(MockInitializer.STRING_INIT, MockAggregator.TOSTRING_ADDER, (aggKey, aggOne, aggTwo) -> null, Materialized.with(Serdes.String(), Serdes.String()));
    }
    ...
    public void shouldCountAndMaterializeResults() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props)) {
            ...
            final KeyValueWithTimestampStore<String, Long> count = driver.getKeyValueWithTimestampStore("count");
    ...
    public void shouldReduceAndMaterializeResults() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props)) {
            ...
            final KeyValueWithTimestampStore<String, String> reduced = driver.getKeyValueWithTimestampStore("reduce");
    ...
    public void shouldAggregateAndMaterializeResults() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props)) {
            ...
            final KeyValueWithTimestampStore<String, String> aggregate = driver.getKeyValueWithTimestampStore("aggregate");
    ...
    public void shouldCountWindowed() {
        ...
        groupedStream.windowedBy(TimeWindows.of(ofMillis(500L))).count(Materialized.as("aggregate-by-key-windowed"))
            .toStream()
