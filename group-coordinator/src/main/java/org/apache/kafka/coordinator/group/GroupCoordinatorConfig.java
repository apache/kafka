...
public class GroupCoordinatorConfig {
    ...
    public static final String CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_CONFIG = "group.consumer.regex.refresh.interval.ms";
    public static final String CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_DOC = "The interval at which the group coordinator will atomatically" +
        "refresh the topics matching the group subscribed regexes. This is only applicable to consumer groups using the consumer group protocol. ";
    public static final int CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_DEFAULT = 10 * 60 * 1000; // 10 minutes
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
        ...
        .define(CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_CONFIG, INT, CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_DEFAULT, atLeast(1), MEDIUM, CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_DOC)
    ...
    public GroupCoordinatorConfig(AbstractConfig config) {
        ...
        this.consumerGroupRegexRefreshIntervalMs = config.getInt(GroupCoordinatorConfig.CONSUMER_GROUP_REGEX_REFRESH_INTERVAL_CONFIG);
        // Share group configurations
