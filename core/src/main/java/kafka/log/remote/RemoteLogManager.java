...
public class RemoteLogManager implements Closeable, AsyncOffsetReader {
    ...
    public RemoteLogManager(RemoteLogManagerConfig rlmConfig,
        ...
        remoteLogStorageManagerPlugin = createRemoteStorageManagerPlugin(metrics);
        remoteLogMetadataManagerPlugin = createRemoteLogMetadataManagerPlugin(metrics);
    ...
    Plugin<RemoteStorageManager> createRemoteStorageManagerPlugin(Metrics metrics) {
        return SecurityManagerCompatibility.get().doPrivileged(() -> {
            ...
            if (classPath != null && !classPath.trim().isEmpty()) {
                ...
                RemoteStorageManager rsm = new ClassLoaderAwareRemoteStorageManager(delegate, classLoader);
                configureRSM(rsm);
                return Plugin.wrapInstance(rsm, metrics, rlmConfig.remoteStorageManagerClassName());
            } else {
                RemoteStorageManager rsm = createDelegate(this.getClass().getClassLoader(), rlmConfig.remoteStorageManagerClassName());
                configureRSM(rsm);
                return Plugin.wrapInstance(rsm, metrics, rlmConfig.remoteStorageManagerClassName());
            }
        });
    ...
    private void configureRSM(RemoteStorageManager rsm) {
    ...
    Plugin<RemoteLogMetadataManager> createRemoteLogMetadataManagerPlugin(Metrics metrics) {
        return SecurityManagerCompatibility.get().doPrivileged(() -> {
            ...
            if (classPath != null && !classPath.trim().isEmpty()) {
                ...
                RemoteLogMetadataManager rlmm = new ClassLoaderAwareRemoteLogMetadataManager(delegate, classLoader);
                configureRLMM(rlmm);
                return Plugin.wrapInstance(rlmm, metrics, rlmConfig.remoteLogMetadataManagerClassName());
            } else {
                RemoteLogMetadataManager rlmm = createDelegate(this.getClass().getClassLoader(), rlmConfig.remoteLogMetadataManagerClassName());
                configureRLMM(rlmm);
                return Plugin.wrapInstance(rlmm, metrics, rlmConfig.remoteLogMetadataManagerClassName());
            }
        });
    ...
    private void configureRLMM(RemoteLogMetadataManager rlmm) {
