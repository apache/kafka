...
class LogLoaderTest {
  ...
  val producerStateManagerConfig: ProducerStateManagerConfig = new ProducerStateManagerConfig(kafka.server.Defaults.ProducerIdExpirationMs, true)
  ...
  private def createLog(dir: File,
    ...
    LogTestUtils.createLog(dir, config, brokerTopicStats, scheduler, time, logStartOffset, recoveryPoint,
      maxTransactionTimeoutMs, new ProducerStateManagerConfig(maxProducerIdExpirationMs, true), producerIdExpirationCheckIntervalMs, lastShutdownClean)
  }
  ...
  def testSkipLoadingIfEmptyProducerStateBeforeTruncation(): Unit = {
    ...
    val producerStateManagerConfig = new ProducerStateManagerConfig(300000, true)
