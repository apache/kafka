...
REMOTE_LOG_METADATA_PUBLISH_WAIT_MS = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.publish.wait.ms"
REMOTE_LOG_METADATA_SECONDARY_CONSUMER_SUBSCRIPTION_INTERVAL_MS_PROP = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.secondary.consumer.subscription.interval.ms"
