...
public class PageViewTypedDemo {
    ...
    public static void main(final String[] args) {
        ...
        props.put(StreamsConfig.TIMESTAMP_EXTRACTOR_CLASS_CONFIG_DEFAULT, JsonTimestampExtractor.class);
        props.put(StreamsConfig.KEY_SERDE_CLASS_CONFIG_DEFAULT, JSONSerde.class);
        props.put(StreamsConfig.VALUE_SERDE_CLASS_CONFIG_DEFAULT, JSONSerde.class);
