...
object LogConfig {
  ...
  val MinConsumerFetchVersionProp = TopicConfig.MIN_CONSUMER_FETCH_VERSION_CONFIG
  ...
  val MinConsumerFetchVersionDoc = TopicConfig.MIN_CONSUMER_FETCH_VERSION_DOC
