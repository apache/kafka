...
public class MirrorMetricsTest {
    ...
    private final PluginMetrics pluginMetrics = new PluginMetricsImpl(metrics, Map.of());
    ...
    public void testSourceTags() {
        ...
        MirrorSourceMetrics sourceMetrics = new MirrorSourceMetrics(pluginMetrics, taskConfig);
    ...
    public void testCheckpointTags() {
        ...
        MirrorCheckpointMetrics checkpointMetrics = new MirrorCheckpointMetrics(pluginMetrics, taskConfig);
