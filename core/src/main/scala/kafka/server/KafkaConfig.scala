...
object KafkaConfig {
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(LogCleanerConfig.LOG_CLEANER_THREADS_PROP, INT, LogCleanerConfig.LOG_CLEANER_THREADS, atLeast(0), MEDIUM, LogCleanerConfig.LOG_CLEANER_THREADS_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_IO_MAX_BYTES_PER_SECOND_PROP, DOUBLE, LogCleanerConfig.LOG_CLEANER_IO_MAX_BYTES_PER_SECOND, MEDIUM, LogCleanerConfig.LOG_CLEANER_IO_MAX_BYTES_PER_SECOND_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_SIZE_PROP, LONG, LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_SIZE, MEDIUM, LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_SIZE_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_IO_BUFFER_SIZE_PROP, INT, LogCleanerConfig.LOG_CLEANER_IO_BUFFER_SIZE, atLeast(0), MEDIUM, LogCleanerConfig.LOG_CLEANER_IO_BUFFER_SIZE_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_LOAD_FACTOR_PROP, DOUBLE, LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_LOAD_FACTOR, MEDIUM, LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_LOAD_FACTOR_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_BACKOFF_MS_PROP, LONG, LogCleanerConfig.LOG_CLEANER_BACKOFF_MS, atLeast(0), MEDIUM, LogCleanerConfig.LOG_CLEANER_BACKOFF_MS_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_MIN_CLEAN_RATIO_PROP, DOUBLE, LogConfig.DEFAULT_MIN_CLEANABLE_DIRTY_RATIO, between(0, 1), MEDIUM, LogCleanerConfig.LOG_CLEANER_MIN_CLEAN_RATIO_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_ENABLE_PROP, BOOLEAN, LogCleanerConfig.LOG_CLEANER_ENABLE, MEDIUM, LogCleanerConfig.LOG_CLEANER_ENABLE_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_DELETE_RETENTION_MS_PROP, LONG, LogConfig.DEFAULT_DELETE_RETENTION_MS, atLeast(0), MEDIUM, LogCleanerConfig.LOG_CLEANER_DELETE_RETENTION_MS_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_MIN_COMPACTION_LAG_MS_PROP, LONG, LogConfig.DEFAULT_MIN_COMPACTION_LAG_MS, atLeast(0), MEDIUM, LogCleanerConfig.LOG_CLEANER_MIN_COMPACTION_LAG_MS_DOC)
      .define(LogCleanerConfig.LOG_CLEANER_MAX_COMPACTION_LAG_MS_PROP, LONG, LogConfig.DEFAULT_MAX_COMPACTION_LAG_MS, atLeast(1), MEDIUM, LogCleanerConfig.LOG_CLEANER_MAX_COMPACTION_LAG_MS_DOC)
...
class KafkaConfig private(doLog: Boolean, val props: java.util.Map[_, _], dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  val logCleanerThreads = getInt(LogCleanerConfig.LOG_CLEANER_THREADS_PROP)
  ...
  val logCleanerDedupeBufferSize = getLong(LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_SIZE_PROP)
  val logCleanerDedupeBufferLoadFactor = getDouble(LogCleanerConfig.LOG_CLEANER_DEDUPE_BUFFER_LOAD_FACTOR_PROP)
  val logCleanerIoBufferSize = getInt(LogCleanerConfig.LOG_CLEANER_IO_BUFFER_SIZE_PROP)
  val logCleanerIoMaxBytesPerSecond = getDouble(LogCleanerConfig.LOG_CLEANER_IO_MAX_BYTES_PER_SECOND_PROP)
  def logCleanerDeleteRetentionMs = getLong(LogCleanerConfig.LOG_CLEANER_DELETE_RETENTION_MS_PROP)
  def logCleanerMinCompactionLagMs = getLong(LogCleanerConfig.LOG_CLEANER_MIN_COMPACTION_LAG_MS_PROP)
  def logCleanerMaxCompactionLagMs = getLong(LogCleanerConfig.LOG_CLEANER_MAX_COMPACTION_LAG_MS_PROP)
  val logCleanerBackoffMs = getLong(LogCleanerConfig.LOG_CLEANER_BACKOFF_MS_PROP)
  def logCleanerMinCleanRatio = getDouble(LogCleanerConfig.LOG_CLEANER_MIN_CLEAN_RATIO_PROP)
  val logCleanerEnable = getBoolean(LogCleanerConfig.LOG_CLEANER_ENABLE_PROP)
