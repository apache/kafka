...
public interface KTableChangeProcessorSupplier<KIn, VIn, T, KOut, VOut> extends ProcessorSupplier<KIn, Change<VIn>, KOut, Change<VOut>> {

    KTableValueAndTimestampGetterSupplier<KIn, T> view();
