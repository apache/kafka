...
from kafkatest.version import LATEST_3_4, LATEST_3_5, \
    ...
    LATEST_4_1, LATEST_4_2, LATEST_4_3, DEV_BRANCH, KafkaVersion, LATEST_STABLE_METADATA_VERSION
...
class TestUpgrade(ProduceConsumeValidateTest):
    ...
    @cluster(num_nodes=5)
    @matrix(from_kafka_version=[str(LATEST_3_4), str(LATEST_3_5), str(LATEST_3_6), str(LATEST_3_7), str(LATEST_3_8), str(LATEST_3_9), str(LATEST_4_0), str(LATEST_4_1), str(LATEST_4_2), str(LATEST_4_3), str(DEV_BRANCH)],
