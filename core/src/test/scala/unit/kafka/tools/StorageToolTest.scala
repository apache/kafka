...
""", stream.toString())
  ...
  val standardProperties = new Properties()
  standardProperties.setProperty("process.roles", "broker")
  standardProperties.setProperty("node.id", "0")
  standardProperties.setProperty("controller.quorum.voters", "100@localhost:9093")
  standardProperties.setProperty("controller.listener.names", "CONTROLLER")
