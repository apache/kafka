...
public class InMemoryKVStoreBenchmark extends KeyValueStateStoreBenchmark {

    @Setup(Level.Trial)
    public void setUp() {
        storeKeys();
        this.keyValueStore = Stores.keyValueStoreBuilder(Stores.inMemoryKeyValueStore("in-memory"),
            Serdes.String(),
            Serdes.String())
            .withCachingDisabled()
            .withLoggingDisabled()
