...
public class OffsetConfig {
    ...
    public CompressionType getOffsetsTopicCompressionType() {
        return offsetsTopicCompressionType;
    }

    public int getOffsetCommitTimeoutMs() {
        return offsetCommitTimeoutMs;
    }

    public int getOffsetsTopicSegmentBytes() {
    ...
    public short getOffsetCommitRequiredAcks() {
    ...
    public long getOffsetsRetentionMs() {
