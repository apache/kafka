  ...
  private def testListGroups(useNewProtocol: Boolean): Unit = {
    ...
    for (version <- ApiKeys.LIST_GROUPS.oldestVersion() to ApiKeys.LIST_GROUPS.latestVersion(isUnstableApiEnabled)) {
      ...
      if (useNewProtocol) {
        ...
        memberId1InGroup4 = joinConsumerGroup("grp-4", useNewProtocol = true, Uuid.randomUuid.toString)._1
        ...
        memberId1InGroup5 = joinConsumerGroup("grp-5", useNewProtocol = true, Uuid.randomUuid.toString)._1
        memberId2InGroup5 = joinConsumerGroup("grp-5", useNewProtocol = true, Uuid.randomUuid.toString)._1
        ...
        memberId1InGroup6 = joinConsumerGroup("grp-6", useNewProtocol = true, Uuid.randomUuid.toString)._1
