...
class CreateTopicsRequestTest extends AbstractCreateTopicsRequestTest {
  ...
  def testValidCreateTopicsRequests() {
    ...
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(Map("topic1" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort)).asJava,
                                      timeout).build()
    )
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(Map("topic2" -> new CreateTopicsRequest.TopicDetails(1, 3.toShort)).asJava,
                                      timeout).build()
    )
    val config3 = Map("min.insync.replicas" -> "2").asJava
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("topic3" -> new CreateTopicsRequest.TopicDetails(5, 2.toShort, config3)).asJava,
        timeout
      ).build()
    )
    // Manual assignments
    ...
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(Map("topic4" -> new CreateTopicsRequest.TopicDetails(assignments4)).asJava,
                                      timeout).build()
    )
    ...
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("topic5" -> new CreateTopicsRequest.TopicDetails(assignments5, config5)).asJava,
        timeout
      ).build()
    )
    // Mixed
    ...
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map(
          ...
          "topic8" -> new CreateTopicsRequest.TopicDetails(assignments8)
        ).asJava,
        timeout
      ).build()
    )
    validateValidCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map(
          ...
          "topic11" -> new CreateTopicsRequest.TopicDetails(assignments8)
        ).asJava,
        timeout,
        true
      ).build()
  ...
  def testErrorCreateTopicsRequests() {
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(Map(existingTopic -> new CreateTopicsRequest.TopicDetails(1, 1.toShort)).asJava,
                                      timeout).build(),
      Map(existingTopic -> error(Errors.TOPIC_ALREADY_EXISTS, Some("Topic 'existing-topic' already exists.")))
    )
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-partitions" -> new CreateTopicsRequest.TopicDetails(-1, 1.toShort)).asJava,
        timeout
      ).build(),
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-replication" -> new CreateTopicsRequest.TopicDetails(1, (numBrokers + 1).toShort)).asJava,
        timeout
      ).build(),
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-config" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort, invalidConfig)).asJava,
        timeout
      ).build(),
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-assignment" -> new CreateTopicsRequest.TopicDetails(invalidAssignments)).asJava,
        timeout
      ).build(),
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map(
          ...
          "partial-none" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort)
        ).asJava,
        timeout
      ).build(),
      Map(
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-timeout" -> new CreateTopicsRequest.TopicDetails(10, 3.toShort)).asJava,
        1
      ).build(),
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-timeout-zero" -> new CreateTopicsRequest.TopicDetails(10, 3.toShort)).asJava,
        0
      ).build(),
    ...
    validateErrorCreateTopicsRequests(
      new CreateTopicsRequest.Builder(
        Map("error-timeout-negative" -> new CreateTopicsRequest.TopicDetails(10, 3.toShort)).asJava,
        -1
      ).build(),
  ...
  def testInvalidCreateTopicsRequests() {
    // Duplicate
    val singleRequest = new CreateTopicsRequest.Builder(Map(
                                                          "duplicate-topic" ->
                                                            new CreateTopicsRequest.TopicDetails(1, 1.toShort)
                                                        ).asJava,
                                                        1000).build()
    validateErrorCreateTopicsRequests(
      singleRequest,
      Map(
        "duplicate-topic" -> error(
          ...
          Some(
            """Create topics request from client `client-id` contains multiple entries for the following topics: duplicate-topic"""
          )
        )
      ),
    ...
    val doubleRequestValidateOnly = new CreateTopicsRequest.Builder(
      Map("duplicate-topic" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort),
          "other-topic" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort)).asJava,
      1000,
      true
    ).build()
    validateErrorCreateTopicsRequests(
      doubleRequestValidateOnly,
      Map("duplicate-topic" -> error(Errors.INVALID_REQUEST), "other-topic" -> error(Errors.NONE)),
      checkErrorMessage = false,
    ...
    // Duplicate Partial
    val doubleRequest =
      new CreateTopicsRequest.Builder(Map("duplicate-topic" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort),
                                          "other-topic" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort)).asJava,
                                      1000).build()
    validateErrorCreateTopicsRequests(
      doubleRequest,
    ...
    validateErrorCreateTopicsRequests(badArgumentsRequestValidateOnly,
                                      Map("bad-args-topic" -> error(Errors.INVALID_REQUEST)),
                                      checkErrorMessage = false)
  }
  ...
  def testNotController() {
    val request =
      new CreateTopicsRequest.Builder(Map("topic1" -> new CreateTopicsRequest.TopicDetails(1, 1.toShort)).asJava, 1000)
        .build()
