...
public class InternalTopicIntegrationTest {
    ...
    public void before() {
        ...
        streamsProp.put(StreamsConfig.KEY_SERDE_CLASS_DEFAULT_CONFIG, Serdes.String().getClass().getName());
        streamsProp.put(StreamsConfig.VALUE_SERDE_CLASS_DEFAULT_CONFIG, Serdes.String().getClass().getName());
