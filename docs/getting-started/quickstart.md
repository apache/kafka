...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/4.5.0/kafka_2.13-4.5.0.tgz) the latest Kafka release and extract it: 

```bash
tar -xzf kafka_2.13-4.5.0.tgz
cd kafka_2.13-4.5.0
```
...
The [Kafka Streams demo](/documentation/streams/quickstart) and the [app development tutorial](/45/documentation/streams/tutorial) demonstrate how to code and run such a streaming application from start to finish. 
