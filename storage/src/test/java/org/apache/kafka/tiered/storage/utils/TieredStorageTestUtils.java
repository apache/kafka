...
import static org.apache.kafka.server.log.remote.storage.RemoteLogManagerConfig.REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG;
...
public class TieredStorageTestUtils {
    ...
    public static Properties createPropsForRemoteStorage(String testClassName,
        ...
        overridingProps.setProperty(REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG, metadataConfigPrefix(testClassName, ""));
