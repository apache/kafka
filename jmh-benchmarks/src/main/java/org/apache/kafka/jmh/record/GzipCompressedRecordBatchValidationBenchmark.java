...
public class GzipCompressedRecordBatchValidationBenchmark extends RecordBatchIterationBenchmark {
    ...
    private int bufferSize = CompressionType.GZIP.defaultBuffer();

    @Param(value = {
        "0", // Deflater.DEFAULT_STRATEGY
        "1", // Deflater.FILTERED,
        "2", // Deflater.HUFFMAN_ONLY
    })
    private int strategy = CompressionType.GZIP.defaultStrategy();
