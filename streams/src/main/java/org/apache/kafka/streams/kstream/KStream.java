...
public interface KStream<K, V> {
     ...
     * The branching happens on first-match: An record in the original stream is assigned to the corresponding result
     * stream for the first predicate that evaluates to true, and is assigned to this stream only.
     * An record will be dropped if none of the predicates evaluate to true.
     * This is a stateless record-by-record operation.
     *
     ...
     * an internal generated name, and "-repartition" is a fixed suffix.
     ...
     * {@link StreamsConfig#APPLICATION_ID_CONFIG APPLICATION_ID_CONFIG}, "XXX" is an internal generated name, and
     ...
     * state and will not produce any result records.
     * <p>
     * For each {@link KStream} record whether or not it finds an corresponding record in {@link GlobalKTable} the
