...
public class SslConfigs {
    ...
    public static final String SSL_TRUSTSTORE_TYPE_DOC = "The file format of the trust store file. The currently supported values for kafka are [JKS , PKCS12, PEM].";
