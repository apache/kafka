    ...
    public void shouldReturnPlainKeyValuePairsOnRangeFetchLongParameters() {
        expect(mockedKeyValueWindowTimestampIterator.next())
            .andReturn(KeyValue.pair(
                new Windowed<>("key1", Window.withBounds(21L, 22L)),
                ValueAndTimestamp.make("value1", 22L)))
            .andReturn(KeyValue.pair(
                new Windowed<>("key2", Window.withBounds(42L, 43L)),
        ...
        assertThat(iterator.next(), is(KeyValue.pair(new Windowed<>("key1", Window.withBounds(21L, 22L)), "value1")));
        assertThat(iterator.next(), is(KeyValue.pair(new Windowed<>("key2", Window.withBounds(42L, 43L)), "value2")));
