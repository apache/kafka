...
class KafkaTest {
  ...
  def testMustContainQuorumVotersIfUsingProcessRoles(): Unit = {
    ...
    propertiesFile.setProperty(ZkConfig.ZkConnectProp, "localhost:2181")
  ...
  def testZkSslClientEnable(): Unit = {
    testZkConfig(ZkConfig.ZkSslClientEnableProp, "zookeeper.ssl.client.enable",
  ...
  def testZkSslKeyStoreLocation(): Unit = {
    testZkConfig(ZkConfig.ZkSslKeyStoreLocationProp, "zookeeper.ssl.keystore.location",
  ...
  def testZkSslTrustStoreLocation(): Unit = {
    testZkConfig(ZkConfig.ZkSslTrustStoreLocationProp, "zookeeper.ssl.truststore.location",
  ...
  def testZookeeperKeyStorePassword(): Unit = {
    testZkConfig(ZkConfig.ZkSslKeyStorePasswordProp, "zookeeper.ssl.keystore.password",
  ...
  def testZookeeperTrustStorePassword(): Unit = {
    testZkConfig(ZkConfig.ZkSslTrustStorePasswordProp, "zookeeper.ssl.truststore.password",
  ...
  def testZkSslKeyStoreType(): Unit = {
    testZkConfig(ZkConfig.ZkSslKeyStoreTypeProp, "zookeeper.ssl.keystore.type",
  ...
  def testZkSslTrustStoreType(): Unit = {
    testZkConfig(ZkConfig.ZkSslTrustStoreTypeProp, "zookeeper.ssl.truststore.type",
  ...
  def testZkSslProtocol(): Unit = {
    testZkConfig(ZkConfig.ZkSslProtocolProp, "zookeeper.ssl.protocol",
  ...
  def testZkSslEnabledProtocols(): Unit = {
    testZkConfig(ZkConfig.ZkSslEnabledProtocolsProp, "zookeeper.ssl.enabled.protocols",
  ...
  def testZkSslCipherSuites(): Unit = {
    testZkConfig(ZkConfig.ZkSslCipherSuitesProp, "zookeeper.ssl.cipher.suites",
  ...
  def testZkSslEndpointIdentificationAlgorithm(): Unit = {
    ...
    val kafkaPropName = ZkConfig.ZkSslEndpointIdentificationAlgorithmProp
  ...
  def testZkSslCrlEnable(): Unit = {
    testZkConfig(ZkConfig.ZkSslCrlEnableProp, "zookeeper.ssl.crl.enable",
  ...
  def testZkSslOcspEnable(): Unit = {
    testZkConfig(ZkConfig.ZkSslOcspEnableProp, "zookeeper.ssl.ocsp.enable",
