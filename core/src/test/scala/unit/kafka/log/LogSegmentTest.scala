...
class LogSegmentTest {
  ...
  def testReadBeforeFirstOffset() {
    ...
    seg.append(50, Message.NoTimestamp, -1L, 53, ms)
  ...
  def testMaxOffset() {
    ...
    seg.append(baseOffset, Message.NoTimestamp, -1L, 52, ms)
  ...
  def testReadAfterLast() {
    ...
    seg.append(50, Message.NoTimestamp, -1L, 51, ms)
  ...
  def testReadFromGap() {
    ...
    seg.append(60, Message.NoTimestamp, -1L, 61, ms2)
  ...
  def testTruncate() {
    ...
    for (_ <- 0 until 30) {
      ...
      seg.append(offset, Message.NoTimestamp, -1L, offset, ms1)
      val ms2 = messages(offset + 1, "hello")
      seg.append(offset + 1, Message.NoTimestamp, -1L, offset+1, ms2)
  ...
  def testTruncateFull() {
    ...
    val seg = createSegment(40)
    seg.append(40, Message.NoTimestamp, -1L, 41, messages(40, "hello", "there"))
    seg.truncateTo(0)
  ...
  def testFindOffsetByTimestamp() {
    ...
    for (i <- 40 until 50)
      seg.append(i, i * 10, i, i, messages(i, s"msg$i"))
  ...
  def testNextOffsetCalculation() {
    ...
    seg.append(50, Message.NoTimestamp, -1L, 52, messages(50, "hello", "there", "you"))
  ...
  def testRecoveryFixesCorruptIndex() {
    ...
    for(i <- 0 until 100)
      seg.append(i, Message.NoTimestamp, -1L, i, messages(i, i.toString))
    val indexFile = seg.index.file
  ...
  def testRecoveryFixesCorruptTimeIndex() {
    val seg = createSegment(0)
    for(i <- 0 until 100)
      seg.append(i, i * 10, i, i, messages(i, i.toString))
