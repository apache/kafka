...
class KafkaApisTest extends Logging {
  ...
  def testDescribeConfigsConsumerGroup(): Unit = {
    ...
    cgConfigs.put(ERRORS_DEADLETTERQUEUE_AUTO_CREATE_TOPICS_ENABLE_CONFIG, "false")
    cgConfigs.put(ERRORS_DEADLETTERQUEUE_TOPIC_NAME_PREFIX_CONFIG, "dlq.")
