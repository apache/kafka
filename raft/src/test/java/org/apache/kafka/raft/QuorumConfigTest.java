...
public class QuorumConfigTest {
    ...
    public void testIllegalConfig() {
        ...
        assertInvalidConfig(Map.of(QuorumConfig.QUORUM_FETCH_SNAPSHOT_SIZE_MAX_BYTES_CONFIG, "-1"));
        assertInvalidConfig(Map.of(QuorumConfig.QUORUM_FETCH_SIZE_MAX_BYTES_CONFIG, "-1"));
    }
