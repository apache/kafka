...
private[log] class Cleaner(val id: Int,
  ...
  private[log] def cleanSegments(log: Log,
    ...
    val cleaned = new LogSegment(log.config, messages, index, timeIndex, segments.head.baseOffset, segments.head.indexIntervalBytes, log.config.randomSegmentJitter, time)
