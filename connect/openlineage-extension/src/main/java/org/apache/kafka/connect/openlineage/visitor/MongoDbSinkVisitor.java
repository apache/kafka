...
/**
 * Extracts lineage for the MongoDB Kafka Sink Connector.
 *
 * <p>Inputs are Kafka topics; outputs are MongoDB collections.
 */
public final class MongoDbSinkVisitor implements ConnectorVisitor {
    ...
    public ConnectorLineage visit(Map<String, String> config) {
        ...
        return new ConnectorLineage(inputs, outputs, "MONGODB_SINK");
    }
