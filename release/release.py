...
# automatically. Publish credentials come from ~/.gradle/gradle.properties (mavenUrl /
# mavenUsername / mavenPassword).
cmd("Building and uploading archives",
    "./gradlew :api-checker:core:publish :api-checker:gradle-plugins:publish :api-checker:maven-plugin:publish -PscalaVersion=2.13",
