...
public class KTableSuppressProcessorTest {
    ...
    private static class Harness<K, V> {
        ...
        Harness(final Suppressed<K> suppressed,
            ...
            final InternalProcessorContextMock context = InternalProcessorContextMockFactory.getInstance();
    ...
    public void zeroTimeLimitShouldImmediatelyEmit() {
        ...
        final InternalProcessorContextMock context = harness.context;
    ...
    public void intermediateSuppressionShouldBufferAndEmitLater() {
        ...
        context.setRecordContext(new ProcessorRecordContext(1L, 1, 0, "topic", null));
    ...
    public void finalResultsSuppressionShouldBufferAndEmitAtGraceExpiration() {
        ...
        context.setRecordContext(new ProcessorRecordContext(recordTime, 0, 0, "topic", null));
        ...
        context.setRecordContext(new ProcessorRecordContext(recordTime2, 1, 0, "topic", null));
        ...
        context.setRecordContext(new ProcessorRecordContext(recordTime3, 1, 0, "topic", null));
    ...
    public void finalResultsWithZeroGraceShouldStillBufferUntilTheWindowEnd() {
        ...
        context.setRecordContext(new ProcessorRecordContext(windowEnd, 1L, 0, "", null));
