...
abstract class KTableKTableAbstractJoin<K, R, V1, V2> implements KTableChangeProcessorSupplier<K, V1, R, K, R> {
    ...
    KTableKTableAbstractJoin(final KTableImpl<K, ?, V1> table1,
        ...
        this.table1 = table1;
        this.table2 = table2;
        this.valueGetterSupplier1 = table1.valueAndTimestampGetterSupplier();
        this.valueGetterSupplier2 = table2.valueAndTimestampGetterSupplier();
        this.joiner = joiner;
    }
