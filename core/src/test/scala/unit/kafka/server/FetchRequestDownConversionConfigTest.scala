...
import org.apache.kafka.server.config.KafkaConfig.LOG_MESSAGE_DOWN_CONVERSION_ENABLE_CONFIG
...
class FetchRequestDownConversionConfigTest extends BaseRequestTest {
  ...
  override protected def brokerPropertyOverrides(properties: Properties): Unit = {
    ...
    properties.put(LOG_MESSAGE_DOWN_CONVERSION_ENABLE_CONFIG, "false")
  }
