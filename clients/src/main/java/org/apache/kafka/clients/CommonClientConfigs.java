...
public class CommonClientConfigs {
    ...
    public static final String RECONNECT_BACKOFF_MAX_CONFIG = "reconnect.backoff.max.ms";
    public static final String RECONNECT_BACKOFF_MAX_DOC = "The maximum amount of time in milliseconds to wait when reconnectng to a broker that has repeatedly failed to connect. If provided, the backoff per host will increase exponentially for each consecutive connection failure, up to this maximum. The actual backoff will be determined randomly, with uniform distribution, to avoid connection storms. In practice the average backoff when this threshold is hit will be (reconnect.backoff.max.ms - reconnect.backoff.ms) / 2.";
    ...
    public static final String SECURITY_PROTOCOL_DOC = "Protocol used to communicate with brokers. Valid values are: " + Utils.join(nonTestingSecurityProtocolNames(), ", ") + ".";
