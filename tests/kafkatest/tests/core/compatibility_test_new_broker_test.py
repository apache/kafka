...
class ClientCompatibilityTestNewBroker(ProduceConsumeValidateTest):
    ...
    @matrix(producer_version=[str(LATEST_4_2)], consumer_version=[str(LATEST_4_2)], compression_types=[["none"]], timestamp_type=[str("CreateTime")], metadata_quorum=quorum.all_non_upgrade)
    @matrix(producer_version=[str(LATEST_4_3)], consumer_version=[str(LATEST_4_3)], compression_types=[["none"]], timestamp_type=[str("CreateTime")], metadata_quorum=quorum.all_non_upgrade)
