...
public class UriConfigDefValidator implements Validator {
    ...
    public void ensureValid(String name, Object value) {
        ...
        if (!(scheme.equals("http") || scheme.equals("https")))
            throw new ConfigException(name, value, String.format("The OAuth configuration option %s contains a URI (%s) that contains an invalid scheme (%s); only \"http\" and \"https\" schemes are supported", name, value, scheme));
    }
