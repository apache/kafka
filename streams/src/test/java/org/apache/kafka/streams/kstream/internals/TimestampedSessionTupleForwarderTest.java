...
public class TimestampedSessionTupleForwarderTest {
    ...
    private void setFlushListener(final boolean sendOldValues) {
        final WrappedStateStore<StateStore, Windowed<Object>, ValueAndTimestamp<Object>> store = mock(WrappedStateStore.class);
        final TimestampedSessionCacheFlushListener<Object, Object> flushListener = mock(TimestampedSessionCacheFlushListener.class);
