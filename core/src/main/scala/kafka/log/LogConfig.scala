...
object LogConfig {
  ...
  val MaxIndexSizeDoc = "This configuration controls the size of the index that maps offsets to file positions. We" +
    ...
    " setting."
  val MaxMessageSizeDoc = "This is largest message size Kafka will allow to be appended to this topic. Note that if" +
    " you increase this size you must also increase your consumer's fetch size so they can fetch messages this large."
