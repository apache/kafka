...
public class LRUMapKVStoreTimestampedBenchmark extends TimestampedKeyValueStateStoreBenchmark {

    @Setup(Level.Trial)
    public void setUp() {
        storeKeys();
        this.timestampedKeyValueStore = Stores.timestampedKeyValueStoreBuilder(Stores.lruMap("lru-map", 100000),
            Serdes.String(),
            Serdes.String())
            .withCachingDisabled()
            .withLoggingDisabled()
