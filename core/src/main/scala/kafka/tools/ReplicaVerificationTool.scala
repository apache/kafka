...
private class ReplicaFetcherBlockingSend(sourceNode: Node,
  ...
  private val networkClient = {
    ...
    new NetworkClient(
      ...
      consumerConfig.getLong(ConsumerConfig.SOCKET_CONNECTIONS_SETUP_TIMEOUT_MS_CONFIG),
      consumerConfig.getLong(ConsumerConfig.SOCKET_CONNECTIONS_SETUP_TIMEOUT_MAX_MS_CONFIG),
