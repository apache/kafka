...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/3.5.2/kafka_2.13-3.5.2.tgz) the latest Kafka release and extract it: 
...
The [Kafka Streams demo](/documentation/streams/quickstart) and the [app development tutorial](/35/documentation/streams/tutorial) demonstrate how to code and run such a streaming application from start to finish. 
