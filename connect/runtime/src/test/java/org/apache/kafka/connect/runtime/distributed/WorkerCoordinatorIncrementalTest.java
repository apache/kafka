...
public class WorkerCoordinatorIncrementalTest {
    ...
    public void testTaskAssignmentWhenWorkerJoins() {
        ...
        Map<String, ByteBuffer> result = coordinator.performAssignment(leaderId, compatibility.protocol(), responseMembers, false);
        ...
        result = coordinator.performAssignment(leaderId, compatibility.protocol(), responseMembers, false);
