...
class KafkaTest {
  ...
  def testMustContainQuorumVotersIfUsingProcessRoles(): Unit = {
    ...
    propertiesFile.setProperty(ZkConfig.ZK_CONNECT_CONFIG, "localhost:2181")
  ...
  def testZkSslClientEnable(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_CLIENT_ENABLE_CONFIG, "zookeeper.ssl.client.enable",
  ...
  def testZkSslKeyStoreLocation(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_KEY_STORE_LOCATION_CONFIG, "zookeeper.ssl.keystore.location",
  ...
  def testZkSslTrustStoreLocation(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_TRUST_STORE_LOCATION_CONFIG, "zookeeper.ssl.truststore.location",
  ...
  def testZookeeperKeyStorePassword(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_KEY_STORE_PASSWORD_CONFIG, "zookeeper.ssl.keystore.password",
  ...
  def testZookeeperTrustStorePassword(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_TRUST_STORE_PASSWORD_CONFIG, "zookeeper.ssl.truststore.password",
  ...
  def testZkSslKeyStoreType(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_KEY_STORE_TYPE_CONFIG, "zookeeper.ssl.keystore.type",
  ...
  def testZkSslTrustStoreType(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_TRUST_STORE_TYPE_CONFIG, "zookeeper.ssl.truststore.type",
  ...
  def testZkSslProtocol(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_PROTOCOL_CONFIG, "zookeeper.ssl.protocol",
  ...
  def testZkSslEnabledProtocols(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_ENABLED_PROTOCOLS_CONFIG, "zookeeper.ssl.enabled.protocols",
  ...
  def testZkSslCipherSuites(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_CIPHER_SUITES_CONFIG, "zookeeper.ssl.cipher.suites",
  ...
  def testZkSslEndpointIdentificationAlgorithm(): Unit = {
    ...
    val kafkaPropName = ZkConfig.ZK_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_CONFIG
  ...
  def testZkSslCrlEnable(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_CRL_ENABLE_CONFIG, "zookeeper.ssl.crl.enable",
  ...
  def testZkSslOcspEnable(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_OCSP_ENABLE_CONFIG, "zookeeper.ssl.ocsp.enable",
