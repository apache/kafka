 ...
 */
public final class ForwardingDisabledOldProcessorContext implements ProcessorContext {
    ...
    public ForwardingDisabledOldProcessorContext(final ProcessorContext delegate) {
