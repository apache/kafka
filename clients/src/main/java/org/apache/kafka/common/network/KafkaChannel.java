...
public class KafkaChannel implements AutoCloseable {
    ...
    public KafkaChannel(String id, TransportLayer transportLayer, Supplier<Authenticator> authenticatorCreator,
                        int maxReceiveSize, MemoryPool memoryPool, ChannelMetricsRegistry metricsRegistry) {
        this.id = id;
    ...
    public void close() throws IOException {
        ...
        Utils.closeAll(transportLayer, authenticator, receive, metricsRegistry);
    }
    ...
    public ChannelMetricsRegistry channelMetricsRegistry() {
