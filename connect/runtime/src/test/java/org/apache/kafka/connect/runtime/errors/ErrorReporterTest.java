...
public class ErrorReporterTest {
    ...
    public void testLogOnDisabledLogReporter() {
        LogReporter logReporter = new LogReporter.Sink(TASK_ID, config(emptyMap()), errorHandlingMetrics);
    ...
    public void testLogOnEnabledLogReporter() {
        LogReporter logReporter = new LogReporter.Sink(TASK_ID, config(singletonMap(ConnectorConfig.ERRORS_LOG_ENABLE_CONFIG, "true")), errorHandlingMetrics);
    ...
    public void testLogMessageWithSinkRecords() {
        ...
        LogReporter logReporter = new LogReporter.Sink(TASK_ID, config(props), errorHandlingMetrics);
