...
public class RecordAccumulatorTest {
    ...
    public void testFull() throws Exception {
        ...
        RecordAccumulator accum = new RecordAccumulator(logContext, batchSize + DefaultRecordBatch.RECORD_BATCH_OVERHEAD, 10L * batchSize,
    ...
    private void testAppendLarge(CompressionType compressionType) throws Exception {
        ...
        RecordAccumulator accum = new RecordAccumulator(logContext, batchSize + DefaultRecordBatch.RECORD_BATCH_OVERHEAD, 10 * 1024,
    ...
    public void testLinger() throws Exception {
        long lingerMs = 10L;
        RecordAccumulator accum = new RecordAccumulator(logContext, 1024 + DefaultRecordBatch.RECORD_BATCH_OVERHEAD, 10 * 1024,
    ...
    public void testFlush() throws Exception {
        ...
        final RecordAccumulator accum = new RecordAccumulator(logContext, 4 * 1024 + DefaultRecordBatch.RECORD_BATCH_OVERHEAD, 64 * 1024,
                CompressionType.NONE, lingerMs, 100L, metrics, time, new ApiVersions(), null);
        for (int i = 0; i < 100; i++) {
    ...
    public void testAwaitFlushComplete() throws Exception {
        RecordAccumulator accum = new RecordAccumulator(logContext, 4 * 1024 + DefaultRecordBatch.RECORD_BATCH_OVERHEAD, 64 * 1024,
    ...
    public void testAbortIncompleteBatches() throws Exception {
        ...
        final RecordAccumulator accum = new RecordAccumulator(logContext, 128 + DefaultRecordBatch.RECORD_BATCH_OVERHEAD, 64 * 1024,
                CompressionType.NONE, lingerMs, 100L, metrics, time, new ApiVersions(), null);
    ...
    public void testSplitAndReenqueue() throws ExecutionException, InterruptedException {
        long now = time.milliseconds();
        RecordAccumulator accum = new RecordAccumulator(logContext, 1024, 10 * 1024, CompressionType.GZIP, 10, 100L, metrics, time,
    ...
    public void testSplitBatchOffAccumulator() throws InterruptedException {
        ...
        RecordAccumulator accum = new RecordAccumulator(logContext, batchSize, bufferCapacity, CompressionType.GZIP, 0L, 100L,
    ...
    public void testSplitFrequency() throws InterruptedException {
        ...
        RecordAccumulator accum = new RecordAccumulator(logContext, batchSize, 3 * 1024, CompressionType.GZIP, 10, 100L,
                                                        metrics, time, new ApiVersions(), null);
