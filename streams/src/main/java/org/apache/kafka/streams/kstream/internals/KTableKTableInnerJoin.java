...
class KTableKTableInnerJoin<K, R, V1, V2> extends KTableKTableAbstractJoin<K, R, V1, V2> {
    ...
    private class KTableKTableJoinProcessor extends ContextualProcessor<K, Change<V1>, K, Change<R>> {

        private final KTableValueAndTimestampGetter<K, V2> valueGetter;
        private StreamsMetricsImpl metrics;
        private Sensor droppedRecordsSensor;

        KTableKTableJoinProcessor(final KTableValueAndTimestampGetter<K, V2> valueGetter) {
...
//                );
    ...
    private class KTableKTableInnerJoinValueGetter implements KTableValueAndTimestampGetter<K, R> {
        ...
        KTableKTableInnerJoinValueGetter(final KTableValueAndTimestampGetter<K, V1> valueGetter1,
        ...
        public ValueAndTimestamp<R> get(final K key) {
            ...
            if (value1 != null) {
                final ValueAndTimestamp<V2> valueAndTimestamp2 = valueGetter2
