 ...
 * referred to as the "telemetry manager", as that manager handles the conversion between different
 * representations of metric names and keys.
 *
 * <p/>
 *
 * This class is primarily used by the telemetry manager, {@link MetricsCollector}, and
 * {@link Emitter} layers.
 */
