...
class UnifiedLogTest {
  ...
  val producerStateManagerConfig = new ProducerStateManagerConfig(JKafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT, false)
  ...
  private def createLog(dir: File,
                        ...
                        producerIdExpirationCheckIntervalMs: Int = JKafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT,
