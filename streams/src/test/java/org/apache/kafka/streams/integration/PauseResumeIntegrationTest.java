...
public class PauseResumeIntegrationTest {
    ...
    private Properties props(final boolean stateUpdaterEnabled) {
        ...
        properties.put(StreamsConfig.KEY_SERDE_CLASS_CONFIG_DEFAULT, Serdes.String().getClass());
        properties.put(StreamsConfig.VALUE_SERDE_CLASS_CONFIG_DEFAULT, Serdes.Long().getClass());
