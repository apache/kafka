 ...
 * @param <V> value type
 */
public class ReadOnlyTimestampedWindowStoreWithHeadersFacade<K, V> extends GenericReadOnlyWindowStoreFacade<K, ValueTimestampHeaders<V>, ValueAndTimestamp<V>> {
