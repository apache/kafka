...
class ConnectDistributedTest(Test):
    ...
    @parametrize(broker_version=str(LATEST_3_2), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_3_1), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_3_0), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_2_8), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_2_7), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_2_6), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_2_5), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    @parametrize(broker_version=str(LATEST_2_4), auto_create_topics=False, exactly_once_source=True, connect_protocol='sessioned')
    ...
    @parametrize(broker_version=str(LATEST_3_2), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_3_1), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_3_0), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_2_8), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_2_7), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_2_6), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_2_5), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    @parametrize(broker_version=str(LATEST_2_4), auto_create_topics=False, exactly_once_source=True, connect_protocol='compatible')
    ...
    @parametrize(broker_version=str(LATEST_3_2), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_3_1), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_3_0), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_2_8), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_2_7), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_2_6), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_2_5), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
    @parametrize(broker_version=str(LATEST_2_4), auto_create_topics=False, exactly_once_source=True, connect_protocol='eager')
