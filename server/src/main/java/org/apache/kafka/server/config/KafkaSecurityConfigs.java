...
public class KafkaSecurityConfigs {
    ...
    public static final String SASL_OAUTHBEARER_SCOPE_CLAIM_NAME_DEFAULT = SaslConfigs.SASL_OAUTHBEARER_SCOPE_CLAIM_NAME;
    ...
    public static final String SASL_OAUTHBEARER_SUB_CLAIM_NAME_DEFAULT = SaslConfigs.SASL_OAUTHBEARER_SUB_CLAIM_NAME;
