...
object KafkaConfig {
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(ServerLogConfigs.LOG_DIR_FAILURE_TIMEOUT_MS_CONFIG, LONG, ServerLogConfigs.LOG_DIR_FAILURE_TIMEOUT_MS_DEFAULT, atLeast(0), MEDIUM, ServerLogConfigs.LOG_DIR_FAILURE_TIMEOUT_MS_DOC)
