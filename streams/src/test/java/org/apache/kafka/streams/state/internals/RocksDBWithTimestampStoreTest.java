...
public class RocksDBWithTimestampStoreTest {
    private final Serializer<String> stringSerializer = new StringSerializer();
    private final Deserializer<String> stringDeserializer = new StringDeserializer();
    private RocksDBWithTimestampStore rocksDBStore;
    ...
    public void setUp() {
        ...
        rocksDBStore = new RocksDBWithTimestampStore("test");
    ...
    public void shouldTogglePrepareForBulkloadSetting() {
        rocksDBStore.init(context, rocksDBStore);
        final RocksDBWithTimestampStore.RocksDBBatchingRestoreCallback restoreListener =
            (RocksDBWithTimestampStore.RocksDBBatchingRestoreCallback) rocksDBStore.batchingStateRestoreCallback;
