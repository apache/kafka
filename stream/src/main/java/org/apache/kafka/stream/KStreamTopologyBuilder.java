...
import org.apache.kafka.stream.kstream.internals.KStreamImpl;
...
/**
 * KStreamTopologyBuilder is the class to create KStream instances.
 */
public class KStreamTopologyBuilder extends PTopologyBuilder {

    public KStreamTopologyBuilder() {
        super();
    }
