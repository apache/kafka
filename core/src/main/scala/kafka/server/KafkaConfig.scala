...
object KafkaConfig {
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(SocketServerConfigs.LISTENERS_CONFIG, LONG, SocketServerConfigs.CONNECTIONS_MAX_IDLE_MS_DEFAULT, MEDIUM, SocketServerConfigs.CONNECTIONS_MAX_IDLE_MS_DOC)
