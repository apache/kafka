...
class RemoteLeaderEndPointTest {
    ...
    def testFetchLatestOffset(): Unit = {
        ...
        assertEquals(OffsetAndEpoch(logEndOffset, 7), endPoint.fetchLatestOffset(topicPartition, currentLeaderEpoch))
    }
    ...
    def testFetchEarliestOffset(): Unit = {
        ...
        assertEquals(OffsetAndEpoch(logStartOffset, 5), endPoint.fetchEarliestOffset(topicPartition, currentLeaderEpoch))
    }
    ...
    def testFetchEarliestLocalOffset(): Unit = {
        ...
        assertEquals(OffsetAndEpoch(localLogStartOffset, 6), endPoint.fetchEarliestLocalOffset(topicPartition, currentLeaderEpoch))
    }
