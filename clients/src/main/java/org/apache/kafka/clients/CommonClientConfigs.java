...
public class CommonClientConfigs {
    ...
    public static final String METRICS_RECORD_LEVEL_CONFIG = "metrics.record.level";
    public static final String METRICS_RECORD_LEVEL_DOC = "The highest recording level for metrics.";
