...
/**
 * Implementation of ConfigValidator that checks if a configuration name is valid
 * for a given resource type based on the dynamic configuration definitions in the core module.
 */
class ConfigValidatorImpl extends ConfigValidator {
