...
public class KTableKTableForeignKeyJoinScenarioTest {
    ...
    private void validateTopologyCanProcessData(final StreamsBuilder builder) {
        ...
        config.setProperty(StreamsConfig.KEY_SERDE_CLASS_DEFAULT_CONFIG, Serdes.IntegerSerde.class.getName());
        config.setProperty(StreamsConfig.VALUE_SERDE_CLASS_DEFAULT_CONFIG, Serdes.StringSerde.class.getName());
