 ...
 * down a StreamThread the closing of the ReadOnlyStreamThread happens
 * after all the StreamThreads are completely stopped.
 * <p>
 * The test validates the Processor still has access to the ReadOnlyStateStore while closing.
 * Otherwise, if the ReadOnlyStreamThread were to close underneath the StreamThread
 * an exception would be thrown as the ReadOnlyStreamThread closes all read-only state stores on closing.
 */
@Timeout(600)
@Tag("integration")
public class ReadOnlyThreadShutDownOrderTest {
    ...
    public void before(final TestInfo testInfo) throws Exception {
        ...
        builder
            ...
            .process(() -> new ReadOnlyStoreProcessor(readOnlyStore), readOnlyStore);
    ...
    @Test
    public void shouldFinishReadOnlyStoreOperationOnShutDown() throws Exception {
    ...
    private class ReadOnlyStoreProcessor implements Processor<String, Long, Void, Void> {

        private KeyValueStore<String, Long> store;
        private final String storeName;

        ReadOnlyStoreProcessor(final String storeName) {
