...
object TestUtils extends Logging {
  ...
  def createLogManager(logDirs: Seq[File] = Seq.empty[File],
    ...
    val logManager = new LogManager(logDirs = logDirs.map(_.getAbsoluteFile),
                   ...
                   producerStateManagerConfig = new ProducerStateManagerConfig(org.apache.kafka.server.config.Defaults.PRODUCER_ID_EXPIRATION_MS, transactionVerificationEnabled),
