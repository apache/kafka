...
public class RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacadeTest {
    ...
    public void shouldOverwriteAllOptionsMethods() throws Exception {
        for (final Method method : Options.class.getMethods()) {
            if (!ignoreMethods.contains(method.getName())) {
                RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade.class
    ...
    private void verifyDBOptionsMethodCall(final Method method) throws Exception {
        final RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade optionsFacadeDbOptions
            = new RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade(dbOptions, new ColumnFamilyOptions());
    ...
    private void verifyColumnFamilyOptionsMethodCall(final Method method) throws Exception {
        final RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade optionsFacadeColumnFamilyOptions
            = new RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade(new DBOptions(), columnFamilyOptions);
