...
public class StreamsGroupCommandOptions extends CommandDefaultOptions {
    ...
    private static final String TOPOLOGY_DOC = "Describe the full processing topology of the group, as stored by the broker's " +
        "topology description plugin. This option may be used with the '--describe' option only.";
