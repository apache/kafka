    ...
    public void testNotSendingOldValue() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(topology, props)) {
            ...
            proc.checkAndClearProcessResult(new KeyValueTimestamp<>("0", "(null<-null)", 0),
                    ...
                    new KeyValueTimestamp<>("2", "(null+YY2<-null)", 10),
                    new KeyValueTimestamp<>("3", "(null+YY3<-null)", 20));
        }
    }
    ...
    public void testSendingOldValue() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(topology, props)) {
            ...
            proc.checkAndClearProcessResult(new KeyValueTimestamp<>("0", "(null<-XXXX0+null)", 0),
                    ...
                    new KeyValueTimestamp<>("2", "(null+YY2<-XXXX2+YY2)", 10),
                    new KeyValueTimestamp<>("3", "(null+YY3<-XXXX3+YY3)", 20));
        }
    }
