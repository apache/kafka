...
public class StreamTaskTest {
    ...
    public void testProcessOrder() throws Exception {
        ...
        try {
            ...
            StreamTask task = new StreamTask(new TaskId(0, 0), "jobId", consumer, producer, restoreStateConsumer, partitions, topology, config, null);
    ...
    public void testPauseResume() throws Exception {
        ...
        try {
            StreamingConfig config = createConfig(baseDir);
            StreamTask task = new StreamTask(new TaskId(1, 1), "jobId", consumer, producer, restoreStateConsumer, partitions, topology, config, null);
