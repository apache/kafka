...
import org.apache.kafka.common.errors.InconsistentReplicationFactorException;
...
public enum Errors {
    ...
    INCONSISTENT_REPLICATION_FACTOR(89, "Replication factor is set lower than min.isr. Acks requirements cannot be satisfied.",
            InconsistentReplicationFactorException::new);
