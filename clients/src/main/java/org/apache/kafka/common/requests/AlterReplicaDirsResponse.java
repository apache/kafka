...
public class AlterReplicaDirsResponse extends AbstractResponse {
    ...
    private static final Schema ALTER_REPLICA_DIRS_RESPONSE_V0 = new Schema(
            THROTTLE_TIME_MS,
    ...
    public static Schema[] schemaVersions() {
        return new Schema[]{ALTER_REPLICA_DIRS_RESPONSE_V0};
    }
    ...
    public AlterReplicaDirsResponse(Struct struct) {
     ...
     */
    public AlterReplicaDirsResponse(int throttleTimeMs, Map<TopicPartition, Errors> responses) {
    ...
    protected Struct toStruct(short version) {
        Struct struct = new Struct(ApiKeys.ALTER_REPLICA_DIRS.responseSchema(version));
    ...
    public static AlterReplicaDirsResponse parse(ByteBuffer buffer, short version) {
        return new AlterReplicaDirsResponse(ApiKeys.ALTER_REPLICA_DIRS.responseSchema(version).read(buffer));
    }
}
