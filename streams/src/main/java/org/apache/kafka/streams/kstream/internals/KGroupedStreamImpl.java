...
class KGroupedStreamImpl<K, V> extends AbstractStream<K, V> implements KGroupedStream<K, V> {
    ...
    @Override
    public KTable<K, V> reduce(final Reducer<V> reducer, final Named named) {
    ...
    public KTable<K, V> reduce(final Reducer<V> reducer,
        ...
        return doAggregate(
                new KStreamReduce<>(materializedInternal.storeName(), reducer), name, materializedInternal
        );
    }
    ...
    public <VR> KTable<K, VR> aggregate(final Initializer<VR> initializer,
        ...
        return doAggregate(
                new KStreamAggregate<>(materializedInternal.storeName(), initializer, aggregator), name, materializedInternal
        );
    }
