...
public interface StructSchemaUpdater {
    ...
    StructSchemaUpdater PASS_THROUGH_FIELD = (schemaBuilder, field, fieldPath) -> schemaBuilder.field(field.name(), field.schema());
    // Default function to filter out field on updated value
    StructSchemaUpdater FILTER_OUT_FIELD = (schemaBuilder, field, fieldPath) -> { /* ignore */ };
