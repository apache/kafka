...
class BrokerLifecycleManagerTest {
  ...
  def configProperties = {
    ...
    properties.setProperty(KRaftConfig.PROCESS_ROLES_CONFIG, "broker")
    ...
    properties.setProperty(KRaftConfig.CONTROLLER_LISTENER_NAMES_CONFIG, "SSL")
    properties.setProperty(KRaftConfig.INITIAL_BROKER_REGISTRATION_TIMEOUT_MS_CONFIG, "300000")
    properties.setProperty(KRaftConfig.BROKER_HEARTBEAT_INTERVAL_MS_CONFIG, "100")
    properties
  }
