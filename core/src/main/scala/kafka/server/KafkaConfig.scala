...
object KafkaConfig {
  ...
  val ReplicaFetchMaxBytesDoc = "The number of bytes of messages to attempt to fetch for each partition"
  ...
  val ReplicaFetchResponseMaxBytesDoc = "Maximum bytes expected for entire fetch response."
