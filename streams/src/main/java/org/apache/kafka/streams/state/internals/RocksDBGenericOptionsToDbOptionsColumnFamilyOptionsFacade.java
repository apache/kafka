 ...
 */
class RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade extends Options {
    private final DBOptions dbOptions;
    private final ColumnFamilyOptions columnFamilyOptions;

    RocksDBGenericOptionsToDbOptionsColumnFamilyOptionsFacade(final DBOptions dbOptions,
    ...
    public Options prepareForBulkLoad() {
         ...
         */
        // don't think we can do (1)
        // (2) is done via bulk-loading API
        // doing (3) to (5) below
        // TODO enabling this breaks StreamThreadTest#shouldRecorverFromInvalidOffsetExceptionOnRestoreAndFinishRestore
        // -> unclear why
