...
public class CommonClientConfigs {
    ...
    public static final String SOCKET_CONNECTIONS_SETUP_TIMEOUT_MS_CONFIG = "connections.setup.timeout.ms";
    public static final String SOCKET_CONNECTIONS_SETUP_TIMEOUT_MS_DOC = "The configuration controls the maximum amount of time the client will wait for socket channels finish connecting. The connection will be closed if it is not built before the timeout elapses.";
