...
class KafkaTest {
  ...
  def testMustContainQuorumVotersIfUsingProcessRoles(): Unit = {
    ...
    propertiesFile.setProperty(ZkConfig.ZK_CONNECT_PROP, "localhost:2181")
  ...
  def testZkSslClientEnable(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_CLIENT_ENABLE_PROP, "zookeeper.ssl.client.enable",
  ...
  def testZkSslKeyStoreLocation(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_KEY_STORE_LOCATION_PROP, "zookeeper.ssl.keystore.location",
  ...
  def testZkSslTrustStoreLocation(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_TRUST_STORE_LOCATION_PROP, "zookeeper.ssl.truststore.location",
  ...
  def testZookeeperKeyStorePassword(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_KEY_STORE_PASSWORD_PROP, "zookeeper.ssl.keystore.password",
  ...
  def testZookeeperTrustStorePassword(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_TRUST_STORE_PASSWORD_PROP, "zookeeper.ssl.truststore.password",
  ...
  def testZkSslKeyStoreType(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_KEY_STORE_TYPE_PROP, "zookeeper.ssl.keystore.type",
  ...
  def testZkSslTrustStoreType(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_TRUST_STORE_TYPE_PROP, "zookeeper.ssl.truststore.type",
  ...
  def testZkSslProtocol(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_PROTOCOL_PROP, "zookeeper.ssl.protocol",
  ...
  def testZkSslEnabledProtocols(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_ENABLED_PROTOCOLS_PROP, "zookeeper.ssl.enabled.protocols",
  ...
  def testZkSslCipherSuites(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_CIPHER_SUITES_PROP, "zookeeper.ssl.cipher.suites",
  ...
  def testZkSslEndpointIdentificationAlgorithm(): Unit = {
    ...
    val kafkaPropName = ZkConfig.ZK_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_PROP
  ...
  def testZkSslCrlEnable(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_CRL_ENABLE_PROP, "zookeeper.ssl.crl.enable",
  ...
  def testZkSslOcspEnable(): Unit = {
    testZkConfig(ZkConfig.ZK_SSL_OCSP_ENABLE_PROP, "zookeeper.ssl.ocsp.enable",
