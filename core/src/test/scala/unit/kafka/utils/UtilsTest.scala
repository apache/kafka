...
class UtilsTest extends JUnitSuite {
  ...
  def testUrlSafeBase64EncodeUUID() {
    ...
    val clusterId1 = CoreUtils.urlSafeBase64EncodeUUID(UUID.fromString("a149b4a3-06e1-4b49-a8cb-8a9c4a59fa46"))
    ...
    val clusterId2 = CoreUtils.urlSafeBase64EncodeUUID(UUID.fromString("d418ec02-277e-4853-81e6-afe30259daec"))
