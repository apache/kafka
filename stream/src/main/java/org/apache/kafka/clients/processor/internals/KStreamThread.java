...
public class KStreamThread extends Thread {
    ...
    public KStreamThread(Class<? extends PTopology> topologyClass, StreamingConfig streamingConfig) throws Exception {
        super();
        ...
        for (TopicPartition partition : partitions) {
            ...
            if (context == null) {
                try {
                    ...
                    context = new ProcessorContextImpl(id, ingestor, topology, collector, streamingConfig, config, metrics);
                    topology.build();
