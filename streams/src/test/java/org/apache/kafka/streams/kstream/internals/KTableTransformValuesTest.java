...
public class KTableTransformValuesTest {
    ...
    @Mock(MockType.NICE)
    private KeyValueWithTimestampStore<String, String> stateStore;
    @Mock(MockType.NICE)
    ...
    public void shouldTransformOnGetIfNotMaterialized() {
        ...
        expect(parentGetter.get("Key")).andReturn(new ValueAndTimestampImpl<>("Value", 42L));
    ...
    public void shouldGetFromStateStoreIfMaterialized() {
        ...
        expect(stateStore.get("Key")).andReturn(new ValueAndTimestampImpl<>("something", 42L));
        ...
        assertThat(result, equalTo(new ValueAndTimestampImpl<>("something", 42L)));
    }
    ...
    public void shouldTransformValuesWithKeyAndMaterialize() {
        ...
        final KeyValueWithTimestampStore<String, String> keyValueStore = driver.getKeyValueWithTimestampStore(QUERYABLE_NAME);
    ...
    public void shouldCalculateCorrectOldValuesIfMaterializedEvenIfStateful() {
        ...
        final KeyValueWithTimestampStore<String, Integer> keyValueStore = driver.getKeyValueWithTimestampStore(QUERYABLE_NAME);
