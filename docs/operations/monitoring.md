...
Byte in (from the other brokers) rate per topic. Omitting 'topic=(...)' will yield the all-topic rate.
</td> </tr>  
<tr>  
<td>
...
Byte out (to the other brokers) rate per topic. Omitting 'topic=(...)' will yield the all-topic rate.
</td> </tr>  
<tr>  
<td>
...
{{< include-html file="/static/35/generated/producer_metrics.html" >}} 
