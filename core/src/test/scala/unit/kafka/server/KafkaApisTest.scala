...
import org.apache.kafka.metadata.{ConfigRepository, KRaftMetadataCache, MetadataCache, MetadataCacheTestFixtures, MockConfigRepository}
...
class KafkaApisTest extends Logging {
  ...
  def testUnauthorizedTopicMetadataRequest(): Unit = {
    ...
    MetadataCacheTestFixtures.updateCache(metadataCache,
    ...
    MetadataCacheTestFixtures.updateCache(metadataCache, (partitionRecords : Seq[ApiMessage]).asJava)
  ...
  private def setupBasicMetadataCache(topic: String, numPartitions: Int, numBrokers: Int, topicId: Uuid): Unit = {
    ...
    MetadataCacheTestFixtures.updateCache(metadataCache, updateMetadata.asJava)
  }
