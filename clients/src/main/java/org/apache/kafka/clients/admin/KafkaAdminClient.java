...
public class KafkaAdminClient extends AdminClient {
    ...
    static KafkaAdminClient createInternal(AdminClientConfig config, TimeoutProcessorFactory timeoutProcessorFactory) {
        ...
        try {
            ...
            AdminMetadataManager metadataManager = new AdminMetadataManager(logContext,
                config.getInt(AdminClientConfig.RETRY_BACKOFF_MS_CONFIG),
    ...
    private KafkaAdminClient(AdminClientConfig config,
        ...
        this.retryBackoffMs = config.getInt(AdminClientConfig.RETRY_BACKOFF_MS_CONFIG);
        config.logUnused();
    ...
    abstract class Call {
        ...
        private Long nextAllowedRetryMs = null;
    ...
    private final class AdminClientRunnable implements Runnable {
        ...
        private long chooseNodesForPendingCalls(long now, Iterator<Call> pendingIter) {
            ...
            while (pendingIter.hasNext()) {
                ...
                if (call.nextAllowedRetryMs != null && now < call.nextAllowedRetryMs) {
