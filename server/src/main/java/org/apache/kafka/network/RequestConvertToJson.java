...
public class RequestConvertToJson {
    ...
    public static JsonNode request(AbstractRequest request) {
        return switch (request.apiKey()) {
            ...
            case CONTROLLED_SHUTDOWN ->
                    ControlledShutdownRequestDataJsonConverter.write(((ControlledShutdownRequest) request).data(), request.version());
            ...
            case LEADER_AND_ISR ->
                    LeaderAndIsrRequestDataJsonConverter.write(((LeaderAndIsrRequest) request).data(), request.version());
            case LEAVE_GROUP ->
                    LeaveGroupRequestDataJsonConverter.write(((LeaveGroupRequest) request).data(), request.version());
            case LIST_CLIENT_METRICS_RESOURCES ->
                    ListClientMetricsResourcesRequestDataJsonConverter.write(((ListClientMetricsResourcesRequest) request).data(), request.version());
            case LIST_GROUPS ->
            ...
            case STOP_REPLICA ->
                    StopReplicaRequestDataJsonConverter.write(((StopReplicaRequest) request).data(), request.version());
            case SYNC_GROUP ->
            ...
            case UPDATE_METADATA ->
                    UpdateMetadataRequestDataJsonConverter.write(((UpdateMetadataRequest) request).data(), request.version());
    ...
    public static JsonNode response(AbstractResponse response, short version) {
        return switch (response.apiKey()) {
            ...
            case CONTROLLED_SHUTDOWN ->
                    ControlledShutdownResponseDataJsonConverter.write(((ControlledShutdownResponse) response).data(), version);
            case CONTROLLER_REGISTRATION ->
            ...
            case LEADER_AND_ISR ->
                    LeaderAndIsrResponseDataJsonConverter.write(((LeaderAndIsrResponse) response).data(), version);
            case LEAVE_GROUP ->
                    LeaveGroupResponseDataJsonConverter.write(((LeaveGroupResponse) response).data(), version);
            case LIST_CLIENT_METRICS_RESOURCES ->
                    ListClientMetricsResourcesResponseDataJsonConverter.write(((ListClientMetricsResourcesResponse) response).data(), version);
            case LIST_GROUPS ->
            ...
            case STOP_REPLICA ->
                    StopReplicaResponseDataJsonConverter.write(((StopReplicaResponse) response).data(), version);
            ...
            case UPDATE_METADATA ->
                    UpdateMetadataResponseDataJsonConverter.write(((UpdateMetadataResponse) response).data(), version);
