...
public class LeaderElectionCommand {
    ...
    static class LeaderElectionCommandOptions extends CommandDefaultOptions {
        ...
        private final ArgumentAcceptingOptionSpec<String> adminClientCommandConfig;
        ...
        public LeaderElectionCommandOptions(String[] args) {
            ...
            adminClientConfig = parser
                ...
                .ofType(String.class);
            adminClientCommandConfig = parser
                .accepts(
                    "command-config",
                    "Config properties file to pass to the admin client")
                .withRequiredArg()
                .describedAs("Config properties files")
                .ofType(String.class);
        ...
        public String getAdminClientCommandConfig() {
            return options.valueOf(adminClientCommandConfig);
        }
        ...
        public void validate() {
            ...
            CommandLineUtils.checkInvalidArgs(parser, options, adminClientConfig, adminClientCommandConfig);
