...
import com.trivago.streams.proto.support.DefinedStackHolder;
...
public class RangeKeyValueGetterProviderAndProcessorSupplier<K, V, KL, VL, VR> implements KTableRangeValueGetterSupplier<K, VR>, ProcessorSupplier<K, VR>
{
