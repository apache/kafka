...
object KafkaConfig {
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      .define(SslKeystorePasswordProp, PASSWORD_STRING, MEDIUM, SslKeystorePasswordDoc, false)
      .define(SslKeyPasswordProp, PASSWORD_STRING, MEDIUM, SslKeyPasswordDoc, false)
      ...
      .define(SslTruststorePasswordProp, PASSWORD_STRING, MEDIUM, SslTruststorePasswordDoc, false)
