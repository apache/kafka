...
import org.apache.kafka.common.errors.{MessageFormatTooOldException, CorruptRecordException, OffsetOutOfRangeException, RecordBatchTooLargeException, RecordTooLargeException}
...
class Log(val dir: File,
  ...
  def fetchOffsetsByTimestamp(targetTimestamp: Long): Option[TimestampOffset] = {
    ...
    if (config.messageFormatVersion < KAFKA_0_10_0_IV0 &&
      ...
      throw new MessageFormatTooOldException(s"Cannot search offsets based on timestamp because message format version " +
