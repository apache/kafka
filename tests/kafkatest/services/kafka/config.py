...
class KafkaConfig(dict):
    ...
    DEFAULTS = {
        ...
        config_property.METADATA_LOG_SEGMENT_BYTES: str(9*1024*1024),
        config_property.METADATA_LOG_BYTES_BETWEEN_SNAPSHOTS: str(20*1024*1024), # 20 MB
        config_property.METADATA_LOG_RETENTION_BYTES: str(20*1024*1024), # 20 MB
