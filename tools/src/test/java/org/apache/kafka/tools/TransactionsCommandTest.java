...
public class TransactionsCommandTest {
    ...
    public void testDescribeProducersSpecificReplica() throws Exception {
        ...
        testDescribeProducers(topicPartition, args, new DescribeProducersOptions().setBrokerId(brokerId));
    }
    ...
    public void testDescribeTransaction() throws Exception {
        ...
        Mockito.when(describeResult.transactionalIdResult(transactionalId)).thenReturn(describeFuture);
