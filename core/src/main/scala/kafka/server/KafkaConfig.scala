...
object KafkaConfig {
  ...
  val LogCleanerMinCleanRatioDoc = "The minimum ratio of dirty log to total log for a log to eligible for cleaning. If " + LogCleanerMaxCompactionLagMsProp + " is used, the log can become eligible for cleaning " +
    " as determined by " + LogCleanerMaxCompactionLagMsProp + " before reaching the minimum dirty ratio"
