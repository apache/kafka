...
public final class InternalProcessorContextNewToOldAdapter implements InternalProcessorContext {
    ...
    static InternalProcessorContext adapt(final InternalApiProcessorContext<Object, Object> delegate) {
        if (delegate instanceof InternalProcessorContextOldToNewAdapter) {
            return ((InternalProcessorContextOldToNewAdapter<Object, Object>) delegate).delegate();
        } else {
            return new InternalProcessorContextNewToOldAdapter(delegate);
        }
    }

    private InternalProcessorContextNewToOldAdapter(final InternalApiProcessorContext<Object, Object> delegate) {
    ...
    public void register(final StateStore store, final StateRestoreCallback stateRestoreCallback) {
        throw new UnsupportedOperationException("This ProcessorContext doesn't support registering stateRestoreCallbacks.");
    }
