...
class WindowedKTableFilter<K, V> implements KTableProcessorSupplier<K, V, V> {

    private final WindowedKTableImpl<K, ?, V> parent;
    private final Predicate<? super Windowed<K>, ? super V> predicate;
    private final boolean filterNot;
    private final String queryableName;
    private boolean sendOldValues = false;

    WindowedKTableFilter(final WindowedKTableImpl<K, ?, V> parent,
                         final Predicate<? super Windowed<K>, ? super V> predicate,
