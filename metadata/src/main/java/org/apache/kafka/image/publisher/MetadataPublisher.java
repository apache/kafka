...
public interface MetadataPublisher extends AutoCloseable {
    ...
    /**
     * Publish a cluster metadata snapshot that we created prior to changing the metadata version.
     *
     * @param delta                 The delta between the previous state and the new one.
     * @param preVersionChangeImage The complete new state.
     * @param manifest              The contents of what was published.
     */
    default void publishPreVersionChangeImage(
            MetadataDelta delta,
