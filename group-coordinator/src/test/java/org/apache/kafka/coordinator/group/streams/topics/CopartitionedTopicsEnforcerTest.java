...
public class CopartitionedTopicsEnforcerTest {
    ...
    public void shouldThrowStreamsInconsistentInternalTopicsExceptionIfPartitionCountsForCoPartitionedTopicsDontMatch() {
        ...
        assertThrows(StreamsInconsistentInternalTopicsException.class, () -> validator.enforce(Utils.mkSet("first", "second"),
            Collections.emptyMap()));
    }
    ...
    public void shouldSetNumPartitionsToMaximumPartitionsWhenAllTopicsAreRepartitionTopics() {
        ...
        final Map<String, InternalTopicConfig> internalTopicConfigs = new HashMap<>();
    ...
    public void shouldThrowAnExceptionIfInternalTopicConfigsWithEnforcedNumOfPartitionsHaveDifferentNumOfPartitions() {
        final CopartitionedTopicsEnforcer validator = new CopartitionedTopicsEnforcer(LOG_CONTEXT, CopartitionedTopicsEnforcerTest::firstSecondTopicConsistent);
        final InternalTopicConfig topic1 = createInternalTopicConfigWithEnforcedNumberOfPartitions("repartitioned-1", 10);
        final InternalTopicConfig topic2 = createInternalTopicConfigWithEnforcedNumberOfPartitions("repartitioned-2", 5);
    ...
    public void shouldNotThrowAnExceptionWhenInternalTopicConfigsWithEnforcedNumOfPartitionsAreValid() {
        final CopartitionedTopicsEnforcer validator = new CopartitionedTopicsEnforcer(LOG_CONTEXT, CopartitionedTopicsEnforcerTest::firstSecondTopicConsistent);
        final InternalTopicConfig topic1 = createInternalTopicConfigWithEnforcedNumberOfPartitions("repartitioned-1", 10);
        final InternalTopicConfig topic2 = createInternalTopicConfigWithEnforcedNumberOfPartitions("repartitioned-2", 10);
    ...
    public void shouldNotThrowAnExceptionWhenNumberOfPartitionsOfNonRepartitionTopicAndRepartitionTopicWithEnforcedNumOfPartitionsMatch() {
        final CopartitionedTopicsEnforcer validator = new CopartitionedTopicsEnforcer(LOG_CONTEXT, CopartitionedTopicsEnforcerTest::firstSecondTopicConsistent);
        final InternalTopicConfig topic1 = createInternalTopicConfigWithEnforcedNumberOfPartitions("repartitioned-1", 2);
    ...
    public void shouldDeductNumberOfPartitionsFromRepartitionTopicWithEnforcedNumberOfPartitions() {
        ...
        final InternalTopicConfig topic3 = createInternalTopicConfigWithEnforcedNumberOfPartitions("repartitioned-3", 2);
    ...
    private InternalTopicConfig createTopicConfig(final String repartitionTopic,
        ...
        final InternalTopicConfig config =
            new InternalTopicConfig(repartitionTopic, Collections.emptyMap());

        config.setNumberOfPartitions(partitions);
        return config;
    }

    private InternalTopicConfig createInternalTopicConfigWithEnforcedNumberOfPartitions(final String repartitionTopic,
                                                                                        final int partitions) {
        return new InternalTopicConfig(repartitionTopic,
            Collections.emptyMap(),
