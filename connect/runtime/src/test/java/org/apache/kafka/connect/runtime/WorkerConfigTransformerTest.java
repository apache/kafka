...
public class WorkerConfigTransformerTest {
    ...
    @Mock private HerderRequestId requestId;
    ...
    public void testReplaceVariableWithTTLAndScheduleRestart() throws Exception {
        ...
        EasyMock.expect(herder.restartConnector(1L, "myConnector", null)).andReturn(requestId);
    ...
    public void testReplaceVariableWithTTLFirstCancelThenScheduleRestart() throws Exception {
        ...
        requestId.cancel();
        EasyMock.expectLastCall();
        EasyMock.expect(herder.restartConnector(10L, "myConnector", null)).andReturn(requestId);
