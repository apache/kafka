...
public class FeatureMetadata {
    ...
    private final Map<String, BrokerFinalizedVersionRange> finalizedFeatures;

    private final Optional<Long> finalizedFeaturesEpoch;

    private final Map<String, BrokerSupportedVersionRange> supportedFeatures;

    FeatureMetadata(final Map<String, BrokerFinalizedVersionRange> finalizedFeatures,
                           final Optional<Long> finalizedFeaturesEpoch,
                           final Map<String, BrokerSupportedVersionRange> supportedFeatures) {
     ...
     * cluster.
     */
    public Map<String, BrokerFinalizedVersionRange> finalizedFeatures() {
     ...
     * cluster.
     */
    public Map<String, BrokerSupportedVersionRange> supportedFeatures() {
