...
public class NodeApiVersions {
    ...
    public short usableVersion(ApiKeys apiKey) {
        ...
        if (usableVersion == API_NOT_ON_NODE)
            ...
            throw new UnsupportedVersionException("The remote node is too old to support " + apiKey +
                " version " + ProtoUtils.oldestVersion(apiKey.id));
        else if (usableVersion == NODE_TOO_NEW)
            throw new UnsupportedVersionException("The remote node is too new to support " + apiKey +
