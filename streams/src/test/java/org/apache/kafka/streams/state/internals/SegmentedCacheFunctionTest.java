...
public class SegmentedCacheFunctionTest {
    ...
    private static final Bytes THE_KEY = TimeWindowedSerde.toStoreKeyBinary(new byte[]{0xA, 0xB, 0xC}, TIMESTAMP, 42);
    ...
    public void compareSegmentedKeys() {
        ...
        final Bytes sameKeyInPriorSegment = TimeWindowedSerde.toStoreKeyBinary(new byte[]{0xA, 0xB, 0xC}, 1234, 42);
        ...
        final Bytes lowerKeyInSameSegment = TimeWindowedSerde.toStoreKeyBinary(new byte[]{0xA, 0xB, 0xB}, TIMESTAMP - 1, 0);
