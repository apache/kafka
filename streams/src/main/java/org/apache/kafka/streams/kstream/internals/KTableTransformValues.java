...
class KTableTransformValues<K, V, VOut> implements KTableNewProcessorSupplier<K, V, K, VOut> {
    ...
    private class KTableTransformValuesProcessor extends ContextualProcessor<K, Change<V>, K, Change<VOut>> {
        ...
        public void init(final ProcessorContext<K, Change<VOut>> context) {
            super.init(context);
            InternalProcessorContext<K, Change<VOut>> internalProcessorContext = (InternalProcessorContext<K, Change<VOut>>) context;
