...
public class DelayedShareFetchKeyTest {
    ...
    public void testDelayedShareFetchEqualsAndHashcode() {
        ...
        keyMap.put("key0", new DelayedShareFetchGroupKey("grp", tp0));
        keyMap.put("key1", new DelayedShareFetchGroupKey("grp", tp1));
        keyMap.put("key2", new DelayedShareFetchGroupKey("grp", tp2));
        keyMap.put("key3", new DelayedShareFetchGroupKey("grp2", tp0));
        keyMap.put("key4", new DelayedShareFetchGroupKey("grp2", tp1));
        keyMap.put("key5", new DelayedShareFetchPartitionKey(tp0));
        keyMap.put("key6", new DelayedShareFetchPartitionKey(tp1));
        keyMap.put("key7", new DelayedShareFetchPartitionKey(tp2));
