...
public interface KTable<K, V> {
    ...
    /**
     * @deprecated Please use {@link KTable#filter(Predicate, TypedStateStoreSupplier)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use {@link KTable#filterNot(Predicate, TypedStateStoreSupplier)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use {@link KTable#mapValues(ValueMapper, Serde, TypedStateStoreSupplier)}
     */
    @Deprecated
    <VR> KTable<K, VR> mapValues(final ValueMapper<? super V, ? extends VR> mapper,
                                 final Serde<VR> valueSerde,
    ...
    /**
     * @deprecated Please use {@link KTable#through(String, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<K, V> through(final String topic,
                         final StateStoreSupplier<KeyValueStore> storeSupplier);
    ...
    /**
     * @deprecated Please use {@link KTable#through(StreamPartitioner, String, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<K, V> through(final StreamPartitioner<? super K, ? super V> partitioner,
                         final String topic,
    ...
    /**
     * @deprecated Please use {@link KTable#through(Serde, Serde, String, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<K, V> through(final Serde<K> keySerde, Serde<V> valSerde,
                         final String topic,
    ...
    /**
     * @deprecated Please use {@link KTable#through(Serde, Serde, StreamPartitioner, String, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<K, V> through(final Serde<K> keySerde,
                         final Serde<V> valSerde,
    ...
    /**
     * @deprecated Please use {@link KTable#join(KTable, ValueJoiner, TypedStateStoreSupplier)}
     */
    @Deprecated
    <VO, VR> KTable<K, VR> join(final KTable<K, VO> other,
                                final ValueJoiner<? super V, ? super VO, ? extends VR> joiner,
    ...
    /**
     * @deprecated Please use {@link KTable#leftJoin(KTable, ValueJoiner, TypedStateStoreSupplier)}
     */
    @Deprecated
    <VO, VR> KTable<K, VR> leftJoin(final KTable<K, VO> other,
                                    final ValueJoiner<? super V, ? super VO, ? extends VR> joiner,
    ...
    /**
     * @deprecated Please use {@link KTable#outerJoin(KTable, ValueJoiner, TypedStateStoreSupplier)}
     */
    @Deprecated
    <VO, VR> KTable<K, VR> outerJoin(final KTable<K, VO> other,
                                     final ValueJoiner<? super V, ? super VO, ? extends VR> joiner,
