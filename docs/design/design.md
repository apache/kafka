...
Details on configuration and the [api](/https://kafka.apache.org/082/javadoc/index.html?org/apache/kafka/clients/producer/KafkaProducer.html) for the producer can be found elsewhere in the documentation. 
...
![](/38/images/log_cleaner_anatomy.png)
