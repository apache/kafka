...
public class SessionKeySchemaTest {
    ...
    private static final Map<SchemaType, Function<Windowed<Bytes>, Bytes>> WINDOW_TO_STORE_BINARY_MAP = Map.ofEntries(
    ...
    private static final Map<SchemaType, Function<byte[], Long>> EXTRACT_END_TS_MAP = Map.ofEntries(
    ...
    private static final Map<SchemaType, Function<byte[], Long>> EXTRACT_START_TS_MAP = Map.ofEntries(
    ...
    private static final Map<SchemaType, TriFunction<Windowed<String>, Serializer<String>, String, byte[]>> SERDE_TO_STORE_BINARY_MAP = Map.ofEntries(
        Map.entry(SchemaType.SessionKeySchema, SessionKeySchema::toBinary),
        Map.entry(SchemaType.PrefixedKeyFirstSchema, KeyFirstSessionKeySchema::toBinary),
        Map.entry(SchemaType.PrefixedTimeFirstSchema, TimeFirstSessionKeySchema::toBinary)
    );

    private static final Map<SchemaType, TriFunction<byte[], Deserializer<String>, String, Windowed<String>>> SERDE_FROM_BYTES_MAP = Map.ofEntries(
    ...
    private static final Map<SchemaType, Function<Bytes, Windowed<Bytes>>> FROM_BYTES_MAP = Map.ofEntries(
        Map.entry(SchemaType.SessionKeySchema, SessionKeySchema::from),
        Map.entry(SchemaType.PrefixedKeyFirstSchema, KeyFirstSessionKeySchema::from),
        Map.entry(SchemaType.PrefixedTimeFirstSchema, TimeFirstSessionKeySchema::from)
    );

    private static final Map<SchemaType, Function<byte[], Window>> EXTRACT_WINDOW = Map.ofEntries(
    ...
    private static final Map<SchemaType, Function<byte[], byte[]>> EXTRACT_KEY_BYTES = Map.ofEntries(
