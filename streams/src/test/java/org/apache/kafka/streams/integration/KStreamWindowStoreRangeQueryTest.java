...
public class KStreamWindowStoreRangeQueryTest {
    ...
    public KStreamWindowStoreRangeQueryTest(final StoreType storeType, final boolean enableLogging, final boolean enableCaching, final boolean forward) {
