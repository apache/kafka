...
public class ResetIntegrationWithSslTest extends AbstractResetIntegrationTest {
    ...
    static {
        ...
        brokerProps.put(KafkaConfig.CONNECTIONS_MAX_IDLE_MS_PROP, -1L);

        try {
            SSL_CONFIG = TestSslUtils.createSslConfig(false, true, Mode.SERVER, TestUtils.tempFile(), "testCert");

            brokerProps.put(KafkaConfig.LISTENERS_PROP, "SSL://localhost:0");
            brokerProps.put(KafkaConfig.INTER_BROKER_LISTENER_NAME_PROP, "SSL");
