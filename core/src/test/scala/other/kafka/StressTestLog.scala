...
object StressTestLog {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val log = UnifiedLog(dir = dir,
      ...
      producerStateManagerConfig = new ProducerStateManagerConfig(KafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT, false),
      producerIdExpirationCheckIntervalMs = KafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT,
