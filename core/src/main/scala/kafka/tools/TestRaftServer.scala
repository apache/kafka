...
class TestRaftServer(
  ...
  class RaftWorkloadGenerator(
    ...
    case class HandleSnapshot(reader: RecordsSnapshotReader[Array[Byte]]) extends RaftEvent
    ...
    override def handleSnapshot(reader: RecordsSnapshotReader[Array[Byte]]): Unit = {
