...
class ChangeLoggingTimestampedSessionBytesStore extends ChangeLoggingSessionBytesStore {

    ChangeLoggingTimestampedSessionBytesStore(final SessionStore<Bytes, byte[]> bytesStore) {
        super(bytesStore);
    }
