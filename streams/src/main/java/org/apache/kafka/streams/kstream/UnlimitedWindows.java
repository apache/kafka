...
public class UnlimitedWindows extends Windows<UnlimitedWindow> {
    ...
    /**
     * Return an unlimited window definition TODO ?
     */
    ...
    /**
     * Return a new unlimited window for the specified start timestamp. TODO ?
     *
     * @param start  the window start time in milliseconds
