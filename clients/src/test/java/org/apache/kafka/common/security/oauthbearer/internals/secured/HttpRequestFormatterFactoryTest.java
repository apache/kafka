...
public class HttpRequestFormatterFactoryTest extends OAuthBearerTest {
    ...
    public void testCreateWithLocalClientAssertionWithPassphraseOnUnencryptedKey() throws Exception {
        ...
        assertThrows(JwtRetrieverException.class, () -> HttpRequestFormatterFactory.create(cu, jou));
    }
    ...
    public void testCreateWithClientAssertionThrowsExceptionForInvalidKeyPath() {
        ...
        assertThrows(ConfigException.class, () -> HttpRequestFormatterFactory.create(cu, jou));
    }
