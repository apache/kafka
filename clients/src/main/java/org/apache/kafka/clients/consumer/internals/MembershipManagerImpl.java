...
public class MembershipManagerImpl implements MembershipManager {
    ...
    void maybeReconcile() {
        ...
        commitResult = commitRequestManager.maybeAutoCommitSyncBeforeRevocation(time.timer(rebalanceTimeoutMs));
    ...
    private CompletableFuture<Void> enqueueConsumerRebalanceListenerCallback(ConsumerRebalanceListenerMethodName methodName,
        ...
        // TODO: we likely want our event to expire at some point.
        Timer t = time.timer(Long.MAX_VALUE);
        CompletableBackgroundEvent<Void> event = new ConsumerRebalanceListenerCallbackNeededEvent(methodName, sortedPartitions, t);
