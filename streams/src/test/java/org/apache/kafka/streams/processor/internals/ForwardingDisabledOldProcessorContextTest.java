...
public class ForwardingDisabledOldProcessorContextTest {
    @Mock(MockType.NICE)
    private ProcessorContext delegate;
    private ForwardingDisabledOldProcessorContext context;

    @Before
    public void setUp() {
        context = new ForwardingDisabledOldProcessorContext(delegate);
    }
