...
public class StreamThreadTest {
    ...
    public void testPartitionAssignmentChange() throws Exception {
        ...
        StreamThread thread = new StreamThread(builder, config, new MockClientSupplier(), applicationId, clientId, processId, new Metrics(), new StreamThreadMetricsRegistry(), new SystemTime()) {
            @Override
    ...
    public void testMaybeClean() throws Exception {
        ...
        try {
            ...
            StreamThread thread = new StreamThread(builder, config, new MockClientSupplier(), applicationId, clientId,  processId, new Metrics(), new StreamThreadMetricsRegistry(), mockTime) {
                @Override
    ...
    public void testInjectClients() {
        ...
        StreamThread thread = new StreamThread(builder, config, clientSupplier, applicationId,
                                               clientId,  processId, new Metrics(),
                                               new StreamThreadMetricsRegistry(), new MockTime());
