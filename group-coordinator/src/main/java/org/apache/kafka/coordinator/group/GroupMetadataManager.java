...
public class GroupMetadataManager {
    ...
    ConsumerGroup getOrMaybeCreateConsumerGroup(
        ...
        if (group == null) {
            return new ConsumerGroup(logContext, snapshotRegistry, groupId, this::image);
    ...
    ConsumerGroup getOrMaybeCreatePersistedConsumerGroup(
        ...
        if (group == null) {
            ConsumerGroup consumerGroup = new ConsumerGroup(logContext, snapshotRegistry, groupId, this::image);
