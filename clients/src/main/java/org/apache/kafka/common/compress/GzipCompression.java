...
public class GzipCompression implements Compression {
    ...
    public static class Builder implements Compression.Builder<GzipCompression> {
        ...
        public Builder bufferSize(int bufferSize) {
            if (bufferSize < MIN_BUFFER_SIZE) {
                throw new IllegalArgumentException("gzip doesn't support given buffer size: " + bufferSize + " (min: " + MIN_BUFFER_SIZE + ")");
            }
            this.bufferSize = bufferSize;
            return this;
        }
    ...
    public static class BufferSizeValidator implements ConfigDef.Validator {
        ...
        public void ensureValid(String name, Object o) {
            ...
            if (bufferSize < MIN_BUFFER_SIZE) {
                throw new ConfigException(name, o, "Value must be at least " + MIN_BUFFER_SIZE);
            }
        }
