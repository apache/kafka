...
public class AddOffsetsToTxnRequest extends AbstractRequest {
    ...
    private static final Schema ADD_OFFSETS_TO_TXN_REQUEST_V0 = new Schema(
            ...
            new FieldDef(EPOCH_KEY_NAME, INT16, "Current epoch associated with the producer id."),
            new FieldDef(CONSUMER_GROUP_ID_KEY_NAME, STRING, "Consumer group id whose offsets should be included in the transaction."));
