...
public class CastleSshTest {
    ...
    public void testArgParse() throws Exception {
        ...
        try (MiniCastleCluster miniCluster = clusterBuilder.build()) {
            try {
                CastleSsh.parse(miniCluster.cluster(), Collections.<String>emptyList());
            ...
            CastleSsh.CastleSshArgs args = CastleSsh.parse(miniCluster.cluster(),
            ...
            CastleSsh.CastleSshArgs args2 = CastleSsh.parse(miniCluster.cluster(),
