...
public class RequestResponseTest {
    ...
    public void testSerialization() throws Exception {
        ...
        checkRequest(createUpdateMetadataRequest(2, "rack1"), true);
        checkRequest(createUpdateMetadataRequest(2, null), true);
        checkErrorResponse(createUpdateMetadataRequest(2, "rack1"), new UnknownServerException(), true);
        checkRequest(createUpdateMetadataRequest(3, "rack1"), true);
        ...
        checkRequest(createUpdateMetadataRequest(4, "rack1"), true);
        checkRequest(createUpdateMetadataRequest(4, null), true);
