...
object Defaults {
  ...
  val DelegationTokenMetadataEncryptionDefault = true
...
object KafkaConfig {
  ...
  val DelegationTokenMetadataEncryptionEnableProp = "delegation.token.metadata.encryption.enable"
  ...
  val DelegationTokenMetadataEncryptionEnableDoc = "Encrypt delegation token metadata"
  ...
  private val configDef = {
    ...
    /** ********* Fetch Session Configuration **************/
      ...
      .define(DelegationTokenMetadataEncryptionEnableProp, BOOLEAN, Defaults.DelegationTokenMetadataEncryptionDefault, MEDIUM, DelegationTokenMetadataEncryptionEnableDoc)
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean, dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  val delegationTokenMetadataEncryptionEnable = getBoolean(KafkaConfig.DelegationTokenMetadataEncryptionEnableProp)
