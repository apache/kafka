...
public class RangeAssignorTest {
    ...
    public void testTwoConsumersOneTopicOnePartition() {
        ...
        assertAssignment(Collections.singletonList(new TopicPartition(topic, 0)), assignment.get(consumer1));
    ...
    public void testTwoConsumersOneTopicTwoPartitions() {
        ...
        Map<String, List<TopicPartition>> assignment = assignor.assign(partitionsPerTopic, consumers);
        assertAssignment(Collections.singletonList(new TopicPartition(topic, 0)), assignment.get(consumer1));
        assertAssignment(Collections.singletonList(new TopicPartition(topic, 1)), assignment.get(consumer2));
    }
    ...
    public void testMultipleConsumersMixedTopics() {
        ...
        Map<String, List<TopicPartition>> assignment = assignor.assign(partitionsPerTopic, consumers);
        assertAssignment(Collections.singletonList(
