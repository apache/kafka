...
class KTableTransformValues<K, V, V1> implements KTableProcessorSupplier<K, Change<V>, K, V1> {
    ...
    private class KTableTransformValuesProcessor implements TypedProcessor<K, Change<V>, K, Change<V1>> {
