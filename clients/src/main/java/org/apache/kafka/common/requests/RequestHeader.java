...
public class RequestHeader extends AbstractRequestResponse {
    ...
    public RequestHeader(ApiKeys requestApiKey, short requestVersion, String clientId, int correlationId) {
        ...
        this.headerVersion = ApiMessageType.fromApiKey(requestApiKey.id).headerVersion(requestVersion);
    }
    ...
    public static RequestHeader parse(ByteBuffer buffer) {
        ...
        try {
            ...
            ApiMessageType apiMessageType = ApiMessageType.fromApiKey(apiKey);
            short headerVersion = apiMessageType.headerVersion(apiVersion);
            buffer.rewind();
