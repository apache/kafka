...
Additional documentation on using the Streams API is available [here](/38/streams). 
...
When using Scala you may optionally include the `kafka-streams-scala` library. Additional documentation on using the Kafka Streams DSL for Scala is available [in the developer guide](/38/streams/developer-guide/dsl-api.html#scala-dsl). 
