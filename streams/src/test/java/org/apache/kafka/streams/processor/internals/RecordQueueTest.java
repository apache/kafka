...
import org.apache.kafka.streams.processor.RobustConsumerRecordTimestampExtractor;
...
public class RecordQueueTest {
    ...
    public void shouldThrowOnNegativeTimestamp() {
        ...
        queue.addRawRecords(records, new ConsumerRecordTimestampExtractor());
    }
    ...
    public void shouldDropOnNegativeTimestamp() {
        ...
        queue.addRawRecords(records, new RobustConsumerRecordTimestampExtractor());
