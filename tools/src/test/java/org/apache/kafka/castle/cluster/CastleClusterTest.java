...
public class CastleClusterTest {
    @Rule
    final public Timeout globalTimeout = Timeout.millis(120000);

    private MiniCastleCluster createMiniCastleCluster() throws Exception {
        MiniCastleCluster.Builder builder = new MiniCastleCluster.Builder();
    ...
    public void testNodesWithRole() throws Exception {
        try (MiniCastleCluster miniCluster = createMiniCastleCluster()) {
    ...
    @Test
    public void testGetCastleNodesByNameOrIndices() throws Exception {
        try (MiniCastleCluster miniCluster = createMiniCastleCluster()) {
            String[] nodeNames = miniCluster.cluster().
                getCastleNodesByNamesOrIndices(Arrays.asList("node0", "node2")).
            ...
            String[] nodeNames2 = miniCluster.cluster().
                getCastleNodesByNamesOrIndices(Arrays.asList("1", "3")).
                toArray(new String[0]);
            ...
            String[] nodeNames3 = miniCluster.cluster().
                getCastleNodesByNamesOrIndices(Arrays.asList("all")).
                toArray(new String[0]);
