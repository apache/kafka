 ...
 */
public class StreamStreamJoinNode<K, V1, V2, VR> extends BaseJoinProcessorNode< V1, V2, VR> {

    private final ProcessorParameters<V1> thisWindowedStreamProcessorParameters;
    private final ProcessorParameters<V2> otherWindowedStreamProcessorParameters;
    ...
    private StreamStreamJoinNode(final String nodeName,
                                 ...
                                 final ProcessorParameters<V2> joinOtherProcessParameters,
                                 final ProcessorParameters<VR> joinMergeProcessorParameters,
                                 final ProcessorParameters<V1> thisWindowedStreamProcessorParameters,
                                 final ProcessorParameters<V2> otherWindowedStreamProcessorParameters,
    ...
    public static final class StreamStreamJoinNodeBuilder<K, V1, V2, VR> {
        ...
        private ProcessorParameters<V1> joinThisProcessorParameters;
        private ProcessorParameters<V2> joinOtherProcessorParameters;
        private ProcessorParameters<VR> joinMergeProcessorParameters;
        private ProcessorParameters<V1> thisWindowedStreamProcessorParameters;
        private ProcessorParameters<V2> otherWindowedStreamProcessorParameters;
        ...
        public StreamStreamJoinNodeBuilder<K, V1, V2, VR> withJoinThisProcessorParameters(final ProcessorParameters<V1> joinThisProcessorParameters) {
        ...
        public StreamStreamJoinNodeBuilder<K, V1, V2, VR> withJoinOtherProcessorParameters(final ProcessorParameters<V2> joinOtherProcessParameters) {
            this.joinOtherProcessorParameters = joinOtherProcessParameters;
            return this;
        }

        public StreamStreamJoinNodeBuilder<K, V1, V2, VR> withJoinMergeProcessorParameters(final ProcessorParameters<VR> joinMergeProcessorParameters) {
            this.joinMergeProcessorParameters = joinMergeProcessorParameters;
            return this;
        }

        public StreamStreamJoinNodeBuilder<K, V1, V2, VR> withThisWindowedStreamProcessorParameters(final ProcessorParameters<V1> thisWindowedStreamProcessorParameters) {
            this.thisWindowedStreamProcessorParameters = thisWindowedStreamProcessorParameters;
            return this;
        }
