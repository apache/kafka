...
public class FileRecordsTest {
    ...
    public void testFormatConversionWithPartialMessage() throws IOException {
        ...
        Records messageV0 = slice.downConvert(RecordBatch.MAGIC_VALUE_V0, 0).records();
    ...
    private void doTestConversion(CompressionType compressionType, byte toMagic) throws IOException {
        ...
        try (FileRecords fileRecords = FileRecords.open(tempFile())) {
            ...
            fileRecords.flush();
            Records convertedRecords = fileRecords.downConvert(toMagic, 0L).records();
            ...
            if (toMagic <= RecordBatch.MAGIC_VALUE_V1 && compressionType == CompressionType.NONE) {
                ...
                Records convertedRecords2 = fileRecords.downConvert(toMagic, firstOffset).records();
                ...
                Records convertedRecords2 = fileRecords.downConvert(toMagic, 10L).records();
