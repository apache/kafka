...
public class StreamTableJoinNode<K, V, VR> extends StreamsGraphNode<K, V, K, VR> {

    private final String[] storeNames;
    private final ProcessorParameters<K, V, K, VR> processorParameters;
    ...
    public void writeToTopology(final InternalTopologyBuilder topologyBuilder) {
        ...
        final TypedProcessorSupplier<? super K, ? super V, K, VR> processorSupplier = processorParameters.processorSupplier();
