...
object DumpLogSegments {
  ...
  def main(args: Array[String]) {
    ...
    CommandLineUtils.printHelpAndExitIfNeeded(opts, "Parse a log file and dump its contents to the console, useful for debugging a seemingly corrupt log segment.")
    opts.checkArgs()
  }
