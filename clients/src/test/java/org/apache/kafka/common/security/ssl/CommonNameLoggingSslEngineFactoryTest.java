...
public class CommonNameLoggingSslEngineFactoryTest {
    ...
    private CommonNameLoggingSslEngineFactory factory = new CommonNameLoggingSslEngineFactory();
    Map<String, Object> configs = new HashMap<>();

    @BeforeEach
    public void setUp() {
        factory = new CommonNameLoggingSslEngineFactory();
