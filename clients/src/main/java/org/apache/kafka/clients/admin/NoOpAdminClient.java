...
public class NoOpAdminClient extends AdminClient {
    ...
    @Override
    public FenceProducersResult fenceProducers(java.util.Collection<String> transactionalIds, FenceProducersOptions options) {
    ...
    public ListConsumerGroupOffsetsResult listConsumerGroupOffsets(
            java.util.Map<String, ListConsumerGroupOffsetsSpec> groupSpecs,
            ListConsumerGroupOffsetsOptions options) {
        return null;
    }
