...
public class StreamsGraphTest {
    ...
    private String expectedJoinedTopology = "Topologies:\n"
                                            ...
                                            + "    TypedProcessor: KSTREAM-WINDOWED-0000000002 (stores: [KSTREAM-JOINTHIS-0000000004-store])\n"
                                            + "      --> KSTREAM-JOINTHIS-0000000004\n"
                                            + "      <-- KSTREAM-SOURCE-0000000000\n"
                                            + "    TypedProcessor: KSTREAM-WINDOWED-0000000003 (stores: [KSTREAM-JOINOTHER-0000000005-store])\n"
                                            + "      --> KSTREAM-JOINOTHER-0000000005\n"
                                            + "      <-- KSTREAM-SOURCE-0000000001\n"
                                            + "    TypedProcessor: KSTREAM-JOINOTHER-0000000005 (stores: [KSTREAM-JOINTHIS-0000000004-store])\n"
                                            + "      --> KSTREAM-MERGE-0000000006\n"
                                            + "      <-- KSTREAM-WINDOWED-0000000003\n"
                                            + "    TypedProcessor: KSTREAM-JOINTHIS-0000000004 (stores: [KSTREAM-JOINOTHER-0000000005-store])\n"
                                            + "      --> KSTREAM-MERGE-0000000006\n"
                                            + "      <-- KSTREAM-WINDOWED-0000000002\n"
                                            + "    TypedProcessor: KSTREAM-MERGE-0000000006 (stores: [])\n"
                                            + "      --> none\n"
    ...
    private String expectedJoinedFilteredTopology = "Topologies:\n"
                                                    ...
                                                    + "      <-- KSTREAM-JOINTHIS-0000000004, KSTREAM-JOINOTHER-0000000005\n"
                                                    + "    TypedProcessor: KSTREAM-FILTER-0000000007 (stores: [])\n"
                                                    + "      --> none\n"
                                                    + "      <-- KSTREAM-MERGE-0000000006\n\n";
    ...
    private String expectedFullTopology = "Topologies:\n"
                                          ...
                                          + "      <-- KSTREAM-MERGE-0000000006\n"
                                          + "    TypedProcessor: KSTREAM-MAPVALUES-0000000008 (stores: [])\n"
