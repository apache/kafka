...
import org.apache.kafka.server.config.{ServerTopicConfigSynonyms, KafkaConfig => JKafkaConfig}
...
object KafkaConfig {
  ...
  val MetadataSnapshotMaxNewRecordBytesDoc = "This is the maximum number of bytes in the log between the latest " +
    ...
    s"${JKafkaConfig.METADATA_SNAPSHOT_MAX_NEW_RECORD_BYTES_DEFAULT}. To generate snapshots based on the time elapsed, see " +
  ...
  val MetadataSnapshotMaxIntervalMsDoc = "This is the maximum number of milliseconds to wait to generate a snapshot " +
    ...
    s"time based snapshot generation. The default value is ${JKafkaConfig.METADATA_SNAPSHOT_MAX_INTERVAL_MS_DEFAULT}. To generate " +
  ...
  val MetadataMaxIdleIntervalMsDoc = "This configuration controls how often the active " +
    ...
    s"are not appended to the metadata partition. The default value is ${JKafkaConfig.METADATA_MAX_IDLE_INTERVAL_MS_DEFAULT}"
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(ZkSessionTimeoutMsProp, INT, JKafkaConfig.ZK_SESSION_TIMEOUT_MS_DEFAULT, HIGH, ZkSessionTimeoutMsDoc)
      .define(ZkConnectionTimeoutMsProp, INT, null, HIGH, ZkConnectionTimeoutMsDoc)
      .define(ZkEnableSecureAclsProp, BOOLEAN, JKafkaConfig.ZK_ENABLE_SECURE_ACLS_DEFAULT, HIGH, ZkEnableSecureAclsDoc)
      .define(ZkMaxInFlightRequestsProp, INT, JKafkaConfig.ZK_MAX_IN_FLIGHT_REQUESTS_DEFAULT, atLeast(1), HIGH, ZkMaxInFlightRequestsDoc)
      .define(ZkSslClientEnableProp, BOOLEAN, JKafkaConfig.ZK_SSL_CLIENT_ENABLE_DEFAULT, MEDIUM, ZkSslClientEnableDoc)
      ...
      .define(ZkSslProtocolProp, STRING, JKafkaConfig.ZK_SSL_PROTOCOL_DEFAULT, LOW, ZkSslProtocolDoc)
      ...
      .define(ZkSslEndpointIdentificationAlgorithmProp, STRING, JKafkaConfig.ZK_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_DEFAULT, LOW, ZkSslEndpointIdentificationAlgorithmDoc)
      .define(ZkSslCrlEnableProp, BOOLEAN, JKafkaConfig.ZK_SSL_CRL_ENABLE_DEFAULT, LOW, ZkSslCrlEnableDoc)
      .define(ZkSslOcspEnableProp, BOOLEAN, JKafkaConfig.ZK_SSL_OCSP_ENABLE_DEFAULT, LOW, ZkSslOcspEnableDoc)

      /** ********* General Configuration ***********/
      .define(BrokerIdGenerationEnableProp, BOOLEAN, JKafkaConfig.BROKER_ID_GENERATION_ENABLE_DEFAULT, MEDIUM, BrokerIdGenerationEnableDoc)
      .define(MaxReservedBrokerIdProp, INT, JKafkaConfig.MAX_RESERVED_BROKER_ID_DEFAULT, atLeast(0), MEDIUM, MaxReservedBrokerIdDoc)
      .define(BrokerIdProp, INT, JKafkaConfig.BROKER_ID_DEFAULT, HIGH, BrokerIdDoc)
      .define(MessageMaxBytesProp, INT, LogConfig.DEFAULT_MAX_MESSAGE_BYTES, atLeast(0), HIGH, MessageMaxBytesDoc)
      .define(NumNetworkThreadsProp, INT, JKafkaConfig.NUM_NETWORK_THREADS_DEFAULT, atLeast(1), HIGH, NumNetworkThreadsDoc)
      .define(NumIoThreadsProp, INT, JKafkaConfig.NUM_IO_THREADS_DEFAULT, atLeast(1), HIGH, NumIoThreadsDoc)
      .define(NumReplicaAlterLogDirsThreadsProp, INT, null, HIGH, NumReplicaAlterLogDirsThreadsDoc)
      .define(BackgroundThreadsProp, INT, JKafkaConfig.BACKGROUND_THREADS_DEFAULT, atLeast(1), HIGH, BackgroundThreadsDoc)
      .define(QueuedMaxRequestsProp, INT, JKafkaConfig.QUEUED_MAX_REQUESTS_DEFAULT, atLeast(1), HIGH, QueuedMaxRequestsDoc)
      .define(QueuedMaxBytesProp, LONG, JKafkaConfig.QUEUED_MAX_REQUEST_BYTES_DEFAULT, MEDIUM, QueuedMaxRequestBytesDoc)
      .define(RequestTimeoutMsProp, INT, JKafkaConfig.REQUEST_TIMEOUT_MS_DEFAULT, HIGH, RequestTimeoutMsDoc)
      .define(ConnectionSetupTimeoutMsProp, LONG, JKafkaConfig.CONNECTION_SETUP_TIMEOUT_MS_DEFAULT, MEDIUM, ConnectionSetupTimeoutMsDoc)
      .define(ConnectionSetupTimeoutMaxMsProp, LONG, JKafkaConfig.CONNECTION_SETUP_TIMEOUT_MAX_MS_DEFAULT, MEDIUM, ConnectionSetupTimeoutMaxMsDoc)

      /*
       * KRaft mode configs.
       */
      .define(MetadataSnapshotMaxNewRecordBytesProp, LONG, JKafkaConfig.METADATA_SNAPSHOT_MAX_NEW_RECORD_BYTES_DEFAULT, atLeast(1), HIGH, MetadataSnapshotMaxNewRecordBytesDoc)
      .define(MetadataSnapshotMaxIntervalMsProp, LONG, JKafkaConfig.METADATA_SNAPSHOT_MAX_INTERVAL_MS_DEFAULT, atLeast(0), HIGH, MetadataSnapshotMaxIntervalMsDoc)
      .define(ProcessRolesProp, LIST, Collections.emptyList(), ValidList.in("broker", "controller"), HIGH, ProcessRolesDoc)
      .define(NodeIdProp, INT, JKafkaConfig.EMPTY_NODE_ID_DEFAULT, null, HIGH, NodeIdDoc)
      .define(InitialBrokerRegistrationTimeoutMsProp, INT, JKafkaConfig.INITIAL_BROKER_REGISTRATION_TIMEOUT_MS_DEFAULT, null, MEDIUM, InitialBrokerRegistrationTimeoutMsDoc)
      .define(BrokerHeartbeatIntervalMsProp, INT, JKafkaConfig.BROKER_HEARTBEAT_INTERVAL_MS_DEFAULT, null, MEDIUM, BrokerHeartbeatIntervalMsDoc)
      .define(BrokerSessionTimeoutMsProp, INT, JKafkaConfig.BROKER_SESSION_TIMEOUT_MS_DEFAULT, null, MEDIUM, BrokerSessionTimeoutMsDoc)
      ...
      .define(MetadataMaxRetentionBytesProp, LONG, JKafkaConfig.METADATA_MAX_RETENTION_BYTES_DEFAULT, null, HIGH, MetadataMaxRetentionBytesDoc)
      .define(MetadataMaxRetentionMillisProp, LONG, LogConfig.DEFAULT_RETENTION_MS, null, HIGH, MetadataMaxRetentionMillisDoc)
      .define(MetadataMaxIdleIntervalMsProp, INT, JKafkaConfig.METADATA_MAX_IDLE_INTERVAL_MS_DEFAULT, atLeast(0), LOW, MetadataMaxIdleIntervalMsDoc)
      .defineInternal(ServerMaxStartupTimeMsProp, LONG, JKafkaConfig.SERVER_MAX_STARTUP_TIME_MS_DEFAULT, atLeast(0), MEDIUM, ServerMaxStartupTimeMsDoc)
      ...
      /************* Authorizer Configuration ***********/
      .define(AuthorizerClassNameProp, STRING, JKafkaConfig.AUTHORIZER_CLASS_NAME_DEFAULT, new ConfigDef.NonNullValidator(), LOW, AuthorizerClassNameDoc)
      .define(EarlyStartListenersProp, STRING, null,  HIGH, EarlyStartListenersDoc)

      /** ********* Socket Server Configuration ***********/
      .define(ListenersProp, STRING, JKafkaConfig.LISTENERS_DEFAULT, HIGH, ListenersDoc)
      .define(AdvertisedListenersProp, STRING, null, HIGH, AdvertisedListenersDoc)
      .define(ListenerSecurityProtocolMapProp, STRING, JKafkaConfig.LISTENER_SECURITY_PROTOCOL_MAP_DEFAULT, LOW, ListenerSecurityProtocolMapDoc)
      .define(ControlPlaneListenerNameProp, STRING, null, HIGH, controlPlaneListenerNameDoc)
      .define(SocketSendBufferBytesProp, INT, JKafkaConfig.SOCKET_SEND_BUFFER_BYTES_DEFAULT, HIGH, SocketSendBufferBytesDoc)
      .define(SocketReceiveBufferBytesProp, INT, JKafkaConfig.SOCKET_RECEIVE_BUFFER_BYTES_DEFAULT, HIGH, SocketReceiveBufferBytesDoc)
      .define(SocketRequestMaxBytesProp, INT, JKafkaConfig.SOCKET_REQUEST_MAX_BYTES_DEFAULT, atLeast(1), HIGH, SocketRequestMaxBytesDoc)
      .define(SocketListenBacklogSizeProp, INT, JKafkaConfig.SOCKET_LISTEN_BACKLOG_SIZE_DEFAULT, atLeast(1), MEDIUM, SocketListenBacklogSizeDoc)
      .define(MaxConnectionsPerIpProp, INT, JKafkaConfig.MAX_CONNECTIONS_PER_IP_DEFAULT, atLeast(0), MEDIUM, MaxConnectionsPerIpDoc)
      .define(MaxConnectionsPerIpOverridesProp, STRING, JKafkaConfig.MAX_CONNECTIONS_PER_IP_OVERRIDES_DEFAULT, MEDIUM, MaxConnectionsPerIpOverridesDoc)
      .define(MaxConnectionsProp, INT, JKafkaConfig.MAX_CONNECTIONS_DEFAULT, atLeast(0), MEDIUM, MaxConnectionsDoc)
      .define(MaxConnectionCreationRateProp, INT, JKafkaConfig.MAX_CONNECTION_CREATION_RATE_DEFAULT, atLeast(0), MEDIUM, MaxConnectionCreationRateDoc)
      .define(ConnectionsMaxIdleMsProp, LONG, JKafkaConfig.CONNECTIONS_MAX_IDLE_MS_DEFAULT, MEDIUM, ConnectionsMaxIdleMsDoc)
      .define(FailedAuthenticationDelayMsProp, INT, JKafkaConfig.FAILED_AUTHENTICATION_DELAY_MS_DEFAULT, atLeast(0), LOW, FailedAuthenticationDelayMsDoc)

      /************ Rack Configuration ******************/
      .define(RackProp, STRING, null, MEDIUM, RackDoc)

      /** ********* Log Configuration ***********/
      .define(NumPartitionsProp, INT, JKafkaConfig.NUM_PARTITIONS_DEFAULT, atLeast(1), MEDIUM, NumPartitionsDoc)
      .define(LogDirProp, STRING, JKafkaConfig.LOG_DIR_DEFAULT, HIGH, LogDirDoc)
      ...
      .define(LogCleanupIntervalMsProp, LONG, JKafkaConfig.LOG_CLEANUP_INTERVAL_MS_DEFAULT, atLeast(1), MEDIUM, LogCleanupIntervalMsDoc)
      ...
      .define(LogCleanerThreadsProp, INT, JKafkaConfig.LOG_CLEANER_THREADS_DEFAULT, atLeast(0), MEDIUM, LogCleanerThreadsDoc)
      .define(LogCleanerIoMaxBytesPerSecondProp, DOUBLE, JKafkaConfig.LOG_CLEANER_IO_MAX_BYTES_PER_SECOND_DEFAULT, MEDIUM, LogCleanerIoMaxBytesPerSecondDoc)
      .define(LogCleanerDedupeBufferSizeProp, LONG, JKafkaConfig.LOG_CLEANER_DEDUPE_BUFFER_SIZE_DEFAULT, MEDIUM, LogCleanerDedupeBufferSizeDoc)
      .define(LogCleanerIoBufferSizeProp, INT, JKafkaConfig.LOG_CLEANER_IO_BUFFER_SIZE_DEFAULT, atLeast(0), MEDIUM, LogCleanerIoBufferSizeDoc)
      .define(LogCleanerDedupeBufferLoadFactorProp, DOUBLE, JKafkaConfig.LOG_CLEANER_DEDUPE_BUFFER_LOAD_FACTOR_DEFAULT, MEDIUM, LogCleanerDedupeBufferLoadFactorDoc)
      .define(LogCleanerBackoffMsProp, LONG, JKafkaConfig.LOG_CLEANER_BACKOFF_MS_DEFAULT, atLeast(0), MEDIUM, LogCleanerBackoffMsDoc)
      ...
      .define(LogCleanerEnableProp, BOOLEAN, JKafkaConfig.LOG_CLEANER_ENABLE_DEFAULT, MEDIUM, LogCleanerEnableDoc)
      ...
      .define(LogFlushOffsetCheckpointIntervalMsProp, INT, JKafkaConfig.LOG_FLUSH_OFFSET_CHECKPOINT_INTERVAL_MS_DEFAULT, atLeast(0), HIGH, LogFlushOffsetCheckpointIntervalMsDoc)
      .define(LogFlushStartOffsetCheckpointIntervalMsProp, INT, JKafkaConfig.LOG_FLUSH_START_OFFSET_CHECKPOINT_INTERVAL_MS_DEFAULT, atLeast(0), HIGH, LogFlushStartOffsetCheckpointIntervalMsDoc)
      .define(LogPreAllocateProp, BOOLEAN, LogConfig.DEFAULT_PREALLOCATE, MEDIUM, LogPreAllocateEnableDoc)
      .define(NumRecoveryThreadsPerDataDirProp, INT, JKafkaConfig.NUM_RECOVERY_THREADS_PER_DATA_DIR_DEFAULT, atLeast(1), HIGH, NumRecoveryThreadsPerDataDirDoc)
      .define(AutoCreateTopicsEnableProp, BOOLEAN, JKafkaConfig.AUTO_CREATE_TOPICS_ENABLE_DEFAULT, HIGH, AutoCreateTopicsEnableDoc)
      ...
      /** ********* Replication configuration ***********/
      .define(ControllerSocketTimeoutMsProp, INT, JKafkaConfig.CONTROLLER_SOCKET_TIMEOUT_MS_DEFAULT, MEDIUM, ControllerSocketTimeoutMsDoc)
      .define(DefaultReplicationFactorProp, INT, JKafkaConfig.REPLICATION_FACTOR_DEFAULT, MEDIUM, DefaultReplicationFactorDoc)
      .define(ReplicaLagTimeMaxMsProp, LONG, JKafkaConfig.REPLICA_LAG_TIME_MAX_MS_DEFAULT, HIGH, ReplicaLagTimeMaxMsDoc)
      .define(ReplicaSocketTimeoutMsProp, INT, JKafkaConfig.REPLICA_SOCKET_TIMEOUT_MS_DEFAULT, HIGH, ReplicaSocketTimeoutMsDoc)
      .define(ReplicaSocketReceiveBufferBytesProp, INT, JKafkaConfig.REPLICA_SOCKET_RECEIVE_BUFFER_BYTES_DEFAULT, HIGH, ReplicaSocketReceiveBufferBytesDoc)
      .define(ReplicaFetchMaxBytesProp, INT, JKafkaConfig.REPLICA_FETCH_MAX_BYTES_DEFAULT, atLeast(0), MEDIUM, ReplicaFetchMaxBytesDoc)
      .define(ReplicaFetchWaitMaxMsProp, INT, JKafkaConfig.REPLICA_FETCH_WAIT_MAX_MS_DEFAULT, HIGH, ReplicaFetchWaitMaxMsDoc)
      .define(ReplicaFetchBackoffMsProp, INT, JKafkaConfig.REPLICA_FETCH_BACKOFF_MS_DEFAULT, atLeast(0), MEDIUM, ReplicaFetchBackoffMsDoc)
      .define(ReplicaFetchMinBytesProp, INT, JKafkaConfig.REPLICA_FETCH_MIN_BYTES_DEFAULT, HIGH, ReplicaFetchMinBytesDoc)
      .define(ReplicaFetchResponseMaxBytesProp, INT, JKafkaConfig.REPLICA_FETCH_RESPONSE_MAX_BYTES_DEFAULT, atLeast(0), MEDIUM, ReplicaFetchResponseMaxBytesDoc)
      .define(NumReplicaFetchersProp, INT, JKafkaConfig.NUM_REPLICA_FETCHERS_DEFAULT, HIGH, NumReplicaFetchersDoc)
      .define(ReplicaHighWatermarkCheckpointIntervalMsProp, LONG, JKafkaConfig.REPLICA_HIGH_WATERMARK_CHECKPOINT_INTERVAL_MS_DEFAULT, HIGH, ReplicaHighWatermarkCheckpointIntervalMsDoc)
      .define(FetchPurgatoryPurgeIntervalRequestsProp, INT, JKafkaConfig.FETCH_PURGATORY_PURGE_INTERVAL_REQUESTS_DEFAULT, MEDIUM, FetchPurgatoryPurgeIntervalRequestsDoc)
      .define(ProducerPurgatoryPurgeIntervalRequestsProp, INT, JKafkaConfig.PRODUCER_PURGATORY_PURGE_INTERVAL_REQUESTS_DEFAULT, MEDIUM, ProducerPurgatoryPurgeIntervalRequestsDoc)
      .define(DeleteRecordsPurgatoryPurgeIntervalRequestsProp, INT, JKafkaConfig.DELETE_RECORDS_PURGATORY_PURGE_INTERVAL_REQUESTS_DEFAULT, MEDIUM, DeleteRecordsPurgatoryPurgeIntervalRequestsDoc)
      .define(AutoLeaderRebalanceEnableProp, BOOLEAN, JKafkaConfig.AUTO_LEADER_REBALANCE_ENABLE_DEFAULT, HIGH, AutoLeaderRebalanceEnableDoc)
      .define(LeaderImbalancePerBrokerPercentageProp, INT, JKafkaConfig.LEADER_IMBALANCE_PER_BROKER_PERCENTAGE_DEFAULT, HIGH, LeaderImbalancePerBrokerPercentageDoc)
      .define(LeaderImbalanceCheckIntervalSecondsProp, LONG, JKafkaConfig.LEADER_IMBALANCE_CHECK_INTERVAL_SECONDS_DEFAULT, atLeast(1), HIGH, LeaderImbalanceCheckIntervalSecondsDoc)
      ...
      .define(InterBrokerSecurityProtocolProp, STRING, JKafkaConfig.INTER_BROKER_SECURITY_PROTOCOL_DEFAULT, in(Utils.enumOptions(classOf[SecurityProtocol]):_*), MEDIUM, InterBrokerSecurityProtocolDoc)
      .define(InterBrokerProtocolVersionProp, STRING, JKafkaConfig.INTER_BROKER_PROTOCOL_VERSION_DEFAULT, new MetadataVersionValidator(), MEDIUM, InterBrokerProtocolVersionDoc)
      ...
      /** ********* Controlled shutdown configuration ***********/
      .define(ControlledShutdownMaxRetriesProp, INT, JKafkaConfig.CONTROLLED_SHUTDOWN_MAX_RETRIES_DEFAULT, MEDIUM, ControlledShutdownMaxRetriesDoc)
      .define(ControlledShutdownRetryBackoffMsProp, LONG, JKafkaConfig.CONTROLLED_SHUTDOWN_RETRY_BACKOFF_MS_DEFAULT, MEDIUM, ControlledShutdownRetryBackoffMsDoc)
      .define(ControlledShutdownEnableProp, BOOLEAN, JKafkaConfig.CONTROLLED_SHUTDOWN_ENABLE_DEFAULT, MEDIUM, ControlledShutdownEnableDoc)

      /** ********* Group coordinator configuration ***********/
      .define(GroupMinSessionTimeoutMsProp, INT, JKafkaConfig.GROUP_MIN_SESSION_TIMEOUT_MS_DEFAULT, MEDIUM, GroupMinSessionTimeoutMsDoc)
      .define(GroupMaxSessionTimeoutMsProp, INT, JKafkaConfig.GROUP_MAX_SESSION_TIMEOUT_MS_DEFAULT, MEDIUM, GroupMaxSessionTimeoutMsDoc)
      .define(GroupInitialRebalanceDelayMsProp, INT, JKafkaConfig.GROUP_INITIAL_REBALANCE_DELAY_MS_DEFAULT, MEDIUM, GroupInitialRebalanceDelayMsDoc)
      .define(GroupMaxSizeProp, INT, JKafkaConfig.GROUP_MAX_SIZE_DEFAULT, atLeast(1), MEDIUM, GroupMaxSizeDoc)

      /** New group coordinator configs */
      .define(GroupCoordinatorRebalanceProtocolsProp, LIST, JKafkaConfig.GROUP_COORDINATOR_REBALANCE_PROTOCOLS_DEFAULT,
        ConfigDef.ValidList.in(Utils.enumOptions(classOf[GroupType]):_*), MEDIUM, GroupCoordinatorRebalanceProtocolsDoc)
      .define(GroupCoordinatorNumThreadsProp, INT, JKafkaConfig.GROUP_COORDINATOR_NUM_THREADS_DEFAULT, atLeast(1), MEDIUM, GroupCoordinatorNumThreadsDoc)
      // Internal configuration used by integration and system tests.
      .defineInternal(NewGroupCoordinatorEnableProp, BOOLEAN, JKafkaConfig.NEW_GROUP_COORDINATOR_ENABLE_DEFAULT, null, MEDIUM, NewGroupCoordinatorEnableDoc)

      /** Consumer groups configs */
      .define(ConsumerGroupSessionTimeoutMsProp, INT, JKafkaConfig.CONSUMER_GROUP_SESSION_TIMEOUT_MS_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupSessionTimeoutMsDoc)
      .define(ConsumerGroupMinSessionTimeoutMsProp, INT, JKafkaConfig.CONSUMER_GROUP_MIN_SESSION_TIMEOUT_MS_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupMinSessionTimeoutMsDoc)
      .define(ConsumerGroupMaxSessionTimeoutMsProp, INT, JKafkaConfig.CONSUMER_GROUP_MAX_SESSION_TIMEOUT_MS_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupMaxSessionTimeoutMsDoc)
      .define(ConsumerGroupHeartbeatIntervalMsProp, INT, JKafkaConfig.CONSUMER_GROUP_HEARTBEAT_INTERVAL_MS_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupHeartbeatIntervalMsDoc)
      .define(ConsumerGroupMinHeartbeatIntervalMsProp, INT, JKafkaConfig.CONSUMER_GROUP_MIN_HEARTBEAT_INTERVAL_MS_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupMinHeartbeatIntervalMsDoc)
      .define(ConsumerGroupMaxHeartbeatIntervalMsProp, INT, JKafkaConfig.CONSUMER_GROUP_MAX_HEARTBEAT_INTERVAL_MS_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupMaxHeartbeatIntervalMsDoc)
      .define(ConsumerGroupMaxSizeProp, INT, JKafkaConfig.CONSUMER_GROUP_MAX_SIZE_DEFAULT, atLeast(1), MEDIUM, ConsumerGroupMaxSizeDoc)
      .define(ConsumerGroupAssignorsProp, LIST, JKafkaConfig.CONSUMER_GROUP_ASSIGNORS_DEFAULT, null, MEDIUM, ConsumerGroupAssignorsDoc)

      /** ********* Offset management configuration ***********/
      .define(OffsetMetadataMaxSizeProp, INT, JKafkaConfig.OFFSET_METADATA_MAX_SIZE_DEFAULT, HIGH, OffsetMetadataMaxSizeDoc)
      .define(OffsetsLoadBufferSizeProp, INT, JKafkaConfig.OFFSETS_LOAD_BUFFER_SIZE_DEFAULT, atLeast(1), HIGH, OffsetsLoadBufferSizeDoc)
      .define(OffsetsTopicReplicationFactorProp, SHORT, JKafkaConfig.OFFSETS_TOPIC_REPLICATION_FACTOR_DEFAULT, atLeast(1), HIGH, OffsetsTopicReplicationFactorDoc)
      .define(OffsetsTopicPartitionsProp, INT, JKafkaConfig.OFFSETS_TOPIC_PARTITIONS_DEFAULT, atLeast(1), HIGH, OffsetsTopicPartitionsDoc)
      .define(OffsetsTopicSegmentBytesProp, INT, JKafkaConfig.OFFSETS_TOPIC_SEGMENT_BYTES_DEFAULT, atLeast(1), HIGH, OffsetsTopicSegmentBytesDoc)
      .define(OffsetsTopicCompressionCodecProp, INT, JKafkaConfig.OFFSETS_TOPIC_COMPRESSION_CODEC_DEFAULT, HIGH, OffsetsTopicCompressionCodecDoc)
      .define(OffsetsRetentionMinutesProp, INT, JKafkaConfig.OFFSETS_RETENTION_MINUTES_DEFAULT, atLeast(1), HIGH, OffsetsRetentionMinutesDoc)
      .define(OffsetsRetentionCheckIntervalMsProp, LONG, JKafkaConfig.OFFSETS_RETENTION_CHECK_INTERVAL_MS_DEFAULT, atLeast(1), HIGH, OffsetsRetentionCheckIntervalMsDoc)
      .define(OffsetCommitTimeoutMsProp, INT, JKafkaConfig.OFFSET_COMMIT_TIMEOUT_MS_DEFAULT, atLeast(1), HIGH, OffsetCommitTimeoutMsDoc)
      .define(OffsetCommitRequiredAcksProp, SHORT, JKafkaConfig.OFFSET_COMMIT_REQUIRED_ACKS_DEFAULT, HIGH, OffsetCommitRequiredAcksDoc)
      .define(DeleteTopicEnableProp, BOOLEAN, JKafkaConfig.DELETE_TOPIC_ENABLE_DEFAULT, HIGH, DeleteTopicEnableDoc)
      ...
      /** ********* Transaction management configuration ***********/
      .define(TransactionalIdExpirationMsProp, INT, JKafkaConfig.TRANSACTIONAL_ID_EXPIRATION_MS_DEFAULT, atLeast(1), HIGH, TransactionalIdExpirationMsDoc)
      .define(TransactionsMaxTimeoutMsProp, INT, JKafkaConfig.TRANSACTIONS_MAX_TIMEOUT_MS_DEFAULT, atLeast(1), HIGH, TransactionsMaxTimeoutMsDoc)
      .define(TransactionsTopicMinISRProp, INT, JKafkaConfig.TRANSACTIONS_TOPIC_MIN_ISR_DEFAULT, atLeast(1), HIGH, TransactionsTopicMinISRDoc)
      .define(TransactionsLoadBufferSizeProp, INT, JKafkaConfig.TRANSACTIONS_LOAD_BUFFER_SIZE_DEFAULT, atLeast(1), HIGH, TransactionsLoadBufferSizeDoc)
      .define(TransactionsTopicReplicationFactorProp, SHORT, JKafkaConfig.TRANSACTIONS_TOPIC_REPLICATION_FACTOR_DEFAULT, atLeast(1), HIGH, TransactionsTopicReplicationFactorDoc)
      .define(TransactionsTopicPartitionsProp, INT, JKafkaConfig.TRANSACTIONS_TOPIC_PARTITIONS_DEFAULT, atLeast(1), HIGH, TransactionsTopicPartitionsDoc)
      .define(TransactionsTopicSegmentBytesProp, INT, JKafkaConfig.TRANSACTIONS_TOPIC_SEGMENT_BYTES_DEFAULT, atLeast(1), HIGH, TransactionsTopicSegmentBytesDoc)
      .define(TransactionsAbortTimedOutTransactionCleanupIntervalMsProp, INT, JKafkaConfig.TRANSACTIONS_ABORT_TIMED_OUT_CLEANUP_INTERVAL_MS_DEFAULT, atLeast(1), LOW, TransactionsAbortTimedOutTransactionsIntervalMsDoc)
      .define(TransactionsRemoveExpiredTransactionalIdCleanupIntervalMsProp, INT, JKafkaConfig.TRANSACTIONS_REMOVE_EXPIRED_CLEANUP_INTERVAL_MS_DEFAULT, atLeast(1), LOW, TransactionsRemoveExpiredTransactionsIntervalMsDoc)

      .define(TransactionPartitionVerificationEnableProp, BOOLEAN, JKafkaConfig.TRANSACTION_PARTITION_VERIFICATION_ENABLE_DEFAULT, LOW, TransactionPartitionVerificationEnableDoc)

      .define(ProducerIdExpirationMsProp, INT, JKafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT, atLeast(1), LOW, ProducerIdExpirationMsDoc)
      // Configuration for testing only as default value should be sufficient for typical usage
      .defineInternal(ProducerIdExpirationCheckIntervalMsProp, INT, JKafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT, atLeast(1), LOW, ProducerIdExpirationCheckIntervalMsDoc)

      /** ********* Fetch Configuration **************/
      .define(MaxIncrementalFetchSessionCacheSlots, INT, JKafkaConfig.MAX_INCREMENTAL_FETCH_SESSION_CACHE_SLOTS_DEFAULT, atLeast(0), MEDIUM, MaxIncrementalFetchSessionCacheSlotsDoc)
      .define(FetchMaxBytes, INT, JKafkaConfig.FETCH_MAX_BYTES_DEFAULT, atLeast(1024), MEDIUM, FetchMaxBytesDoc)

      /** ********* Request Limit Configuration ***********/
      .define(MaxRequestPartitionSizeLimit, INT, JKafkaConfig.MAX_REQUEST_PARTITION_SIZE_LIMIT_DEFAULT, atLeast(1), MEDIUM, MaxRequestPartitionSizeLimitDoc)

      /** ********* Kafka Metrics Configuration ***********/
      .define(MetricNumSamplesProp, INT, JKafkaConfig.METRIC_NUM_SAMPLES_DEFAULT, atLeast(1), LOW, MetricNumSamplesDoc)
      .define(MetricSampleWindowMsProp, LONG, JKafkaConfig.METRIC_SAMPLE_WINDOW_MS_DEFAULT, atLeast(1), LOW, MetricSampleWindowMsDoc)
      .define(MetricReporterClassesProp, LIST, JKafkaConfig.METRIC_REPORTER_CLASSES_DEFAULT, LOW, MetricReporterClassesDoc)
      .define(MetricRecordingLevelProp, STRING, JKafkaConfig.METRIC_RECORDING_LEVEL_DEFAULT, LOW, MetricRecordingLevelDoc)
      .define(AutoIncludeJmxReporterProp, BOOLEAN, JKafkaConfig.AUTO_INCLUDE_JMX_REPORTER_DEFAULT, LOW, AutoIncludeJmxReporterDoc)

      /** ********* Kafka Yammer Metrics Reporter Configuration for docs ***********/
      .define(KafkaMetricsReporterClassesProp, LIST, JKafkaConfig.KAFKA_METRIC_REPORTER_CLASSES_DEFAULT, LOW, KafkaMetricsReporterClassesDoc)
      .define(KafkaMetricsPollingIntervalSecondsProp, INT, JKafkaConfig.KAFKA_METRICS_POLLING_INTERVAL_SECONDS_DEFAULT, atLeast(1), LOW, KafkaMetricsPollingIntervalSecondsDoc)

      /** ********* Kafka Client Telemetry Metrics Configuration ***********/
      .define(ClientTelemetryMaxBytesProp, INT, JKafkaConfig.CLIENT_TELEMETRY_MAX_BYTES_DEFAULT, atLeast(1), LOW, ClientTelemetryMaxBytesDoc)

      /** ********* Quota configuration ***********/
      .define(NumQuotaSamplesProp, INT, JKafkaConfig.NUM_QUOTA_SAMPLES_DEFAULT, atLeast(1), LOW, NumQuotaSamplesDoc)
      .define(NumReplicationQuotaSamplesProp, INT, JKafkaConfig.NUM_REPLICATION_QUOTA_SAMPLES_DEFAULT, atLeast(1), LOW, NumReplicationQuotaSamplesDoc)
      .define(NumAlterLogDirsReplicationQuotaSamplesProp, INT, JKafkaConfig.NUM_ALTER_LOG_DIRS_REPLICATION_QUOTA_SAMPLES_DEFAULT, atLeast(1), LOW, NumAlterLogDirsReplicationQuotaSamplesDoc)
      .define(NumControllerQuotaSamplesProp, INT, JKafkaConfig.NUM_CONTROLLER_QUOTA_SAMPLES_DEFAULT, atLeast(1), LOW, NumControllerQuotaSamplesDoc)
      .define(QuotaWindowSizeSecondsProp, INT, JKafkaConfig.QUOTA_WINDOW_SIZE_SECONDS_DEFAULT, atLeast(1), LOW, QuotaWindowSizeSecondsDoc)
      .define(ReplicationQuotaWindowSizeSecondsProp, INT, JKafkaConfig.REPLICATION_QUOTA_WINDOW_SIZE_SECONDS_DEFAULT, atLeast(1), LOW, ReplicationQuotaWindowSizeSecondsDoc)
      .define(AlterLogDirsReplicationQuotaWindowSizeSecondsProp, INT, JKafkaConfig.ALTER_LOG_DIRS_REPLICATION_QUOTA_WINDOW_SIZE_SECONDS_DEFAULT, atLeast(1), LOW, AlterLogDirsReplicationQuotaWindowSizeSecondsDoc)
      .define(ControllerQuotaWindowSizeSecondsProp, INT, JKafkaConfig.CONTROLLER_QUOTA_WINDOW_SIZE_SECONDS_DEFAULT, atLeast(1), LOW, ControllerQuotaWindowSizeSecondsDoc)
      .define(ClientQuotaCallbackClassProp, CLASS, null, LOW, ClientQuotaCallbackClassDoc)

      /** ********* General Security Configuration ****************/
      .define(ConnectionsMaxReauthMsProp, LONG, JKafkaConfig.CONNECTIONS_MAX_REAUTH_MS_DEFAULT, MEDIUM, ConnectionsMaxReauthMsDoc)
      .define(SaslServerMaxReceiveSizeProp, INT, JKafkaConfig.SERVER_MAX_RECEIVE_SIZE_DEFAULT, MEDIUM, SaslServerMaxReceiveSizeDoc)
      .define(securityProviderClassProp, STRING, null, LOW, securityProviderClassDoc)

      /** ********* SSL Configuration ****************/
      .define(PrincipalBuilderClassProp, CLASS, JKafkaConfig.PRINCIPAL_BUILDER_DEFAULT, MEDIUM, PrincipalBuilderClassDoc)
      .define(SslProtocolProp, STRING, JKafkaConfig.SSL_PROTOCOL_DEFAULT, MEDIUM, SslProtocolDoc)
      .define(SslProviderProp, STRING, null, MEDIUM, SslProviderDoc)
      .define(SslEnabledProtocolsProp, LIST, JKafkaConfig.SSL_ENABLED_PROTOCOLS_DEFAULT, MEDIUM, SslEnabledProtocolsDoc)
      .define(SslKeystoreTypeProp, STRING, JKafkaConfig.SSL_KEYSTORE_TYPE_DEFAULT, MEDIUM, SslKeystoreTypeDoc)
      ...
      .define(SslTruststoreTypeProp, STRING, JKafkaConfig.SSL_TRUSTSTORE_TYPE_DEFAULT, MEDIUM, SslTruststoreTypeDoc)
      ...
      .define(SslKeyManagerAlgorithmProp, STRING, JKafkaConfig.SSL_KEY_MANAGER_ALGORITHM_DEFAULT, MEDIUM, SslKeyManagerAlgorithmDoc)
      .define(SslTrustManagerAlgorithmProp, STRING, JKafkaConfig.SSL_TRUST_MANAGER_ALGORITHM_DEFAULT, MEDIUM, SslTrustManagerAlgorithmDoc)
      .define(SslEndpointIdentificationAlgorithmProp, STRING, JKafkaConfig.SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_DEFAULT, LOW, SslEndpointIdentificationAlgorithmDoc)
      .define(SslSecureRandomImplementationProp, STRING, null, LOW, SslSecureRandomImplementationDoc)
      .define(SslClientAuthProp, STRING, JKafkaConfig.SSL_CLIENT_AUTHENTICATION_DEFAULT, in(JKafkaConfig.SSL_CLIENT_AUTHENTICATION_VALID_VALUES_DEFAULT:_*), MEDIUM, SslClientAuthDoc)
      .define(SslCipherSuitesProp, LIST, Collections.emptyList(), MEDIUM, SslCipherSuitesDoc)
      .define(SslPrincipalMappingRulesProp, STRING, JKafkaConfig.SSL_PRINCIPAL_MAPPING_RULES_DEFAULT, LOW, SslPrincipalMappingRulesDoc)
      ...
      /** ********* Sasl Configuration ****************/
      .define(SaslMechanismInterBrokerProtocolProp, STRING, JKafkaConfig.SASL_MECHANISM_INTER_BROKER_PROTOCOL_DEFAULT, MEDIUM, SaslMechanismInterBrokerProtocolDoc)
      .define(SaslJaasConfigProp, PASSWORD, null, MEDIUM, SaslJaasConfigDoc)
      .define(SaslEnabledMechanismsProp, LIST, JKafkaConfig.SASL_ENABLED_MECHANISMS_DEFAULT, MEDIUM, SaslEnabledMechanismsDoc)
      ...
      .define(SaslKerberosKinitCmdProp, STRING, JKafkaConfig.SASL_KERBEROS_KINIT_CMD_DEFAULT, MEDIUM, SaslKerberosKinitCmdDoc)
      .define(SaslKerberosTicketRenewWindowFactorProp, DOUBLE, JKafkaConfig.SASL_KERBEROS_TICKET_RENEW_WINDOW_FACTOR_DEFAULT, MEDIUM, SaslKerberosTicketRenewWindowFactorDoc)
      .define(SaslKerberosTicketRenewJitterProp, DOUBLE, JKafkaConfig.SASL_KERBEROS_TICKET_RENEW_JITTER_DEFAULT, MEDIUM, SaslKerberosTicketRenewJitterDoc)
      .define(SaslKerberosMinTimeBeforeReloginProp, LONG, JKafkaConfig.SASL_KERBEROS_MIN_TIME_BEFORE_RELOGIN_DEFAULT, MEDIUM, SaslKerberosMinTimeBeforeReloginDoc)
      .define(SaslKerberosPrincipalToLocalRulesProp, LIST, JKafkaConfig.SASL_KERBEROS_PRINCIPAL_TO_LOCAL_RULES_DEFAULT, MEDIUM, SaslKerberosPrincipalToLocalRulesDoc)
      .define(SaslLoginRefreshWindowFactorProp, DOUBLE, JKafkaConfig.SASL_LOGIN_REFRESH_WINDOW_FACTOR_DEFAULT, MEDIUM, SaslLoginRefreshWindowFactorDoc)
      .define(SaslLoginRefreshWindowJitterProp, DOUBLE, JKafkaConfig.SASL_LOGIN_REFRESH_WINDOW_JITTER_DEFAULT, MEDIUM, SaslLoginRefreshWindowJitterDoc)
      .define(SaslLoginRefreshMinPeriodSecondsProp, SHORT, JKafkaConfig.SASL_LOGIN_REFRESH_MIN_PERIOD_SECONDS_DEFAULT, MEDIUM, SaslLoginRefreshMinPeriodSecondsDoc)
      .define(SaslLoginRefreshBufferSecondsProp, SHORT, JKafkaConfig.SASL_LOGIN_REFRESH_BUFFER_SECONDS_DEFAULT, MEDIUM, SaslLoginRefreshBufferSecondsDoc)
      ...
      .define(SaslLoginRetryBackoffMaxMsProp, LONG, JKafkaConfig.SASL_LOGIN_RETRY_BACKOFF_MAX_MS_DEFAULT, LOW, SaslLoginRetryBackoffMaxMsDoc)
      .define(SaslLoginRetryBackoffMsProp, LONG, JKafkaConfig.SASL_LOGIN_RETRY_BACKOFF_MS_DEFAULT, LOW, SaslLoginRetryBackoffMsDoc)
      .define(SaslOAuthBearerScopeClaimNameProp, STRING, JKafkaConfig.SASL_OAUTH_BEARER_SCOPE_CLAIM_NAME_DEFAULT, LOW, SaslOAuthBearerScopeClaimNameDoc)
      .define(SaslOAuthBearerSubClaimNameProp, STRING, JKafkaConfig.SASL_OAUTH_BEARER_SUB_CLAIM_NAME_DEFAULT, LOW, SaslOAuthBearerSubClaimNameDoc)
      ...
      .define(SaslOAuthBearerJwksEndpointRefreshMsProp, LONG, JKafkaConfig.SASL_OAUTH_BEARER_JWKS_ENDPOINT_REFRESH_MS_DEFAULT, LOW, SaslOAuthBearerJwksEndpointRefreshMsDoc)
      .define(SaslOAuthBearerJwksEndpointRetryBackoffMsProp, LONG, JKafkaConfig.SASL_OAUTH_BEARER_JWKS_ENDPOINT_RETRY_BACKOFF_MS_DEFAULT, LOW, SaslOAuthBearerJwksEndpointRetryBackoffMsDoc)
      .define(SaslOAuthBearerJwksEndpointRetryBackoffMaxMsProp, LONG, JKafkaConfig.SASL_OAUTH_BEARER_JWKS_ENDPOINT_RETRY_BACKOFF_MAX_MS_DEFAULT, LOW, SaslOAuthBearerJwksEndpointRetryBackoffMaxMsDoc)
      .define(SaslOAuthBearerClockSkewSecondsProp, INT, JKafkaConfig.SASL_OAUTH_BEARER_CLOCK_SKEW_SECONDS_DEFAULT, LOW, SaslOAuthBearerClockSkewSecondsDoc)
      ...
      .define(DelegationTokenMaxLifeTimeProp, LONG, JKafkaConfig.DELEGATION_TOKEN_MAX_LIFE_TIME_MS_DEFAULT, atLeast(1), MEDIUM, DelegationTokenMaxLifeTimeDoc)
      .define(DelegationTokenExpiryTimeMsProp, LONG, JKafkaConfig.DELEGATION_TOKEN_EXPIRY_TIME_MS_DEFAULT, atLeast(1), MEDIUM, DelegationTokenExpiryTimeMsDoc)
      .define(DelegationTokenExpiryCheckIntervalMsProp, LONG, JKafkaConfig.DELEGATION_TOKEN_EXPIRY_CHECK_INTERVAL_MS_DEFAULT, atLeast(1), LOW, DelegationTokenExpiryCheckIntervalDoc)
      ...
      .define(PasswordEncoderCipherAlgorithmProp, STRING, JKafkaConfig.PASSWORD_ENCODER_CIPHER_ALGORITHM_DEFAULT, LOW, PasswordEncoderCipherAlgorithmDoc)
      .define(PasswordEncoderKeyLengthProp, INT, JKafkaConfig.PASSWORD_ENCODER_KEY_LENGTH_DEFAULT, atLeast(8), LOW, PasswordEncoderKeyLengthDoc)
      .define(PasswordEncoderIterationsProp, INT, JKafkaConfig.PASSWORD_ENCODER_ITERATIONS_DEFAULT, atLeast(1024), LOW, PasswordEncoderIterationsDoc)

      /** ********* Raft Quorum Configuration *********/
      .define(RaftConfig.QUORUM_VOTERS_CONFIG, LIST, JKafkaConfig.QUORUM_VOTERS_DEFAULT, new RaftConfig.ControllerQuorumVotersValidator(), HIGH, RaftConfig.QUORUM_VOTERS_DOC)
      .define(RaftConfig.QUORUM_ELECTION_TIMEOUT_MS_CONFIG, INT, JKafkaConfig.QUORUM_ELECTION_TIMEOUT_MS_DEFAULT, null, HIGH, RaftConfig.QUORUM_ELECTION_TIMEOUT_MS_DOC)
      .define(RaftConfig.QUORUM_FETCH_TIMEOUT_MS_CONFIG, INT, JKafkaConfig.QUORUM_FETCH_TIMEOUT_MS_DEFAULT, null, HIGH, RaftConfig.QUORUM_FETCH_TIMEOUT_MS_DOC)
      .define(RaftConfig.QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIG, INT, JKafkaConfig.QUORUM_ELECTION_BACKOFF_MS_DEFAULT, null, HIGH, RaftConfig.QUORUM_ELECTION_BACKOFF_MAX_MS_DOC)
      .define(RaftConfig.QUORUM_LINGER_MS_CONFIG, INT, JKafkaConfig.QUORUM_LINGER_MS_DEFAULT, null, MEDIUM, RaftConfig.QUORUM_LINGER_MS_DOC)
      .define(RaftConfig.QUORUM_REQUEST_TIMEOUT_MS_CONFIG, INT, JKafkaConfig.QUORUM_REQUEST_TIMEOUT_MS_DEFAULT, null, MEDIUM, RaftConfig.QUORUM_REQUEST_TIMEOUT_MS_DOC)
      .define(RaftConfig.QUORUM_RETRY_BACKOFF_MS_CONFIG, INT, JKafkaConfig.QUORUM_RETRY_BACKOFF_MS_DEFAULT, null, LOW, RaftConfig.QUORUM_RETRY_BACKOFF_MS_DOC)
