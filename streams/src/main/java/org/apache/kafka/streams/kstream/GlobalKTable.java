 ...
 * <p>
 * {@link GlobalKTable} can only be used as right-hand side input for {@link KStream stream}-table joins.
 * <p>
 * In contrast to a {@link KTable} that is partitioned over all {@link KafkaStreams} instances, a {@link GlobalKTable}
 * is fully replicated per {@link KafkaStreams} instance.
 * Every partition of the underlying topic is consumed by each {@link GlobalKTable}, such that the full set of data is
 ...
 * All joins with the {@link GlobalKTable} require that a {@link KeyValueMapper} is provided that can map from the
