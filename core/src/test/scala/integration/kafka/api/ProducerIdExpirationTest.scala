...
import org.apache.kafka.server.config.{ControlledShutdownConfigs, ReplicationConfigs, ServerLogConfigs}
...
class ProducerIdExpirationTest extends KafkaServerTestHarness {
  ...
  private def serverProps(): Properties = {
    ...
    serverProps.put(ControlledShutdownConfigs.CONTROLLED_SHUTDOWN_ENABLE_CONFIG, true.toString)
