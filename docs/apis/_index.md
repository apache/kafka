...
The [Streams](/42/streams) API allows transforming streams of data from input topics to output topics. 
...
Additional documentation on using the Streams API is available [here](/42/streams). 
...
When using Scala you may optionally include the `kafka-streams-scala` library. Additional documentation on using the Kafka Streams DSL for Scala is available [in the developer guide](/42/streams/developer-guide/dsl-api.html#scala-dsl). 
