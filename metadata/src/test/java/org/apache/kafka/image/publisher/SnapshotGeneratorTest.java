...
public class SnapshotGeneratorTest {
    ...
    static {
        TEST_DELTA = new MetadataDelta.Builder().
                ...
                setMetadataVersion(IBP_3_3_IV2).
                build();
    ...
    public void testCreateSnapshot() throws Exception {
        ...
        try (SnapshotGenerator generator = new SnapshotGenerator.Builder(emitter).
            ...
            generator.publishLogDelta(TEST_DELTA, TEST_IMAGE,
                    new LogDeltaManifest(MetadataProvenance.EMPTY, 1, 100, 100));
            // Pre-version change images are always queued for writing, even if there is another
            // image in progress.
            for (int i = 0; i < 2; i++) {
                generator.publishPreVersionChangeImage(TEST_DELTA, TEST_IMAGE,
                        new PreVersionChangeManifest(MetadataProvenance.EMPTY,
