...
public class SessionWindowedCogroupedKStreamImplTest {
    ...
    public void shouldNotHaveNullNamedAndMaterializedOnAggregate() {
        windowedCogroupedStream.aggregate(MockInitializer.STRING_INIT, null, sessionMerger,  null);
    }

    @Test(expected = NullPointerException.class)
    public void shouldNotHaveNullSessionMergerNamedAndMaterializedOnAggregate() {
        windowedCogroupedStream.aggregate(MockInitializer.STRING_INIT, null, null,  null);
    }

    @Test(expected = NullPointerException.class)
    public void shouldNotHaveNullInitializerSessionMergerNamedAndMaterializedOnAggregate() {
        windowedCogroupedStream.aggregate(null, null, null,  null);
    }
