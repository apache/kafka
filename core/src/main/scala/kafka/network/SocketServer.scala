...
import org.apache.kafka.common.network.{ChannelBuilders, KafkaChannel, LoginType, Mode, Selectable, Selector => KSelector, SelectorMetricsRegistry}
...
private[kafka] class Processor(val id: Int,
  ...
  private val selector = new KSelector(
    ...
    metrics,
    time,
    new SelectorMetricsRegistry("socket-server"),
    metricTags,
    false,
