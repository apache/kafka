...
public class RocksDBWindowStoreTest {
    ...
    private final PlainSegments segments = new PlainSegments(windowName, retentionPeriod, segmentInterval);
    ...
    public void testRangeAndSinglePointFetch() {
        ...
        verifyStore("one", 1, startTime);
        verifyStore("two", 2, startTime);
        verifyStore(null, 3, startTime);
        verifyStore("four", 4, startTime);
        verifyStore("five", 5, startTime);
