...
public interface ThreadCacheMetrics {
     ...
     */
    Sensor addCountSensor(String entityName, String operationName, String... tags);

    /**
     * Record the given count value of the sensor.
     */
    void recordCount(Sensor sensor, long count);
}
