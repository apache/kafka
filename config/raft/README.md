...
# Introduction
It is now possible to run Apache Kafka without Apache ZooKeeper!  We call this [Raft mode](https://cwiki.apache.org/confluence/display/KAFKA/KIP-500%3A+Replace+ZooKeeper+with+a+Self-Managed+Metadata+Quorum).
