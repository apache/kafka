...
public class ZkConfigs {
    ...
    static {
        ...
        zkSslConfigToSystemPropertyMap.put(ZK_SSL_CLIENT_ENABLE_CONFIG, ZKClientConfig.SECURE_CLIENT);
        zkSslConfigToSystemPropertyMap.put(ZK_CLIENT_CNXN_SOCKET_CONFIG, ZKClientConfig.ZOOKEEPER_CLIENT_CNXN_SOCKET);
