...
public class MergedSortedCacheKeyValueStoreIteratorTest {
    ...
    public void shouldIterateOverRange() throws Exception {
        ...
        final MergedSortedCacheKeyValueStoreIterator iterator = new MergedSortedCacheKeyValueStoreIterator(cacheIterator, storeIterator);
    ...
    public void shouldSkipLargerDeletedCacheValue() throws Exception {
        ...
        final MergedSortedCacheKeyValueStoreIterator iterator = createIterator();
    ...
    public void shouldPeekNextKey() throws Exception {
        ...
        final MergedSortedCacheKeyValueStoreIterator iterator =
    ...
    private MergedSortedCacheKeyValueStoreIterator createIterator() {
