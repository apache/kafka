...
class LogConfigTest {
  ...
  def ensureNoStaticInitializationOrderDependency(): Unit = {
    ...
    assertNotNull(KafkaLogConfigs.LOG_RETENTION_TIME_MILLIS_CONFIG)
  ...
  def testKafkaConfigToProps(): Unit = {
    ...
    kafkaProps.put(KafkaLogConfigs.LOG_ROLL_TIME_HOURS_CONFIG, "2")
    kafkaProps.put(KafkaLogConfigs.LOG_ROLL_TIME_JITTER_HOURS_CONFIG, "2")
    kafkaProps.put(KafkaLogConfigs.LOG_RETENTION_TIME_HOURS_CONFIG, "960") // 40 days
    kafkaProps.put(KafkaLogConfigs.LOG_MESSAGE_FORMAT_VERSION_CONFIG, "0.11.0")
  ...
  def testGetConfigValue(): Unit = {
    ...
    assertEquals(KafkaLogConfigs.LOG_DELETE_DELAY_MS_CONFIG, deleteDelayServerDefault)
  ...
  def testOverriddenConfigsAsLoggableString(): Unit = {
    ...
    kafkaProps.put(KafkaLogConfigs.LOG_RETENTION_BYTES_CONFIG, "50")
  ...
  def testTopicCreationWithInvalidRetentionTime(sysRemoteStorageEnabled: Boolean): Unit = {
    val kafkaProps = TestUtils.createDummyBrokerConfig()
    kafkaProps.put(RemoteLogManagerConfig.REMOTE_LOG_STORAGE_SYSTEM_ENABLE_PROP, sysRemoteStorageEnabled.toString)
    kafkaProps.put(KafkaLogConfigs.LOG_RETENTION_TIME_MILLIS_CONFIG, "1000")
  ...
  def testTopicCreationWithInvalidRetentionSize(sysRemoteStorageEnabled: Boolean): Unit = {
    ...
    props.put(KafkaLogConfigs.LOG_RETENTION_BYTES_CONFIG, "1024")
  ...
  def testTimestampBeforeMaxMsUsesDeprecatedConfig(): Unit = {
    ...
    val kafkaProps = TestUtils.createBrokerConfig(nodeId = 0, zkConnect = "")
    kafkaProps.put(KafkaLogConfigs.LOG_MESSAGE_TIMESTAMP_BEFORE_MAX_MS_CONFIG, Long.MaxValue.toString)
    kafkaProps.put(KafkaLogConfigs.LOG_MESSAGE_TIMESTAMP_AFTER_MAX_MS_CONFIG, Long.MaxValue.toString)
    kafkaProps.put(KafkaLogConfigs.LOG_MESSAGE_TIMESTAMP_DIFFERENCE_MAX_MS_CONFIG, oneDayInMillis.toString)
