...
public class ForeignJoinSubscriptionProcessorSupplier<K, KO, VO> implements
    ...
    private final class KTableKTableJoinProcessor extends
        ContextualProcessor<KO, Change<VO>, K, SubscriptionResponseWrapper<VO>> {
        ...
        public void init(final ProcessorContext<K, SubscriptionResponseWrapper<VO>> context) {
            super.init(context);
            final InternalProcessorContext<K, SubscriptionResponseWrapper<VO>> internalProcessorContext =
                (InternalProcessorContext<K, SubscriptionResponseWrapper<VO>>) context;
...
//                );
            ...
            try (final KeyValueIterator<Bytes, ValueAndTimestamp<SubscriptionWrapper<K>>> prefixScanResults =
                ...
                while (prefixScanResults.hasNext()) {
                    final KeyValue<Bytes, ValueAndTimestamp<SubscriptionWrapper<K>>> next = prefixScanResults
                        .next();
