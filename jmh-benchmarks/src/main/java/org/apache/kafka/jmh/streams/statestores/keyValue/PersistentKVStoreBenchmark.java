...
public class PersistentKVStoreBenchmark extends KeyValueStateStoreBenchmark {

    @Setup(Level.Trial)
    public void setUp() {
        storeKeys();
        this.keyValueStore = Stores.keyValueStoreBuilder(Stores.persistentKeyValueStore("rocks"),
            Serdes.String(),
            Serdes.String())
            .withCachingDisabled()
            .withLoggingDisabled()
