...
public class ListPartitionReassignmentsResponse extends AbstractResponse {
    ...
    public ListPartitionReassignmentsResponse(ListPartitionReassignmentsResponseData data) {
        this.data = data;
    }
    ...
    public ListPartitionReassignmentsResponse(Struct struct) {
        short latestVersion = (short) (ListPartitionReassignmentsResponseData.SCHEMAS.length - 1);
        this.data = new ListPartitionReassignmentsResponseData(struct, latestVersion);
    }
    ...
    public static ListPartitionReassignmentsResponse parse(ByteBuffer buffer, short version) {
        return new ListPartitionReassignmentsResponse(
                ApiKeys.LIST_PARTITION_REASSIGNMENTS.responseSchema(version).read(buffer), version);
    }
