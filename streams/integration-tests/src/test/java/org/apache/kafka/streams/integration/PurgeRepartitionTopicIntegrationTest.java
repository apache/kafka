...
public class PurgeRepartitionTopicIntegrationTest {
        ...
        public final boolean conditionMet() {
            ...
            try {
                ...
                return config.get(TopicConfig.CLEANUP_POLICY_CONFIG).value().equals(TopicConfig.CLEANUP_POLICY_DELETE)
                        ...
                        && config.get(ServerLogConfigs.INTERNAL_SEGMENT_BYTES_CONFIG).value().equals(PURGE_SEGMENT_BYTES.toString());
            } catch (final Exception e) {
                return false;
            }
        }
    ...
    public void setup() {
        ...
        streamsConfiguration.put(StreamsConfig.topicPrefix(ServerLogConfigs.INTERNAL_SEGMENT_BYTES_CONFIG), PURGE_SEGMENT_BYTES);
