 ...
 */
abstract class BaseJoinProcessorNode<V1, V2, VR> extends StreamsGraphNode {

    private final ProcessorParameters<V1> joinThisProcessorParameters;
    private final ProcessorParameters<V2> joinOtherProcessorParameters;
    private final ProcessorParameters<VR> joinMergeProcessorParameters;
    ...
    BaseJoinProcessorNode(final String nodeName,
                          ...
                          final ProcessorParameters<V1> joinThisProcessorParameters,
                          final ProcessorParameters<V2> joinOtherProcessorParameters,
                          final ProcessorParameters<VR> joinMergeProcessorParameters,
    ...
    ProcessorParameters<V1> thisProcessorParameters() {
        return joinThisProcessorParameters;
    }

    ProcessorParameters<V2> otherProcessorParameters() {
        return joinOtherProcessorParameters;
    }

    ProcessorParameters<VR> mergeProcessorParameters() {
