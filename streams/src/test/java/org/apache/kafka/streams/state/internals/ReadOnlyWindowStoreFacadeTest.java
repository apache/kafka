...
public class ReadOnlyWindowStoreFacadeTest {
    ...
    public void shouldReturnPlainKeyValuePairsOnSingleKeyFetch() {
        ...
        verify(mockedWindowTimestampStore, times(1)).fetch("key1", 21L);
        verify(mockedWindowTimestampStore, times(1)).fetch("unknownKey", 21L);
    }
    ...
    public void shouldReturnPlainKeyValuePairsOnSingleKeyFetchLongParameters() {
        ...
        verify(mockedWindowTimestampIterator, times(2)).next();
        verify(mockedWindowTimestampStore, times(1))
            .fetch("key1", Instant.ofEpochMilli(21L), Instant.ofEpochMilli(42L));
    }
    ...
    public void shouldReturnPlainKeyValuePairsOnRangeFetchLongParameters() {
        ...
        verify(mockedKeyValueWindowTimestampIterator, times(2)).next();
        verify(mockedWindowTimestampStore, times(1))
            .fetch("key1", "key2", Instant.ofEpochMilli(21L), Instant.ofEpochMilli(42L));
    }
    ...
    public void shouldReturnPlainKeyValuePairsOnFetchAllLongParameters() {
        ...
        verify(mockedKeyValueWindowTimestampIterator, times(2)).next();
        verify(mockedWindowTimestampStore, times(1))
            .fetchAll(Instant.ofEpochMilli(21L), Instant.ofEpochMilli(42L));
    }
    ...
    public void shouldReturnPlainKeyValuePairsOnAll() {
        ...
        assertThat(iterator.next(), is(KeyValue.pair(new Windowed<>("key2", new TimeWindow(42L, 43L)), "value2")));
        verify(mockedKeyValueWindowTimestampIterator, times(2)).next();
        verify(mockedWindowTimestampStore, times(1)).all();
    }
}
