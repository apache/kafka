...
### Notable changes in 2.0.0
  ...
  * Updated `ProcessorStateManager` APIs in Kafka Streams for registering state stores to the processor topology. For more details please read the Streams [Upgrade Guide](/36/streams/upgrade-guide#streams_api_changes_200).
...
### Upgrading a 0.11.0 Kafka Streams Application
  ...
  * See [Streams API changes in 1.0.0](/36/streams/upgrade-guide#streams_api_changes_100) for more details. 
...
### Upgrading a 0.10.2 Kafka Streams Application
  ...
  * See [Streams API changes in 0.11.0](/36/streams/upgrade-guide#streams_api_changes_0110) for more details. 
...
### Upgrading a 0.10.1 Kafka Streams Application
  ...
  * See [Streams API changes in 1.0.0](/36/streams/upgrade-guide#streams_api_changes_100), [Streams API changes in 0.11.0](/36/streams/upgrade-guide#streams_api_changes_0110) and [Streams API changes in 0.10.2](/36/streams/upgrade-guide#streams_api_changes_0102) for more details. 
...
### Upgrading a 0.10.0 Kafka Streams Application
  ...
  * There are couple of API changes, that are not backward compatible (cf. [Streams API changes in 1.0.0](/36/streams/upgrade-guide#streams_api_changes_100), [Streams API changes in 0.11.0](/36/streams#streams_api_changes_0110), [Streams API changes in 0.10.2](/36/streams#streams_api_changes_0102), and [Streams API changes in 0.10.1](/36/streams#streams_api_changes_0101) for more details). Thus, you need to update and recompile your code. Just swapping the Kafka Streams library jar file will not work and will break your application. 
...
### Upgrading a 0.10.1 Kafka Streams Application
  ...
  * If you use a custom (i.e., user implemented) timestamp extractor, you will need to update this code, because the `TimestampExtractor` interface was changed. 
  * If you register custom metrics, you will need to update this code, because the `StreamsMetric` interface was changed. 
  * See [Streams API changes in 0.11.0](/36/streams/upgrade-guide#streams_api_changes_0110) and [Streams API changes in 0.10.2](/36/streams/upgrade-guide#streams_api_changes_0102) for more details. 
...
### Upgrading a 0.10.1 Kafka Streams Application
  ...
  * If you use a custom (i.e., user implemented) timestamp extractor, you will need to update this code, because the `TimestampExtractor` interface was changed. 
  * If you register custom metrics, you will need to update this code, because the `StreamsMetric` interface was changed. 
  * See [Streams API changes in 0.10.2](/36/streams/upgrade-guide#streams_api_changes_0102) for more details. 
...
### Upgrading a 0.10.0 Kafka Streams Application
  ...
  * There are couple of API changes, that are not backward compatible (cf. [Streams API changes in 0.10.2](/36/streams#streams_api_changes_0102) for more details). Thus, you need to update and recompile your code. Just swapping the Kafka Streams library jar file will not work and will break your application. 
...
### Upgrading a 0.10.0 Kafka Streams Application
  ...
  * There are couple of API changes, that are not backward compatible (cf. [Streams API changes in 0.10.1](/36/streams/upgrade-guide#streams_api_changes_0101) for more details). Thus, you need to update and recompile your code. Just swapping the Kafka Streams library jar file will not work and will break your application. 
...
### Notable changes in 0.10.0.0
  ...
  * Starting from Kafka 0.10.0.0, a new client library named **Kafka Streams** is available for stream processing on data stored in Kafka topics. This new client library only works with 0.10.x and upward versioned brokers due to message format changes mentioned above. For more information please read [Streams documentation](/36/streams).
