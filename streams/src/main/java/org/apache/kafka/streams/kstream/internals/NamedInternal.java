...
public class NamedInternal extends Named {
    ...
    private static final NamedInternal EMPTY = new NamedInternal();
     ...
     */
    public NamedInternal(final Named internal) {
        super(internal);
    }

    public NamedInternal(final String internal) {
        super(internal);
    }

    private NamedInternal() {
        super();
    }
     ...
     * @return <code>false</code> if no name is set.
     */
