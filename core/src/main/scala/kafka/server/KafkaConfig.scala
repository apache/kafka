...
object KafkaConfig {
  ...
  val MaxConnectionsPerIpOverridesDoc = "A comma separated list of per-ip or hostname overrides to the default maximum number of connections. Example value is : hostName:100,127.0.0.1:200"
