...
class KafkaController(val config : KafkaConfig, zkClient: ZkClient, zkConnection : ZkConnection, val brokerState: BrokerState) extends Logging with KafkaMetricsGroup {
