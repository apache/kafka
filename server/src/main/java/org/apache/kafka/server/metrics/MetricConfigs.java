...
public class MetricConfigs {
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            ...
            .define(METRIC_REPORTER_CLASSES_CONFIG, LIST, METRIC_REPORTER_CLASSES_DEFAULT, ConfigDef.ValidList.anyValues(true, false), LOW, METRIC_REPORTER_CLASSES_DOC)
            .define(METRIC_RECORDING_LEVEL_CONFIG, STRING, METRIC_RECORDING_LEVEL_DEFAULT, LOW, METRIC_RECORDING_LEVEL_DOC)

            // Kafka Yammer Metrics Reporter Configuration
            .define(KAFKA_METRICS_REPORTER_CLASSES_CONFIG, LIST, KAFKA_METRIC_REPORTER_CLASSES_DEFAULT, ConfigDef.ValidList.anyValues(true, false), LOW, KAFKA_METRICS_REPORTER_CLASSES_DOC)
