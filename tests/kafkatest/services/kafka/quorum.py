...
colocated_raft = 'COLOCATED_RAFT' # co-located Controllers in Raft mode, used during/after the KIP-500 bridge release(s)
remote_raft = 'REMOTE_RAFT' # separate Controllers in Raft mode, used during/after the KIP-500 bridge release(s)
