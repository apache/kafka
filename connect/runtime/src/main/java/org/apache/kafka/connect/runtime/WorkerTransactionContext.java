...
public class WorkerTransactionContext implements TransactionContext {
    ...
    private volatile boolean batchCommitRequested = false;
    private volatile boolean batchAbortRequested = false;
    ...
    private synchronized void checkBatchRequestsConsistency() {
    ...
    private synchronized void checkRecordRequestConsistency(SourceRecord record) {
