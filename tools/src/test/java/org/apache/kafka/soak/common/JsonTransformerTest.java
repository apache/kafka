...
public class JsonTransformerTest {
    ...
    public void testTransformJson() throws Exception {
        ...
        JsonNode inputNode = SoakTool.JSON_SERDE.valueToTree(inputObject);
        JsonNode outputNode = JsonTransformer.transform(inputNode, transforms);
        TestJsonObject outputObject = SoakTool.JSON_SERDE.treeToValue(outputNode, TestJsonObject.class);
