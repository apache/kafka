...
public class FakeLocalMetadataStore {
    public static ConcurrentHashMap<String, Map<String, String>> allTopics = new ConcurrentHashMap<>();
    public static ConcurrentHashMap<String, List<AclBinding>> allAcls = new ConcurrentHashMap<>();
}
