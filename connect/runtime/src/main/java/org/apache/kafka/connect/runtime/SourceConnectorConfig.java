...
public class SourceConnectorConfig extends ConnectorConfig {
    ...
    public enum ExactlyOnceSupportLevel {
        ...
        public static List<String> options() {
            return Stream.of(values()).map(ExactlyOnceSupportLevel::toString).collect(Collectors.toList());
        }
    ...
    private static final String EXACTLY_ONCE_SUPPORT_DOC = "Permitted values are " + ExactlyOnceSupportLevel.options() + ". "
    ...
    private static final String TRANSACTION_BOUNDARY_DOC = "Permitted values are: " + SourceTask.TransactionBoundary.options() + ". "
            ...
            + "not all connectors are capable of defining their own transaction boundaries, and in that case, attempts to create them with "
    ...
    private static final String TRANSACTION_BOUNDARY_INTERVAL_DOC = "If '" + TRANSACTION_BOUNDARY_CONFIG + "' is set to '" + INTERVAL
            ...
            + "'" + WorkerConfig.OFFSET_COMMIT_INTERVAL_MS_CONFIG + "' property. Has no effect if a different "
    ...
    public static ConfigDef configDef() {
        ...
        return new ConfigDef(ConnectorConfig.configDef())
                ...
                .define(
                        ...
                        REQUESTED.toString(),
                        ConfigDef.CaseInsensitiveValidString.in(ExactlyOnceSupportLevel.options().toArray(new String[0])),
                ...
                .define(
                        ...
                        ConfigDef.Type.STRING,
                        DEFAULT.toString(),
                        ConfigDef.CaseInsensitiveValidString.in(TransactionBoundary.options().toArray(new String[0])),
                        ConfigDef.Importance.MEDIUM,
