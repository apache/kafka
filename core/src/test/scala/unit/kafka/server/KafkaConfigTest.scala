...
class KafkaConfigTest {
  ...
  def testAdvertiseDefaults(): Unit = {
    ...
    props.setProperty(ZkConfig.ZkConnectProp, "localhost:2181")
  ...
  def testFromPropsInvalid(): Unit = {
    def baseProperties: Properties = {
      ...
      validRequiredProperties.setProperty(ZkConfig.ZkConnectProp, "127.0.0.1:2181")
    ...
    KafkaConfig.configNames.foreach { name =>
      name match {
        case ZkConfig.ZkConnectProp => // ignore string
        case ZkConfig.ZkSessionTimeoutMsProp => assertPropertyInvalid(baseProperties, name, "not_a_number")
        case ZkConfig.ZkConnectionTimeoutMsProp => assertPropertyInvalid(baseProperties, name, "not_a_number")
        case ZkConfig.ZkEnableSecureAclsProp => assertPropertyInvalid(baseProperties, name, "not_a_boolean")
        case ZkConfig.ZkMaxInFlightRequestsProp => assertPropertyInvalid(baseProperties, name, "not_a_number", "0")
        case ZkConfig.ZkSslClientEnableProp => assertPropertyInvalid(baseProperties, name, "not_a_boolean")
        case ZkConfig.ZkClientCnxnSocketProp =>  //ignore string
        case ZkConfig.ZkSslKeyStoreLocationProp =>  //ignore string
        case ZkConfig.ZkSslKeyStorePasswordProp =>  //ignore string
        case ZkConfig.ZkSslKeyStoreTypeProp =>  //ignore string
        case ZkConfig.ZkSslTrustStoreLocationProp =>  //ignore string
        case ZkConfig.ZkSslTrustStorePasswordProp =>  //ignore string
        case ZkConfig.ZkSslTrustStoreTypeProp =>  //ignore string
        case ZkConfig.ZkSslProtocolProp =>  //ignore string
        case ZkConfig.ZkSslEnabledProtocolsProp =>  //ignore string
        case ZkConfig.ZkSslCipherSuitesProp =>  //ignore string
        case ZkConfig.ZkSslEndpointIdentificationAlgorithmProp => //ignore string
        case ZkConfig.ZkSslCrlEnableProp => assertPropertyInvalid(baseProperties, name, "not_a_boolean")
        case ZkConfig.ZkSslOcspEnableProp => assertPropertyInvalid(baseProperties, name, "not_a_boolean")
  ...
  def testSpecificProperties(): Unit = {
    ...
    defaults.setProperty(ZkConfig.ZkConnectProp, "127.0.0.1:2181")
    // For ZkConnectionTimeoutMs
    defaults.setProperty(ZkConfig.ZkSessionTimeoutMsProp, "1234")
  ...
  def testNonroutableAdvertisedListeners(): Unit = {
    val props = new Properties()
    props.setProperty(ZkConfig.ZkConnectProp, "127.0.0.1:2181")
