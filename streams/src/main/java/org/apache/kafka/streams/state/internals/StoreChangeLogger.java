...
class StoreChangeLogger<K, V> {
    ...
    StoreChangeLogger(final String storeName,
                      ...
                      final Headers formatVersion) {
        this(storeName, context, context.taskId().partition, serialization, formatVersion);
    }
    ...
    void logChange(final K key,
        ...
        collector.send(topic, key, value, headers, partition, timestamp, keySerializer, valueSerializer);
    }
}
