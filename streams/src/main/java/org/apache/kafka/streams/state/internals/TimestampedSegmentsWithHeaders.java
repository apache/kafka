...
class TimestampedSegmentsWithHeaders extends AbstractSegments<TimestampedSegmentWithHeaders> {
    ...
    public TimestampedSegmentsWithHeaders(final String name,
    ...
    @Override
    public TimestampedSegmentWithHeaders getOrCreateSegment(long segmentId, StateStoreContext context) {
