...
public class SaslChannelBuilder implements ChannelBuilder, ListenerReconfigurable {
    ...
    public KafkaChannel buildChannel(String id, SelectionKey key, int maxReceiveSize,
        ...
        try {
            ...
            TransportLayer transportLayer = buildTransportLayer(id, key, socketChannel, metricsRegistry);
    ...
    protected SaslServerAuthenticator buildServerAuthenticator(Map<String, ?> configs,
        ...
        return new SaslServerAuthenticator(configs, callbackHandlers, id,
            subjects, kerberosShortNamer, listenerName,
            securityProtocol, transportLayer, connectionsMaxReauthMsByMechanism,
            time, metricsRegistry);
    }
