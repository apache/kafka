...
public class MockClientSupplier implements KafkaClientSupplier {
    ...
    public Producer<byte[], byte[]> getProducer(final Map<String, Object> config) {
        ...
        if (cluster == null) {
            producer = new MockProducer<>(true, BYTE_ARRAY_SERIALIZER, BYTE_ARRAY_SERIALIZER);
        } else {
            producer = new MockProducer<>(cluster, true, new DefaultPartitioner(), BYTE_ARRAY_SERIALIZER, BYTE_ARRAY_SERIALIZER);
        }
