...
public interface KGroupedTable<K, V> {
    ...
    /**
     * @deprecated Please use {@link KGroupedTable#count(TypedStateStoreSupplier)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use {@link KGroupedTable#reduce(Reducer, Reducer, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<K, V> reduce(final Reducer<V> adder,
                        final Reducer<V> subtractor,
    ...
    /**
     * @deprecated Please use {@link KGroupedTable#aggregate(Initializer, Aggregator, Aggregator, TypedStateStoreSupplier)}
     */
    @Deprecated
    <VR> KTable<K, VR> aggregate(final Initializer<VR> initializer,
                                 final Aggregator<? super K, ? super V, VR> adder,
