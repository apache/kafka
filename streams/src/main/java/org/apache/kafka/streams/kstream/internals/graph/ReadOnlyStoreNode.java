...
public class ReadOnlyStoreNode<KIn, VIn, S extends StateStore> extends StateStoreNode<S> {
    ...
    public ReadOnlyStoreNode(final StoreFactory storeBuilder,
    ...
    public void writeToTopology(final InternalTopologyBuilder topologyBuilder) {
        ...
        topologyBuilder.connectSourceStoreAndTopic(storeBuilder.storeName(), topic);
    }

    @Override
    public String toString() {
        return "ReadOnlyStoreNode{" +
