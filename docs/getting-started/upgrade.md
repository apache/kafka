...
### Notable changes in 4.4.0
  ...
  * Generated protocol message readers now bound collection allocations when decoding messages. Collections with more than 1,000,000 elements and flexible-version tagged-field sections with more than 10,000 fields are rejected before allocation; larger valid collections are no longer preallocated beyond 1,000 elements. This prevents a peer from triggering excessive heap allocation through sender-declared collection sizes.
