...
object ApiVersion {
  ...
  private val versionNameMap = Map(
    ...
    // Introduced LeaderAndIsrRequest V1, UpdateMetadataRequest V4 and MetadataRequest V5 via KIP-112
    // Introduced ProduceRequest V4 and FetchRequest V6 in order to use KafkaStorageException for KIP-112
