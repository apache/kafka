 ...
 */
public final class SelfJoinDemo {
    ...
    static Properties getStreamsConfig(final String[] args) throws IOException {
        ...
        props.putIfAbsent(StreamsConfig.STATE_DIR_CONFIG, "/Users/vpapavasileiou/Documents/confluent/streams-data/");
    ...
    static void createWordCountStream(final StreamsBuilder builder) {
        ...
        final KStream<String, String> left = builder.stream(
