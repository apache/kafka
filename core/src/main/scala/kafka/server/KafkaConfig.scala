...
object Defaults {
  ...
  /** KRaft mode configs */
  val EmptyNodeId: Int = RaftConfig.DEFAULT_NODE_ID
  val ProcessRoles: util.List[String] = RaftConfig.DEFAULT_PROCESS_ROLES
  ...
  /** ********* Log Configuration ***********/
  val NumPartitions = 1
  val LogDir = LogConfig.DEFAULT_LOG_DIR
  ...
  val UncleanLeaderElectionEnable = LogConfig.DEFAULT_UNCLEAN_LEADER_ELECTION_ENABLE
  val InterBrokerSecurityProtocol = SecurityProtocol.PLAINTEXT.toString
  val InterBrokerProtocolVersion = LogConfig.DEFAULT_INTER_BROKER_PROTOCOL_VERSION
  ...
  val UnstableApiVersionsEnable = LogConfig.DEFAULT_UNSTABLE_API_VERSIONS_ENABLE
  val UnstableMetadataVersionsEnable = LogConfig.DEFAULT_UNSTABLE_METADATA_VERSIONS_ENABLE
}

>>>>>>> e2425a358a (KAFKA-14585: Move StorageTool to tools)
object KafkaConfig {
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .defineInternal(UnstableApiVersionsEnableProp, BOOLEAN, Defaults.UnstableApiVersionsEnable, HIGH)
      // This indicates whether unreleased MetadataVersions should be enabled on this node.
      .defineInternal(UnstableMetadataVersionsEnableProp, BOOLEAN, Defaults.UnstableMetadataVersionsEnable, HIGH)
  }
