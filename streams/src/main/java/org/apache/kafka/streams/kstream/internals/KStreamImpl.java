...
public class KStreamImpl<K, V> extends AbstractStream<K> implements KStream<K, V> {
    ...
    public KStream<K, V> filter(final Predicate<? super K, ? super V> predicate) {
        ...
        final ProcessorGraphNode<K, V> filterProcessorNode = new ProcessorGraphNode<>(name,
                                                                                      processorParameters,
                                                                                      repartitionRequired);
    ...
    public KStream<K, V> filterNot(final Predicate<? super K, ? super V> predicate) {
        ...
        final ProcessorGraphNode<K, V> filterNotProcessorNode = new ProcessorGraphNode<>(name,
                                                                                         processorParameters,
                                                                                         repartitionRequired);
    ...
    public <K1, V1> KStream<K1, V1> map(final KeyValueMapper<? super K, ? super V, ? extends KeyValue<? extends K1, ? extends V1>> mapper) {
        ...
        final ProcessorGraphNode<K1, V1> mapProcessorNode = new ProcessorGraphNode<>(name,
                                                                                     processorParameters,
                                                                                     true);
    ...
    public <VR> KStream<K, VR> mapValues(final ValueMapperWithKey<? super K, ? super V, ? extends VR> mapper) {
        ...
        final ProcessorGraphNode<K, V> mapValuesProcessorNode = new ProcessorGraphNode<>(name,
                                                                                         processorParameters,
                                                                                         repartitionRequired);
    ...
    public void print(final Printed<K, V> printed) {
        ...
        final ProcessorGraphNode<K, V> printNode = new ProcessorGraphNode<>(name,
                                                                            processorParameters,
                                                                            false);
    ...
    public <K1, V1> KStream<K1, V1> flatMap(
        ...
        final ProcessorGraphNode<K1, V1> flatMapNode = new ProcessorGraphNode<>(name,
                                                                                processorParameters,
                                                                                true);
    ...
    public <VR> KStream<K, VR> flatMapValues(final ValueMapperWithKey<? super K, ? super V, ? extends Iterable<? extends VR>> mapper) {
        ...
        final ProcessorGraphNode<K, VR> flatMapValuesNode = new ProcessorGraphNode<>(name,
                                                                                     processorParameters,
                                                                                     repartitionRequired);
    ...
    private KStream<K, V> merge(final InternalStreamsBuilder builder,
        ...
        final ProcessorGraphNode<K, V> mergeNode = new ProcessorGraphNode<>(name,
                                                                            processorParameters,
    ...
    public void foreach(final ForeachAction<? super K, ? super V> action) {
        ...
        final ProcessorGraphNode<K, V> foreachNode = new ProcessorGraphNode<>(name,
                                                                              processorParameters,
                                                                              repartitionRequired);
    ...
    public KStream<K, V> peek(final ForeachAction<? super K, ? super V> action) {
        ...
        final ProcessorGraphNode<K, V> peekNode = new ProcessorGraphNode<>(
            name,
            processorParameters,
            repartitionRequired
        );
