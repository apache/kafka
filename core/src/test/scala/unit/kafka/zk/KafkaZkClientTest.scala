...
class KafkaZkClientTest extends ZooKeeperTestHarness {
  ...
  def testCreateAndGetTopicPartitionStatesRaw(): Unit = {
    ...
    assertEquals(
      Seq(
        CreateResponse(Code.OK, TopicPartitionStateZNode.path(topicPartition10), Some(topicPartition10),
          TopicPartitionStateZNode.path(topicPartition10), ResponseMetadata(0, 0), zkVersionCheckResultCode = Code.OK),
        CreateResponse(Code.OK, TopicPartitionStateZNode.path(topicPartition11), Some(topicPartition11),
          TopicPartitionStateZNode.path(topicPartition11), ResponseMetadata(0, 0), zkVersionCheckResultCode = Code.OK)),
      zkClient.createTopicPartitionStatesRaw(initialLeaderIsrAndControllerEpochs, controllerEpochZkVersion)
    ...
    assertEquals(
      Seq(
        CreateResponse(Code.NODEEXISTS, TopicPartitionStateZNode.path(topicPartition10), Some(topicPartition10), null, ResponseMetadata(0, 0), zkVersionCheckResultCode = Code.OK),
        CreateResponse(Code.NODEEXISTS, TopicPartitionStateZNode.path(topicPartition11), Some(topicPartition11), null, ResponseMetadata(0, 0), zkVersionCheckResultCode = Code.OK)),
  ...
  def testSetTopicPartitionStatesRaw(): Unit = {
    ...
    def expectedSetDataResponses(topicPartitions: TopicPartition*)(resultCode: Code, stat: Stat, zkVersionCheckResultCode: Code) =
      topicPartitions.map { topicPartition =>
        SetDataResponse(resultCode, TopicPartitionStateZNode.path(topicPartition),
          Some(topicPartition), stat, ResponseMetadata(0, 0), zkVersionCheckResultCode)
      }
    ...
    assertEquals(
      expectedSetDataResponses(topicPartition10, topicPartition11)(Code.NONODE, null, Code.OK),
    ...
    assertEquals(
      expectedSetDataResponses(topicPartition10, topicPartition11)(Code.OK, statWithVersion(1), Code.OK),
    ...
    assertEquals(
      expectedSetDataResponses(topicPartition10, topicPartition11)(Code.OK, statWithVersion(2), Code.OK),
