...
public final class TopicsImageFixtures {
    ...
    public static final TopicsImage IMAGE2;
    ...
    static {
        List<TopicImage> topicImages1 = List.of(
        ...
        IMAGE1 = new TopicsImage(newTopicsByIdMap(topicImages1), newTopicsByNameMap(topicImages1));
