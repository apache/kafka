...
public class SuppressTopologyTest {
    ...
    private static final String NAMED_FINAL_TOPOLOGY = "Topologies:\n" +
        ...
        "\n" +
        "  Sub-topology: 1\n" +
        "    Source: KSTREAM-SOURCE-0000000005 (topics: [counts-repartition], keySerde: StringDeserializer, valueSerde: StringDeserializer)\n" +
    ...
    private static final String ANONYMOUS_FINAL_TOPOLOGY = "Topologies:\n" +
        ...
        "      <-- KTABLE-TOSTREAM-0000000008\n" +
        "    Sink: KSTREAM-SINK-0000000010 (topic: output-suppressed, keySerde: StringSerializer, valueSerde: LongSerializer)\n" +
        "      <-- KSTREAM-MAP-0000000009\n" +
        "\n";
    ...
    private static final String NAMED_INTERMEDIATE_TOPOLOGY = "Topologies:\n" +
        ...
        "      --> asdf\n" +
        "      <-- KSTREAM-SOURCE-0000000000\n" +
        "    Processor: asdf (stores: [(asdf-store, serdes: [StringSerde, FullChangeSerde])])\n" +
        "      --> KTABLE-TOSTREAM-0000000003\n" +
        "      <-- KSTREAM-AGGREGATE-0000000002\n" +
        "    Processor: KTABLE-TOSTREAM-0000000003 (stores: [])\n" +
        "      --> KSTREAM-SINK-0000000004\n" +
        "      <-- asdf\n" +
        "    Sink: KSTREAM-SINK-0000000004 (topic: output, keySerde: StringSerializer, valueSerde: LongSerializer)\n" +
        "      <-- KTABLE-TOSTREAM-0000000003\n" +
        "\n";
    ...
    private static final String ANONYMOUS_INTERMEDIATE_TOPOLOGY = "Topologies:\n" +
        ...
        "      <-- KSTREAM-SOURCE-0000000000\n" +
        "    Processor: KTABLE-SUPPRESS-0000000003 (stores: [(KTABLE-SUPPRESS-STATE-STORE-0000000004, serdes: [StringSerde, FullChangeSerde])])\n" +
        "      --> KTABLE-TOSTREAM-0000000005\n" +
        "      <-- KSTREAM-AGGREGATE-0000000002\n" +
        "    Processor: KTABLE-TOSTREAM-0000000005 (stores: [])\n" +
        "      --> KSTREAM-SINK-0000000006\n" +
        "      <-- KTABLE-SUPPRESS-0000000003\n" +
        "    Sink: KSTREAM-SINK-0000000006 (topic: output, keySerde: StringSerializer, valueSerde: LongSerializer)\n" +
        "      <-- KTABLE-TOSTREAM-0000000005\n" +
        "\n";
