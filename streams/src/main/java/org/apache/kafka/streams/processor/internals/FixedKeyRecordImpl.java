 ...
 */
public final class FixedKeyRecordImpl<K, V> implements FixedKeyRecord<K, V> {
     ...
     */
    FixedKeyRecordImpl(final K key, final V value, final long timestamp, final Headers headers) {
        this.key = key;
        this.value = value;
        if (timestamp < 0) {
    ...
    FixedKeyRecordImpl(final Record<K, V> record) {
        this(record.key(), record.value(), record.timestamp(), record.headers());
    }
     ...
     */
    public <NewV> FixedKeyRecordImpl<K, NewV> withValue(final NewV value) {
        return new FixedKeyRecordImpl<>(key, value, timestamp, headers);
    }
     ...
     */
    public FixedKeyRecordImpl<K, V> withTimestamp(final long timestamp) {
        return new FixedKeyRecordImpl<>(key, value, timestamp, headers);
    }
     ...
     *
     * See {@link FixedKeyProcessorContext#forward(FixedKeyRecordImpl)} for
     ...
     */
    public FixedKeyRecordImpl<K, V> withHeaders(final Headers headers) {
        return new FixedKeyRecordImpl<>(key, value, timestamp, headers);
    }
    ...
    public boolean equals(final Object o) {
        ...
        final FixedKeyRecordImpl<?, ?> record = (FixedKeyRecordImpl<?, ?>) o;
