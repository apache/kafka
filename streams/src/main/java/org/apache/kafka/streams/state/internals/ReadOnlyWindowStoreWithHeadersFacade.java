 ...
 * plain value interface, discarding both timestamps and headers.
 *
 * @param <K> key type
 * @param <V> value type
 */
public class ReadOnlyWindowStoreWithHeadersFacade<K, V> extends GenericReadOnlyWindowStoreFacade<K, ValueTimestampHeaders<V>, V> {
