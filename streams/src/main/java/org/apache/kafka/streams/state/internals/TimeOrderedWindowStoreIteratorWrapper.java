...
public class TimeOrderedWindowStoreIteratorWrapper {
    ...
    public WindowStoreIterator<byte[]> valuesIterator() {
        return new TimeOrderedWindowStoreIteratorWrapper.WrappedWindowStoreIterator(bytesIterator);
    }

    public KeyValueIterator<Windowed<Bytes>, byte[]> keyValueIterator() {
        return new TimeOrderedWindowStoreIteratorWrapper.WrappedKeyValueIterator(bytesIterator, windowSize);
    }
