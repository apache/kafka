...
public class MockConsumerTest {
    ...
    public void testSimpleMock() {
        ...
        ConsumerRecord<String, String> rec1 = new ConsumerRecord<String, String>("test", 0, 0, 0L, TimestampType.CreateTime, "key1", "value1");
        ConsumerRecord<String, String> rec2 = new ConsumerRecord<String, String>("test", 0, 1, 0L, TimestampType.CreateTime, "key2", "value2");
