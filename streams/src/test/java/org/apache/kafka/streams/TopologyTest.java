...
public class TopologyTest {
    ...
    public void readonlyStateStoresShouldHaveTheirOwnSubTopology() {
        ...
        final KeyValueStoreBuilder<?, ?> storeBuilder = EasyMock.createNiceMock(KeyValueStoreBuilder.class);
        EasyMock.expect(storeBuilder.name()).andReturn(storeName).anyTimes();
        EasyMock.replay(storeBuilder);
