...
import kafka.test.annotation.{ClusterConfigProperty, ClusterTest, ClusterTemplate, ClusterTestDefaults, ClusterTests, Type}
...
object ApiVersionsRequestTest {
  ...
  def controlPlaneListenerProperties(): util.HashMap[String, String] = {
  ...
  def testApiVersionsRequestTemplate(clusterGenerator: ClusterGenerator): Unit = {
    val serverProperties: util.HashMap[String, String] = controlPlaneListenerProperties()
...
class ApiVersionsRequestTest(cluster: ClusterInstance) extends AbstractApiVersionsRequestTest(cluster) {
  ...
  @ClusterTests(clusterTemplate = new ClusterTemplate("testApiVersionsRequestTemplate"), value = Array(
  ...
  @ClusterTests(clusterTemplate = new ClusterTemplate("testApiVersionsRequestIncludesUnreleasedApisTemplate"), value = Array(
  ...
  @ClusterTests(clusterTemplate = new ClusterTemplate("zkApiVersionsRequest"), value = Array(
  ...
  @ClusterTests(clusterTemplate = new ClusterTemplate("testApiVersionsRequestValidationV0Template"), value = Array(
