...
import org.apache.kafka.server.config.{DelegationTokenManagerConfigs, KRaftConfigs, KafkaSecurityConfigs, QuotaConfigs, ReplicationConfigs, ServerConfigs, ServerLogConfigs, ZkConfigs}
...
object KafkaConfig {
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(ServerConfigs.METADATA_RECOVERY_STRATEGY_CONFIG, STRING, ServerConfigs.DEFAULT_METADATA_RECOVERY_STRATEGY, LOW, ServerConfigs.METADATA_RECOVERY_STRATEGY_DOC)
...
class KafkaConfig private(doLog: Boolean, val props: java.util.Map[_, _], dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  val metadataRecoveryStrategy = MetadataRecoveryStrategy.forName(getString(ServerConfigs.METADATA_RECOVERY_STRATEGY_CONFIG))
