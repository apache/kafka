...
./gradlew clean compileJava compileScala compileTestJava compileTestScala checkstyleMain checkstyleTest findbugsMain unitTest integrationTest --no-daemon -PxmlFindBugsReport=true -Dorg.gradle.project.testLoggingEvents=started,passed,skipped,failed "$@"
