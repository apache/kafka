...
public class SocketServer {
    ...
    public static final Set<String> RECONFIGURABLE_CONFIGS = Utils.mkSet(
            KafkaConfig.MAX_CONNECTIONS_PER_IP_PROP,
            KafkaConfig.MAX_CONNECTIONS_PER_IP_OVERRIDES_PROP,
            KafkaConfig.MAX_CONNECTIONS_PROP,
            KafkaConfig.MAX_CONNECTION_CREATION_RATE_PROP
    );

    public static final Set<String> LISTENER_RECONFIGURABLE_CONFIGS = Utils.mkSet(
            KafkaConfig.MAX_CONNECTIONS_PROP,
            KafkaConfig.MAX_CONNECTION_CREATION_RATE_PROP
    );
}
