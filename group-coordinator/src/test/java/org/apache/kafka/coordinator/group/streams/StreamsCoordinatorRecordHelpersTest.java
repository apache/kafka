...
class StreamsCoordinatorRecordHelpersTest {
    ...
    public void testNewStreamsGroupMetadataRecordWithNullAssignmentConfig() {
        assertThrows(NullPointerException.class, () ->
            StreamsCoordinatorRecordHelpers.newStreamsGroupMetadataRecord(GROUP_ID, 42, 43, 44, null, -1L));
    }
    ...
    public void testNewStreamsGroupMetadataRecordNullGroupId() {
        NullPointerException exception = assertThrows(NullPointerException.class, () ->
            StreamsCoordinatorRecordHelpers.newStreamsGroupMetadataRecord(null, 1, 1, 1, Map.of(), -1L));
        assertEquals("groupId should not be null here", exception.getMessage());
    }
