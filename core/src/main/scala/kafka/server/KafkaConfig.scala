...
object KafkaConfig {
  ...
  val TransactionsTopicMinISRDoc = "Overridden " + MIN_IN_SYNC_REPLICAS_PROP + " config for the transaction topic."
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(LOG_ROLL_TIME_HOURS_PROP, INT, TimeUnit.MILLISECONDS.toHours(LogConfig.DEFAULT_SEGMENT_MS).toInt, atLeast(1), HIGH, LOG_ROLL_TIME_HOURS_DOC)

      .define(LOG_ROLL_TIME_JITTER_MILLIS_PROP, LONG, null, HIGH, LOG_ROLL_TIME_JITTER_MILLIS_DOC)
      .define(LOG_ROLL_TIME_JITTER_HOURS_PROP, INT, TimeUnit.MILLISECONDS.toHours(LogConfig.DEFAULT_SEGMENT_JITTER_MS).toInt, atLeast(0), HIGH, LOG_ROLL_TIME_JITTER_HOURS_DOC)

      .define(LOG_RETENTION_TIME_MILLIS_PROP, LONG, null, HIGH, LOG_RETENTION_TIME_MILLIS_DOC)
      .define(LOG_RETENTION_TIME_MINUTES_PROP, INT, null, HIGH, LOG_RETENTION_TIME_MINUTES_DOC)
      .define(LOG_RETENTION_TIME_HOURS_PROP, INT, TimeUnit.MILLISECONDS.toHours(LogConfig.DEFAULT_RETENTION_MS).toInt, HIGH, LOG_RETENTION_TIME_HOURS_DOC)
      ...
      .define(LOG_CLEANUP_POLICY_PROP, LIST, LogConfig.DEFAULT_CLEANUP_POLICY, ValidList.in(TopicConfig.CLEANUP_POLICY_COMPACT, TopicConfig.CLEANUP_POLICY_DELETE), MEDIUM, LOG_CLEANUP_POLICY_DOC)
