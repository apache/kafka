...
public class MeteredTimestampedKeyValueStoreTest {
    ...
    public void shouldWriteBytesToInnerStoreAndRecordPutMetric() {
        ...
        verify(inner, times(1)).put(eq(KEY_BYTES), aryEq(VALUE_AND_TIMESTAMP_BYTES));
    }
    ...
    public void shouldGetWithBinary() {
        ...
        verify(inner, times(1)).get(KEY_BYTES);
    }
    ...
    public void shouldPutIfAbsentAndRecordPutIfAbsentMetric() {
        when(inner.putIfAbsent(eq(KEY_BYTES), aryEq(VALUE_AND_TIMESTAMP_BYTES))).thenReturn(null);
        init();
        ...
        assertTrue((Double) metric.metricValue() > 0);
        verify(inner, times(1)).putIfAbsent(eq(KEY_BYTES), aryEq(VALUE_AND_TIMESTAMP_BYTES));
    }
    ...
    public void shouldDeleteFromInnerStoreAndRecordDeleteMetric() {
        ...
        assertTrue((Double) metric.metricValue() > 0);
        verify(inner, times(1)).delete(KEY_BYTES);
    }
    ...
    public void shouldGetRangeFromInnerStoreAndRecordRangeMetric() {
        ...
        assertTrue((Double) metric.metricValue() > 0);
        verify(inner, times(1)).range(KEY_BYTES, KEY_BYTES);
    }
    ...
    public void shouldSetFlushListenerOnWrappedCachingStore() {
        ...
        verify(cachedKeyValueStore, times(1)).setFlushListener(any(CacheFlushListener.class), eq(false));
    }
