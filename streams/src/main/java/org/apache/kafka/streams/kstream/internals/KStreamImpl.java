...
public class KStreamImpl<K, V> extends AbstractStream<K> implements KStream<K, V> {
    ...
    public KStream<K, V> filter(final Predicate<? super K, ? super V> predicate) {
        ...
        final StatelessProcessorNode<K, V> filterProcessorNode = new StatelessProcessorNode<>(name,
                                                                                              processorParameters,
                                                                                              repartitionRequired);
    ...
    public KStream<K, V> filterNot(final Predicate<? super K, ? super V> predicate) {
        ...
        final StatelessProcessorNode<K, V> filterNotProcessorNode = new StatelessProcessorNode<>(name,
                                                                                                 processorParameters,
                                                                                                 repartitionRequired);
    ...
    public <K1, V1> KStream<K1, V1> map(final KeyValueMapper<? super K, ? super V, ? extends KeyValue<? extends K1, ? extends V1>> mapper) {
        ...
        final StatelessProcessorNode<K1, V1> mapProcessorNode = new StatelessProcessorNode<>(name,
                                                                                             processorParameters,
                                                                                             true);
    ...
    public <VR> KStream<K, VR> mapValues(final ValueMapperWithKey<? super K, ? super V, ? extends VR> mapper) {
        ...
        final StatelessProcessorNode<K, V> mapValuesProcessorNode = new StatelessProcessorNode<>(name,
                                                                                                 processorParameters,
                                                                                                 repartitionRequired);
    ...
    public void print(final Printed<K, V> printed) {
        ...
        final StatelessProcessorNode<K, V> printNode = new StatelessProcessorNode<>(name,
                                                                                    processorParameters,
                                                                                    false);
    ...
    public <K1, V1> KStream<K1, V1> flatMap(
        ...
        final StatelessProcessorNode<K1, V1> flatMapNode = new StatelessProcessorNode<>(name,
                                                                                        processorParameters,
                                                                                        true);
    ...
    public <VR> KStream<K, VR> flatMapValues(final ValueMapperWithKey<? super K, ? super V, ? extends Iterable<? extends VR>> mapper) {
        ...
        final StatelessProcessorNode<K, VR> flatMapValuesNode = new StatelessProcessorNode<>(name,
                                                                                             processorParameters,
                                                                                             repartitionRequired);
    ...
    public KStream<K, V>[] branch(final Predicate<? super K, ? super V>... predicates) {
        ...
        final StatelessProcessorNode<K, V> branchNode = new StatelessProcessorNode<>(branchName,
                                                                                     processorParameters,
                                                                                     false);
        ...
        for (int i = 0; i < predicates.length; i++) {
            ...
            final StatelessProcessorNode<K, V> branchChildNode = new StatelessProcessorNode<>(childNames[i],
    ...
    private KStream<K, V> merge(final InternalStreamsBuilder builder,
        ...
        final StatelessProcessorNode<K, V> mergeNode = new StatelessProcessorNode<>(name,
                                                                                    processorParameters,
                                                                                    requireRepartitioning,
                                                                                    Arrays.asList(parentNames));

        builder.addGraphNode(this.streamsGraphNode, mergeNode);
    ...
    public void foreach(final ForeachAction<? super K, ? super V> action) {
        ...
        final StatelessProcessorNode<K, V> foreachNode = new StatelessProcessorNode<>(name,
                                                                                      processorParameters,
                                                                                      repartitionRequired);
    ...
    public <K1, V1> KStream<K1, V1> transform(final TransformerSupplier<? super K, ? super V, KeyValue<K1, V1>> transformerSupplier,
        ...
        final StatefulStatelessProcessorNode<K1, V1> transformNode = new StatefulStatelessProcessorNode<>(name,
                                                                                                          processorParameters,
                                                                                                          stateStoreNames,
                                                                                                          null,
                                                                                                          true);
    ...
    private <VR> KStream<K, VR> doTransformValues(final ValueTransformerWithKeySupplier<? super K, ? super V, ? extends VR> valueTransformerWithKeySupplier,
        ...
        final StatefulStatelessProcessorNode<K, VR> transformNode = new StatefulStatelessProcessorNode<>(name,
                                                                                                         processorParameters,
                                                                                                         stateStoreNames,
                                                                                                         null,
                                                                                                         repartitionRequired);
    ...
    public void process(final ProcessorSupplier<? super K, ? super V> processorSupplier,
        ...
        final StatefulStatelessProcessorNode<K, V> processNode = new StatefulStatelessProcessorNode<>(name,
                                                                                                      processorParameters,
                                                                                                      stateStoreNames,
                                                                                                      null,
                                                                                                      repartitionRequired);
    ...
    public <KR> KGroupedStream<KR, V> groupBy(final KeyValueMapper<? super K, ? super V, KR> selector,
        ...
        final StatelessProcessorNode<K, V> selectKeyMapNode = internalSelectKey(selector);
    ...
    private class KStreamImplJoin {
        ...
        public <K1, R, V1, V2> KStream<K1, R> join(final KStream<K1, V1> lhs,
            ...
            final StatelessProcessorNode<K1, V1> thisWindowedStreamsNode = new StatelessProcessorNode<>(thisWindowStreamName, thisWindowStreamProcessorParams);
            ...
            final StatelessProcessorNode<K1, V2> otherWindowedStreamsNode = new StatelessProcessorNode<>(otherWindowStreamName, otherWindowStreamProcessorParams);
