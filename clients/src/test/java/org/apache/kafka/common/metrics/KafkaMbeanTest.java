...
public class KafkaMbeanTest {
    ...
    public void testInvoke() throws Exception {
        try {
            mBeanServer.invoke(getObjectName(countMetricName), "something", null, null);
    ...
    public void testSetAttribute() throws Exception {
        try {
            mBeanServer.setAttribute(getObjectName(countMetricName), new Attribute("anything", 1));
    ...
    public void testSetAttributes() throws Exception {
        try {
            mBeanServer.setAttributes(getObjectName(countMetricName), new AttributeList(1));
    ...
    private ObjectName getObjectName(MetricName metricName) throws Exception {
    ...
    private Object getAttribute(MetricName metricName, String attribute) throws Exception {
        return mBeanServer.getAttribute(getObjectName(metricName), attribute);
    }
    ...
    private AttributeList getAttributes(MetricName metricName, String... attributes) throws Exception {
        return mBeanServer.getAttributes(getObjectName(metricName), attributes);
    }
