...
class KTableFilter<K, V> implements KTableProcessorSupplier<K, Change<V>, K, V> {
    ...
    private class KTableFilterProcessor implements TypedProcessor<K, Change<V>, K, Change<V>> {
