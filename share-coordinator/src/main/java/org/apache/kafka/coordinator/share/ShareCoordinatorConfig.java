...
public class ShareCoordinatorConfig {
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
        ...
        .define(NUM_THREADS_CONFIG, INT, NUM_THREADS_DEFAULT, atLeast(1), HIGH, NUM_THREADS_DOC)
        .define(SNAPSHOT_UPDATE_RECORDS_PER_SNAPSHOT_CONFIG, INT, SNAPSHOT_UPDATE_RECORDS_PER_SNAPSHOT_DEFAULT, between(0, 500), LOW, SNAPSHOT_UPDATE_RECORDS_PER_SNAPSHOT_DOC)
        ...
        .define(APPEND_LINGER_MS_CONFIG, INT, APPEND_LINGER_MS_DEFAULT, atLeast(-1), LOW, APPEND_LINGER_MS_DOC)
