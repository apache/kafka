...
public class DescribeClientConfigsResult {

    private final KafkaFuture<Map<ClientQuotaEntity, Map<String, String>>> entities;
     ...
     */
    public DescribeClientConfigsResult(KafkaFuture<Map<ClientQuotaEntity, Map<String, String>>> entities) {
     ...
     */
    public KafkaFuture<Map<ClientQuotaEntity, Map<String, String>>> entities() {
        return entities;
    }
}
