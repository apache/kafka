...
public class MeteredKeyValueStore<K, V> implements KeyValueStore<K, V> {
    ...
    public void init(ProcessorContext context, StateStore root) {
        ...
        this.getTime = this.metrics.addLatencySensor(metricScope, name, "get", Sensor.RecordLevel.SENSOR_DEBUG);
        this.deleteTime = this.metrics.addLatencySensor(metricScope, name, "delete", Sensor.RecordLevel.SENSOR_DEBUG);
        this.putAllTime = this.metrics.addLatencySensor(metricScope, name, "put-all", Sensor.RecordLevel.SENSOR_DEBUG);
        this.allTime = this.metrics.addLatencySensor(metricScope, name, "all", Sensor.RecordLevel.SENSOR_DEBUG);
        this.rangeTime = this.metrics.addLatencySensor(metricScope, name, "range", Sensor.RecordLevel.SENSOR_DEBUG);
