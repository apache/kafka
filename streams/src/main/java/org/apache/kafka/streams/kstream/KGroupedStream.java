...
public interface KGroupedStream<K, V> {
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#count(TypedStateStoreSupplier)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#count(Windows, TypedStateStoreSupplier)}
     */
    @Deprecated
    <W extends Window> KTable<Windowed<K>, Long> count(final Windows<W> windows,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#count(SessionWindows, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<Windowed<K>, Long> count(final SessionWindows sessionWindows,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#reduce(Reducer, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<K, V> reduce(final Reducer<V> reducer,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#reduce(Reducer, Windows, TypedStateStoreSupplier)}
     */
    @Deprecated
    <W extends Window> KTable<Windowed<K>, V> reduce(final Reducer<V> reducer,
                                                     final Windows<W> windows,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#reduce(Reducer, SessionWindows, TypedStateStoreSupplier)}
     */
    @Deprecated
    KTable<Windowed<K>, V> reduce(final Reducer<V> reducer,
                                  final SessionWindows sessionWindows,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#aggregate(Initializer, Aggregator, TypedStateStoreSupplier)}
     */
    @Deprecated
    <VR> KTable<K, VR> aggregate(final Initializer<VR> initializer,
                                 final Aggregator<? super K, ? super V, VR> aggregator,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#aggregate(Initializer, Aggregator, Windows, TypedStateStoreSupplier)}
     */
    @Deprecated
    <W extends Window, VR> KTable<Windowed<K>, VR> aggregate(final Initializer<VR> initializer,
                                                             final Aggregator<? super K, ? super V, VR> aggregator,
    ...
    /**
     * @deprecated Please use {@link KGroupedStream#aggregate(Initializer, Aggregator, Merger, SessionWindows, Serde, TypedStateStoreSupplier)}
     */
    @Deprecated
    <T> KTable<Windowed<K>, T> aggregate(final Initializer<T> initializer,
                                         final Aggregator<? super K, ? super V, T> aggregator,
