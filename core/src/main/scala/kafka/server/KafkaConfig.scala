...
object KafkaConfig {
  ...
  val InterBrokerSecurityProtocolDoc = s"Security protocol used to communicate between brokers. Valid values are: ${SecurityProtocol.getNames.asScala.mkString(", ")}."
