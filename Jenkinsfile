...
pipeline {
    ...
    parameters {
        ...
        string(name: 'JVM_ARGS_OPENJ9', defaultValue: "-Xmx2G -Xgcpolicy:gencon -Xgcthreads1 -XcompilationThreads1 -XX:+DisableExplicitGC -Xtune:virtualized -Xss512k -Xnojit -Dscala.concurrent.context.numThreads=1", description: 'Custom JVM arguments for OpenJ9 builds.')
