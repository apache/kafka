...
public class MeteredKeyValueStoreTest {
    ...
    public void shouldRecordRestoreLatencyOnInit() {
        ...
        verify(inner, times(1)).init((StateStoreContext) context, metered);
    }
    ...
    public void shouldWriteBytesToInnerStoreAndRecordPutMetric() {
        ...
        verify(inner, times(1)).put(eq(KEY_BYTES), aryEq(VALUE_BYTES));
    }
    ...
    public void shouldPutIfAbsentAndRecordPutIfAbsentMetric() {
        when(inner.putIfAbsent(eq(KEY_BYTES), aryEq(VALUE_BYTES))).thenReturn(null);
        init();
    ...
    public void shouldPutAllToInnerStoreAndRecordPutAllMetric() {
        ...
        assertTrue((Double) metric.metricValue() > 0);
        verify(inner, times(1)).putAll(any(List.class));
    }
