...
import org.apache.kafka.server.config.{KafkaServerConfigs, ReplicationConfigs, ServerLogConfigs}
...
class ProducerIdExpirationTest extends KafkaServerTestHarness {
  ...
  private def serverProps(): Properties = {
    ...
    serverProps.put(KafkaServerConfigs.CONTROLLED_SHUTDOWN_ENABLE_CONFIG, true.toString)
