...
import org.apache.kafka.server.config.{KafkaServerConfigs, ReplicationConfigs}
...
abstract class AbstractMetadataRequestTest extends BaseRequestTest {
  ...
  override def brokerPropertyOverrides(properties: Properties): Unit = {
    ...
    properties.setProperty(KafkaServerConfigs.BROKER_RACK_CONFIG, s"rack/${properties.getProperty(KafkaServerConfigs.BROKER_ID_CONFIG)}")
  }
