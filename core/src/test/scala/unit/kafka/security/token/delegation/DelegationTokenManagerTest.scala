...
import org.apache.kafka.common.config.DelegationConfigs
...
class DelegationTokenManagerTest extends QuorumTestHarness  {
  ...
  val maxLifeTimeMsDefault = DelegationConfigs.DELEGATION_TOKEN_MAX_LIFE_TIME_MS
  val renewTimeMsDefault = DelegationConfigs.DELEGATION_TOKEN_EXPIRY_TIME_MS
  ...
  override def setUp(testInfo: TestInfo): Unit = {
    ...
    props.put(DelegationConfigs.DELEGATION_TOKEN_SECRET_KEY_CONFIG, secretKey)
