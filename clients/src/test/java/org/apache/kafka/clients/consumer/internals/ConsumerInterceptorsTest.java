...
public class ConsumerInterceptorsTest {
    ...
    private final ConsumerRecord<Integer, Integer> consumerRecord =
        new ConsumerRecord<>(topic, partition, 0, 0L, TimestampType.CreateTime, 1, 1);
    ...
    public void testOnConsumeChain() {
        ...
        list2.add(new ConsumerRecord<>(filterTopicPart1.topic(), filterTopicPart1.partition(), 0, 0L, TimestampType.CreateTime, 1, 1));
        List<ConsumerRecord<Integer, Integer>> list3 = new ArrayList<>();
        list3.add(new ConsumerRecord<>(filterTopicPart2.topic(), filterTopicPart2.partition(), 0, 0L, TimestampType.CreateTime, 1, 1));
