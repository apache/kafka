...
public class StaticMemberTestClient {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        config.put(StreamsConfig.KEY_SERDE_CLASS_DEFAULT_CONFIG, Serdes.StringSerde.class);
        config.put(StreamsConfig.VALUE_SERDE_CLASS_DEFAULT_CONFIG, Serdes.StringSerde.class);
