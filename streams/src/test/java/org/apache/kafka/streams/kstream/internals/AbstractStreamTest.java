...
public class AbstractStreamTest {
    ...
    private class ExtendedKStream<K, V> extends AbstractStream<K> {
        ...
        KStream<K, V> randomFilter() {
            ...
            StatelessProcessorNode statelessProcessorNode = new StatelessProcessorNode(name,
                                                                                       new ProcessorParameters<>(new ExtendedKStreamDummy<>(), name),
                                                                                       false);
            addGraphNode(statelessProcessorNode);
            return new KStreamImpl<>(builder, name, sourceNodes, false, statelessProcessorNode);
        }
    }
