...
For a full list of configurations of Kafka Streams please refer to this [table](/40/#streamsconfigs). 
...
For detailed instructions on how to run a Streams application and observe its computing results, please read the [Play with a Streams Application](/40/streams/quickstart) section. We will not talk about this in the rest of this section. 
