...
object TestUtils extends Logging {
  ...
  def createLogManager(logDirs: Seq[File] = Seq.empty[File],
    ...
    val logManager = new LogManager(logDirs = logDirs.map(_.getAbsoluteFile),
                   ...
                   producerStateManagerConfig = new ProducerStateManagerConfig(TransactionLogConfigs.PRODUCER_ID_EXPIRATION_MS_DEFAULT, TransactionLogConfigs.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT, transactionVerificationEnabled),
