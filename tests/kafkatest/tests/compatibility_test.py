...
from kafkatest.services.kafka.version import LATEST_0_8_2, LATEST_0_9
...
class ClientCompatibilityTest(Test):
    ...
    def test_producer_back_compatibility(self):
        ...
        self.producer = VerifiableProducer(
            ...
            throughput=self.producer_throughput, version=LATEST_0_9)
    ...
    def test_consumer_back_compatibility(self):
        """Run the scala 0.9.X consumer against an 0.8.X cluster.
        Expect 0.9.X scala consumer to fail with buffer underflow. This error is the same as when an 0.9.X producer
        ...
        self.consumer = ConsoleConsumer(
            ...
            consumer_timeout_ms=10000, message_validator=is_int, version=LATEST_0_9)
