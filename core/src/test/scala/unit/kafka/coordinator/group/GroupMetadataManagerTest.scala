...
class GroupMetadataManagerTest {
  ...
  def testloadGroupWithStaticMember() {
    ...
    val staticMember = new MemberMetadata(staticMemberId, groupId, groupInstanceId.get, "", "", rebalanceTimeout, sessionTimeout,
  ...
  def testStoreNonEmptyGroup() {
    ...
    val member = new MemberMetadata(memberId, groupId, groupInstanceId.get, clientId, clientHost, rebalanceTimeout, sessionTimeout,
      protocolType, List(("protocol", Array[Byte]())))
    group.add(member, _ => ())
  ...
  private def buildStableGroupRecordWithMember(generation: Int,
    ...
    val member = new MemberMetadata(memberId, groupId, groupInstanceId.get, "clientId", "clientHost", 30000, 10000, protocolType, memberProtocols)
