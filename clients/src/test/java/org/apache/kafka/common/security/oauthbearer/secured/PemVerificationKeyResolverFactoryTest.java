...
public class PemVerificationKeyResolverFactoryTest extends OAuthBearerTest {
    ...
    private void testResolution(String pemEncoded,
        ...
        if (pemEncoded != null) {
            ...
            kid = PemVerificationKeyResolverFactory.toKid(pemFile);
        }
        ...
        PemVerificationKeyResolverFactory factory = new PemVerificationKeyResolverFactory(tmpPemDir.toPath());
        VerificationKeyResolver vkr = factory.create();
