...
from kafkatest.version import LATEST_2_1, LATEST_2_2, LATEST_2_3, LATEST_2_4, LATEST_2_5, LATEST_2_6, LATEST_2_7, LATEST_2_8, \
    ...
    LATEST_4_0, LATEST_4_1, LATEST_4_2, LATEST_4_3, DEV_BRANCH, DEV_VERSION, KafkaVersion
...
broker_upgrade_versions = [str(LATEST_2_8), str(LATEST_3_0), str(LATEST_3_1), str(LATEST_3_2),
                           ...
                           str(LATEST_4_1), str(LATEST_4_2), str(LATEST_4_3), str(DEV_BRANCH)]
...
fk_join_versions = [str(LATEST_3_4), str(LATEST_3_5), str(LATEST_3_6), str(LATEST_3_7), str(LATEST_3_8),
                    str(LATEST_3_9), str(LATEST_4_0), str(LATEST_4_1), str(LATEST_4_2), str(LATEST_4_3)]
