...
public class TimeWindowedKStreamImplTest {
    ...
    public void shouldMaterializeCount() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props, 0L)) {
            ...
            final List<KeyValue<Windowed<String>, Long>> data = StreamsTestUtils.toList(windowStore.fetch("1", "2", ofEpochMilli(0), ofSeconds(1)));
    ...
    public void shouldMaterializeReduced() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props, 0L)) {
            ...
            final List<KeyValue<Windowed<String>, String>> data = StreamsTestUtils.toList(windowStore.fetch("1", "2", ofEpochMilli(0), ofSeconds(1)));
