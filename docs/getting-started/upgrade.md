...
### Notable changes in 4.3.0
  ...
  * The new config have been introduced: `rlmm.config.remote.log.metadata.topic.min.isr` with 2 as default value. You can update the value for the existed __remote_log_metadata topic via kafka-configs.sh if needed. For further details, please refer to [KIP-1235](https://cwiki.apache.org/confluence/x/yommFw).
