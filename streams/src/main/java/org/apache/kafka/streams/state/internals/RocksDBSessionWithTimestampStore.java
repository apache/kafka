...
public class RocksDBSessionWithTimestampStore<K, AGG> extends WrappedStateStore.AbstractStateStore implements SessionStore<K, AGG> {
    ...
    RocksDBSessionWithTimestampStore(final SegmentedBytesStore bytesStore,
