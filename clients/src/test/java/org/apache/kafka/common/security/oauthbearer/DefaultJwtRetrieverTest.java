...
public class DefaultJwtRetrieverTest extends OAuthBearerTest {
    ...
    public void testConfigureRefreshingFileJwtRetriever() throws Exception {
        ...
        try (JwtRetriever jwtRetriever = new DefaultJwtRetriever()) {
            jwtRetriever.configure(configs, OAUTHBEARER_MECHANISM, getJaasConfig());
    ...
    public void testConfigureRefreshingFileJwtRetrieverWithInvalidDirectory() throws IOException {
        ...
        try (JwtRetriever jwtRetriever = new DefaultJwtRetriever()) {
            assertThrowsWithMessage(ConfigException.class, () -> jwtRetriever.configure(configs, OAUTHBEARER_MECHANISM, getJaasConfig()), "that doesn't exist");
        }
    }
    ...
    public void testConfigureWithAccessTokenFile() throws Exception {
        ...
        assertDoesNotThrow(() -> jwtRetriever.configure(configs, OAUTHBEARER_MECHANISM, getJaasConfig()));
    ...
    public void testConfigureWithAccessClientCredentials() {
        ...
        DefaultJwtRetriever jwtRetriever = new DefaultJwtRetriever();
        assertDoesNotThrow(() -> jwtRetriever.configure(configs, OAUTHBEARER_MECHANISM, getJaasConfig(jaasConfigs)));
