...
public class SessionWithTimestampStoreBuilder<K, V> extends AbstractStoreBuilder<K, ValueAndTimestamp<V>, SessionStore<K, ValueAndTimestamp<V>>> {

    private final SessionBytesStoreSupplier storeSupplier;

    public SessionWithTimestampStoreBuilder(final SessionBytesStoreSupplier storeSupplier,
