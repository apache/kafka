...
public class FileConfigDefValidatorTest extends AbstractConfigDefValidatorTest {
    ...
    public void testFileDoesNotExist() {
        assertThrowsWithMessage(() -> ensureValid("/tmp/not/a/real/file.txt"), "that doesn't exist");
    }
    ...
    public void testFileUnreadable() throws IOException {
        ...
        assertThrowsWithMessage(() -> ensureValid(file.getAbsolutePath()), "that doesn't have read permission");
    }
