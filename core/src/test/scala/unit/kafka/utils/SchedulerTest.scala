...
class SchedulerTest {
  ...
  def testUnscheduleProducerTask(): Unit = {
    ...
    val maxProducerIdExpirationMs = KafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT
    val producerIdExpirationCheckIntervalMs = KafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT
