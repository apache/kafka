...
public class MeteredSessionStoreTest {
    ...
    public void shouldDelegateDeprecatedInit() {
        ...
        verify(inner, times(1)).init((ProcessorContext) context, outer);
    }
    ...
    public void shouldWriteBytesToInnerStoreAndRecordPutMetric() {
        ...
        verify(innerStore, times(1)).put(eq(WINDOWED_KEY_BYTES), aryEq(VALUE_BYTES));
    }
    ...
    public void shouldFindSessionsFromStoreAndRecordFetchMetric() {
        ...
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).findSessions(KEY_BYTES, 0, 0);
    }
    ...
    public void shouldBackwardFindSessionsFromStoreAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).backwardFindSessions(KEY_BYTES, 0, 0);
    }
    ...
    public void shouldFindSessionRangeFromStoreAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).findSessions(KEY_BYTES, KEY_BYTES, 0, 0);
    }
    ...
    public void shouldBackwardFindSessionRangeFromStoreAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).backwardFindSessions(KEY_BYTES, KEY_BYTES, 0, 0);
    }
    ...
    public void shouldRemoveFromStoreAndRecordRemoveMetric() {
        ...
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).remove(WINDOWED_KEY_BYTES);
    }
    ...
    public void shouldFetchForKeyAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).fetch(KEY_BYTES);
    }
    ...
    public void shouldBackwardFetchForKeyAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).backwardFetch(KEY_BYTES);
    }
    ...
    public void shouldFetchRangeFromStoreAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).fetch(KEY_BYTES, KEY_BYTES);
    }
    ...
    public void shouldBackwardFetchRangeFromStoreAndRecordFetchMetric() {
        ...
        final KafkaMetric metric = metric("fetch-rate");
        assertTrue((Double) metric.metricValue() > 0);
        verify(innerStore, times(1)).backwardFetch(KEY_BYTES, KEY_BYTES);
    }
    ...
    public void shouldRemoveMetricsOnClose() {
        ...
        verify(innerStore, times(1)).close();
    }
