...
public class SslSelectorTest extends SelectorTest {
    ...
    public void setUp() throws Exception {
        ...
        this.selector = new Selector(5000, metrics, time, "MetricGroup", channelBuilder, new LogContext(), 5000L);
    }
    ...
    public void testMuteOnOOM() throws Exception {
        ...
        selector = new Selector(NetworkReceive.UNLIMITED, 5000, metrics, time, "MetricGroup",
                new HashMap<String, String>(), true, false, channelBuilder, pool, new LogContext(), 5000L);
