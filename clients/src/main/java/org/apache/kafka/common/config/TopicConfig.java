...
public class TopicConfig {
    ...
    public static final String REMOTE_COPY_LAG_MS_DOC = "Controls how long to delay uploading segments to remote storage. " +
            ...
            "When set to -1, resolves to the effective <code>local.retention.ms</code> (maximum delay, or upload immediately when <code>local.retention.ms</code> is -1). " +
            ...
            "The value should not exceed the effective <code>local.retention.ms</code> when that value is non-negative.";
    ...
    public static final String REMOTE_COPY_LAG_BYTES_DOC = "Controls size-based delay for uploading segments to remote storage. " +
            "When set to 0 (default), segments are uploaded as soon as they are eligible (no delay). " +
            "When set to -1, resolves to the effective <code>local.retention.bytes</code> (maximum delay, or upload immediately when <code>local.retention.bytes</code> is -1). " +
            "When set to a positive value (bytes), a segment becomes eligible for upload only when the total bytes of log data after the segment reach the value. " +
            "The value should not exceed the effective <code>local.retention.bytes</code> when that value is non-negative.";
