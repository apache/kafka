...
public class GroupMetadataManager {
    ...
    private CoordinatorResult<ConsumerGroupHeartbeatResponseData, CoordinatorRecord> consumerGroupHeartbeat(
        ...
        if (bumpGroupEpoch || group.hasMetadataExpired(currentTimeMs)) {
            ...
            if (subscriptionMetadataHash != group.subscribedTopicMetadataHash()) {
    ...
    public void replay(
        ...
        if (value != null) {
            ...
            consumerGroup.setSubscribedTopicMetadataHash(value.subscriptionMetadataHash());
        } else {
            ConsumerGroup consumerGroup;
            try {
    ...
    public void replay(
        ...
        if (value != null) {
            ...
            shareGroup.setSubscribedTopicMetadataHash(value.subscriptionMetadataHash());
        } else {
