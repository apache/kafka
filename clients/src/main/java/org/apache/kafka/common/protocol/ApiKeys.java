...
public enum ApiKeys {
    ...
    DESCRIBE_CLIENT_CONFIGS(900, "DescribeClientConfigs", DescribeClientConfigsRequestData.SCHEMAS,
            DescribeClientConfigsResponseData.SCHEMAS),
    ALTER_CLIENT_CONFIGS(901, "AlterClientConfigs", AlterClientConfigsRequestData.SCHEMAS,
            AlterClientConfigsResponseData.SCHEMAS);
