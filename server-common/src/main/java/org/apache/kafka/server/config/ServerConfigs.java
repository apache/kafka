...
public class ServerConfigs {
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            ...
            .define(CONFIG_PROVIDERS_CONFIG, ConfigDef.Type.LIST, List.of(), ConfigDef.ValidList.anyValues(true, false), ConfigDef.Importance.LOW, CONFIG_PROVIDERS_DOC)
            /************* Authorizer Configuration ***********/
            ...
            .define(EARLY_START_LISTENERS_CONFIG, LIST, null, ConfigDef.ValidList.anyValues(true, true), HIGH, EARLY_START_LISTENERS_DOC)
            /************ Rack Configuration ******************/
