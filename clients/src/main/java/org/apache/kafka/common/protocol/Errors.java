...
public enum Errors {
    ...
    TOPIC_AUTHORIZATION_FAILED(29, "Topic authorization failed.", msg -> new TopicAuthorizationException(msg, null)),
    GROUP_AUTHORIZATION_FAILED(30, "Group authorization failed.", msg -> new GroupAuthorizationException(msg, null)),
