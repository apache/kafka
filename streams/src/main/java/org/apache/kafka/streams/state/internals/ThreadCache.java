...
public class ThreadCache {
    ...
    public MemoryLRUCacheBytesIterator range(final String namespace, final byte[] from, final byte[] to) {
        ...
        return new MemoryLRUCacheBytesIterator(keySetIterator(cache.keySubSet(cacheKey(from), cacheKey(to))), cache);
    }
    ...
    public MemoryLRUCacheBytesIterator all(final String namespace) {
        ...
        return new MemoryLRUCacheBytesIterator(keySetIterator(cache.keySet()), cache);
    }
