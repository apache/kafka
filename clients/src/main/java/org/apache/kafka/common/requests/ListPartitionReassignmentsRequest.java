...
public class ListPartitionReassignmentsRequest extends AbstractRequest {
    ...
    public ListPartitionReassignmentsRequest(Struct struct, short version) {
        super(ApiKeys.LIST_PARTITION_REASSIGNMENTS, version);
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e) {
        ListPartitionReassignmentsResponseData response = new ListPartitionReassignmentsResponseData();
        response.setThrottleTimeMs(throttleTimeMs);
        Errors error = Errors.forException(e);
        response.setErrorCode(error.code());
        response.setErrorMessage(error.message());
        return new ListPartitionReassignmentsResponse(response);
    }

    public static ListPartitionReassignmentsRequest parse(ByteBuffer buffer, short version) {
        return new ListPartitionReassignmentsRequest(ApiKeys.LIST_PARTITION_REASSIGNMENTS.
