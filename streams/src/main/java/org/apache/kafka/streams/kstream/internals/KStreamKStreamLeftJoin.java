...
class KStreamKStreamLeftJoin<K, R, V1, V2> implements ProcessorSupplier<K, V1> {
    ...
    KStreamKStreamLeftJoin(String otherWindowName, ValueJoiner<V1, V2, R> joiner) {
    ...
    private class KStreamKStreamLeftJoinProcessor extends AbstractProcessor<K, V1> {
