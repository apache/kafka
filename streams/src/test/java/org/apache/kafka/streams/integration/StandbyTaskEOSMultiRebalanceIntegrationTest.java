...
public class StandbyTaskEOSMultiRebalanceIntegrationTest {
    ...
    private KafkaStreams buildWithUniqueIdAssignmentTopology(final String stateDirPath) {
        final Topology top = new Topology();

        top.addSource(inputTopic, inputTopic);
        top.addProcessor("Processor", () ->
        ...
        top.addStateStore(Stores.keyValueStoreBuilder(
        ...
        top.addSink(outputTopic, outputTopic, "Processor");
        return new KafkaStreams(top, props(stateDirPath));
    }
