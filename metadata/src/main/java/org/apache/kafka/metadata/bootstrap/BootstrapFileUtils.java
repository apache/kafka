...
/**
 * Utility class for reading bootstrap metadata from binary files.
 */
public final class BootstrapFileUtils {

    private BootstrapFileUtils() {
     ...
     */
    public static BootstrapMetadata readFromBinaryFile(String binaryPath) {
