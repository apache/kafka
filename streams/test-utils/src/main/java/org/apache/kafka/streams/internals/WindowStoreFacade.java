...
public class WindowStoreFacade<K, V> extends ReadOnlyWindowStoreFacade<K, V> implements WindowStore<K, V> {
    ...
    public WindowStoreFacade(final WindowWithTimestampStore<K, V> store) {
        super(store);
    }
    ...
    public void put(final K key,
                    final V value) {
        inner.put(key, new ValueAndTimestampImpl<>(value, -1L));
    }
    ...
    public void put(final K key,
        ...
        inner.put(key, value, -1L, windowStartTimestamp);
    }
