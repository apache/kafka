...
object LogTestUtils {
  ...
  def createLog(dir: File,
                ...
                producerStateManagerConfig: ProducerStateManagerConfig = new ProducerStateManagerConfig(KafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT, false),
                producerIdExpirationCheckIntervalMs: Int = KafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT,
