...
public class StaticMemberPersistentProcessIdTestClient {
    ...
    private static final String TEST_NAME = "StaticMemberPersistentProcessIdTestClient";
    ...
    public static void main(final String[] args) throws Exception {
        ...
        // Keep one persistent store so the Streams processId survives restart.
        ...
        Exit.addShutdownHook("streams-shutdown-hook", () -> {
            ...
            System.out.flush();
            streams.close();
            System.out.println("Static membership persistent-process-id test closed");
            System.out.flush();
        });
    }
}