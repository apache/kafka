...
public class ShareGroupConfig {
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(SHARE_GROUP_MAX_DELIVERY_COUNT_LIMIT_CONFIG, INT, SHARE_GROUP_MAX_DELIVERY_COUNT_LIMIT_DEFAULT, between(5, 25), LOW, SHARE_GROUP_MAX_DELIVERY_COUNT_LIMIT_DOC)
            .define(SHARE_GROUP_MIN_DELIVERY_COUNT_LIMIT_CONFIG, INT, SHARE_GROUP_MIN_DELIVERY_COUNT_LIMIT_DEFAULT, between(2, 5), LOW, SHARE_GROUP_MIN_DELIVERY_COUNT_LIMIT_DOC)
            ...
            .define(SHARE_GROUP_MIN_RECORD_LOCK_DURATION_MS_CONFIG, INT, SHARE_GROUP_MIN_RECORD_LOCK_DURATION_MS_DEFAULT, between(1000, 30000), LOW, SHARE_GROUP_MIN_RECORD_LOCK_DURATION_MS_DOC)
            .define(SHARE_GROUP_MAX_RECORD_LOCK_DURATION_MS_CONFIG, INT, SHARE_GROUP_MAX_RECORD_LOCK_DURATION_MS_DEFAULT, between(30000, 3600000), LOW, SHARE_GROUP_MAX_RECORD_LOCK_DURATION_MS_DOC)
            ...
            .define(SHARE_GROUP_MAX_PARTITION_MAX_RECORD_LOCKS_CONFIG, INT, SHARE_GROUP_MAX_PARTITION_MAX_RECORD_LOCKS_DEFAULT, between(2000, 10000), LOW, SHARE_GROUP_MAX_PARTITION_MAX_RECORD_LOCKS_DOC)
            .define(SHARE_GROUP_MIN_PARTITION_MAX_RECORD_LOCKS_CONFIG, INT, SHARE_GROUP_MIN_PARTITION_MAX_RECORD_LOCKS_DEFAULT, between(100, 2000), LOW, SHARE_GROUP_MIN_PARTITION_MAX_RECORD_LOCKS_DOC)
            .define(SHARE_FETCH_PURGATORY_PURGE_INTERVAL_REQUESTS_CONFIG, INT, SHARE_FETCH_PURGATORY_PURGE_INTERVAL_REQUESTS_DEFAULT, LOW, SHARE_FETCH_PURGATORY_PURGE_INTERVAL_REQUESTS_DOC)
