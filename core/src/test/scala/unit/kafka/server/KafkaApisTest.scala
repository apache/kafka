...
class KafkaApisTest {
  ...
  def testListTransactionsAuthorization(): Unit = {
    ...
    val response = readResponse(ApiKeys.LIST_TRANSACTIONS, listTransactionsRequest, capturedResponse)
  ...
  def testDescribeTransactionsAuthorization(): Unit = {
    ...
    val response = readResponse(ApiKeys.DESCRIBE_TRANSACTIONS, describeTransactionsRequest, capturedResponse)
  ...
  def testDescribeProducersAuthorization(): Unit = {
    ...
    val response = readResponse(ApiKeys.DESCRIBE_PRODUCERS, describeProducersRequest, capturedResponse)
