...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(Map<String, Object> configs,
        ...
        try {
            ...
            long retryBackoffMaxMS = config.getLong(ProducerConfig.RECONNECT_BACKOFF_MAX_MS_CONFIG);
    ...
    private TransactionManager configureTransactionState(ProducerConfig config,
        ...
        if (config.idempotenceEnabled()) {
            ...
            final long retryBackoffMaxMs = config.getLong(ProducerConfig.RECONNECT_BACKOFF_MAX_MS_CONFIG);
