...
public class KGroupedTableImplTest {
    ...
    private MockOldProcessorSupplier<String, Integer> getReducedResults(final KTable<String, Integer> inputKTable) {
    ...
    public void shouldReduce() {
        ...
        final MockOldProcessorSupplier<String, Integer> supplier = getReducedResults(reduced);
