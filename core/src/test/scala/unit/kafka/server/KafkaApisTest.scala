...
class KafkaApisTest extends Logging {
  ...
  def testHandleOffsetCommitRequest(version: Short): Unit = {
    ...
    val requestChannelRequest = buildRequest(new OffsetCommitRequest.Builder(offsetCommitRequest, true, true).build(version))
  ...
  def testHandleOffsetCommitRequestTopicsAndPartitionsValidationWithTopicIds(): Unit = {
    ...
    val requestChannelRequest = buildRequest(new OffsetCommitRequest.Builder(offsetCommitRequest, true, true).build())
  ...
  def testHandleOffsetCommitRequestTopicsAndPartitionsValidation(): Unit = {
    ...
    val requestChannelRequest = buildRequest(new OffsetCommitRequest.Builder(offsetCommitRequest, false).build())
