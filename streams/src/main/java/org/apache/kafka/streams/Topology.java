...
public class Topology {
     ...
     * The source will use the {@link StreamsConfig#KEY_SERDE_CLASS_DEFAULT_CONFIG default key deserializer} and
     * {@link StreamsConfig#VALUE_SERDE_CLASS_DEFAULT_CONFIG default value deserializer} specified in the
     ...
     * The sink will use the {@link StreamsConfig#KEY_SERDE_CLASS_DEFAULT_CONFIG default key serializer} and
     * {@link StreamsConfig#VALUE_SERDE_CLASS_DEFAULT_CONFIG default value serializer} specified in the
     * {@link StreamsConfig stream configuration}.
     *
     ...
     * should use the {@link StreamsConfig#KEY_SERDE_CLASS_DEFAULT_CONFIG default key serializer} specified in the
     * {@link StreamsConfig stream configuration}
     * @param valueSerializer the {@link Serializer value serializer} used when consuming records; may be null if the sink
     * should use the {@link StreamsConfig#VALUE_SERDE_CLASS_DEFAULT_CONFIG default value serializer} specified in the
     * {@link StreamsConfig stream configuration}
     * @param parentNames the name of one or more source or processor nodes whose output records this sink should consume
     * and write to its topic
     * @return itself
