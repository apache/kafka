...
class ThrottledChannelExpirationTest {
  ...
  def testCallbackInvocationAfterExpiration() {
    ...
    try {
      ...
      val channel1 = new ThrottledChannel(null, time, 10, callback)
      val channel2 = new ThrottledChannel(null, time, 30, callback)
      val channel3 = new ThrottledChannel(null, time, 30, callback)
      val channel4 = new ThrottledChannel(null, time, 20, callback)
  ...
  def testThrottledChannelDelay() {
    val t1: ThrottledChannel = new ThrottledChannel(null, time, 10, callback)
    val t2: ThrottledChannel = new ThrottledChannel(null, time, 20, callback)
    val t3: ThrottledChannel = new ThrottledChannel(null, time, 20, callback)
