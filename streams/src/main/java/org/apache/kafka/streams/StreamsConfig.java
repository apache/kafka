...
public class StreamsConfig extends AbstractConfig {
    ...
    public static final String RACK_AWARE_ASSIGNMENT_STRATEGY_DOC = "The strategy we use for rack aware assignment. Rack aware assignment will take client.rack and racks of TopicPartition into account when assigning"
        + " tasks to minimize cross rack traffic. Valid settings are : <code>" + RACK_AWARE_ASSSIGNMENT_STRATEGY_NONE + "</code>, which will disable rack aware assignment; <code>" + RACK_AWARE_ASSSIGNMENT_STRATEGY_MIN_TRAFFIC
        + "</code>, which will compute minimum cross rack traffic assignment and <code>" + RACK_AWARE_ASSSIGNMENT_STRATEGY_MIN_TRAFFIC_BALANCE_SUBTOPOLOGY + "</code>, which will compute minimum cross rack traffic with "
        + "balanced subtopology";
