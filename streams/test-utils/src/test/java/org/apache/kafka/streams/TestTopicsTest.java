...
public class TestTopicsTest {
    ...
    public void setup() {
        ...
        properties.put(StreamsConfig.KEY_SERDE_CLASS_DEFAULT_CONFIG, Serdes.ByteArraySerde.class);
        properties.put(StreamsConfig.VALUE_SERDE_CLASS_DEFAULT_CONFIG, Serdes.ByteArraySerde.class);
