 ...
 * @param <V>
 */
class TimestampedSessionTupleForwarder<K, V> {
    private final ProcessorContext context;
    private final boolean sendOldValues;
    private final boolean cachingEnabled;

    @SuppressWarnings("unchecked")
    TimestampedSessionTupleForwarder(final StateStore store,
                                     final ProcessorContext context,
                                     final TimestampedSessionCacheFlushListener<Windowed<K>, V> flushListener,
