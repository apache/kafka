...
public class SocketServerConfigs {
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(SOCKET_SEND_BUFFER_BYTES_CONFIG, INT, SOCKET_SEND_BUFFER_BYTES_DEFAULT, MEDIUM, SOCKET_SEND_BUFFER_BYTES_DOC)
            .define(SOCKET_RECEIVE_BUFFER_BYTES_CONFIG, INT, SOCKET_RECEIVE_BUFFER_BYTES_DEFAULT, MEDIUM, SOCKET_RECEIVE_BUFFER_BYTES_DOC)
            ...
            .define(QUEUED_MAX_REQUESTS_CONFIG, INT, QUEUED_MAX_REQUESTS_DEFAULT, atLeast(1), MEDIUM, QUEUED_MAX_REQUESTS_DOC)
