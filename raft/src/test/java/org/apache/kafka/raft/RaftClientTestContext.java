...
public final class RaftClientTestContext {
    ...
    static class MockListener implements RaftClient.Listener<String> {
        ...
        private final OptionalInt localId;
        private Optional<RecordsSnapshotReader<String>> snapshot = Optional.empty();
        ...
        Optional<RecordsSnapshotReader<String>> drainHandledSnapshot() {
            Optional<RecordsSnapshotReader<String>> temp = snapshot;
        ...
        @Override
        public void handleSnapshot(RecordsSnapshotReader<String> reader) {
