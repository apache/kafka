 ...
 * batches (see {@link RecordBatch}). There are two types of {@link Records} - {@link Records} and
 * {@link SendableRecords}. {@link Records} provides methods for reading the underlying records, while
 * {@link SendableRecords} provides methods to write records out to a channel.
 *
