...
public class ConsumerConfig extends AbstractConfig {
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG,
                                ...
                                .define(SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG, Type.PASSWORD_STRING, Importance.HIGH, SslConfigs.SSL_KEYSTORE_PASSWORD_DOC, false)
                                .define(SslConfigs.SSL_KEY_PASSWORD_CONFIG, Type.PASSWORD_STRING, Importance.HIGH, SslConfigs.SSL_KEY_PASSWORD_DOC, false)
                                ...
                                .define(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, Type.PASSWORD_STRING, Importance.HIGH, SslConfigs.SSL_TRUSTSTORE_PASSWORD_DOC, false)
