...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(ProducerConfig config,
        ...
        try {
            ...
            List<ProducerInterceptor<K, V>> interceptorList = ClientUtils.getConfiguredInterceptors(config,
            ...
            ClusterResourceListeners clusterResourceListeners = ClientUtils.configureClusterResourceListeners(interceptorList,
                    reporters,
