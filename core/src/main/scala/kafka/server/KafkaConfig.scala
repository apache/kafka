...
import org.apache.kafka.server.config.{Defaults, ClientQuotaManagerConfig, ReplicationQuotaManagerConfig, ServerTopicConfigSynonyms}
...
object KafkaConfig {
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(SaslServerMaxReceiveSizeProp, INT, Defaults.SERVER_MAX_MAX_RECEIVE_SIZE, MEDIUM, SaslServerMaxReceiveSizeDoc)
