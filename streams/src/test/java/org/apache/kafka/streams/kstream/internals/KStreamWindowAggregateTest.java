...
public class KStreamWindowAggregateTest {
    ...
    public void testAggBasic() {
        ...
        assertEquals(
            asList(
                    new KeyValueTimestamp<>("[A@0/10]", "0+1", 0),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2", 1),
                    new KeyValueTimestamp<>("[C@0/10]", "0+3", 2),
                    new KeyValueTimestamp<>("[D@0/10]", "0+4", 3),
                    new KeyValueTimestamp<>("[A@0/10]", "0+1+1", 4),
                    new KeyValueTimestamp<>("[A@0/10]", "0+1+1+1", 5),
                    new KeyValueTimestamp<>("[A@5/15]", "0+1", 5),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2", 6),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2", 6),
                    new KeyValueTimestamp<>("[D@0/10]", "0+4+4", 7),
                    new KeyValueTimestamp<>("[D@5/15]", "0+4", 7),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2+2", 8),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2+2", 8),
                    new KeyValueTimestamp<>("[C@0/10]", "0+3+3", 9),
                    new KeyValueTimestamp<>("[C@5/15]", "0+3", 9),
                    new KeyValueTimestamp<>("[A@5/15]", "0+1+1", 10),
                    new KeyValueTimestamp<>("[A@10/20]", "0+1", 10),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2+2+2", 11),
                    new KeyValueTimestamp<>("[B@10/20]", "0+2", 11),
                    new KeyValueTimestamp<>("[D@5/15]", "0+4+4", 12),
                    new KeyValueTimestamp<>("[D@10/20]", "0+4", 12),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2+2+2+2", 13),
                    new KeyValueTimestamp<>("[B@10/20]", "0+2+2", 13),
                    new KeyValueTimestamp<>("[C@5/15]", "0+3+3", 14),
                    new KeyValueTimestamp<>("[C@10/20]", "0+3", 14),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2+2+1", 8),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2+2+1+2", 8),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2+2+1+2+3", 9),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2+2+2+2+3", 13)
                ),
    ...
    public void testJoin() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props)) {
            ...
            processors.get(0).checkAndClearProcessResult(
                    ...
                    new KeyValueTimestamp<>("[C@0/10]", "0+3", 2),
                    new KeyValueTimestamp<>("[D@0/10]", "0+4", 3),
                    new KeyValueTimestamp<>("[A@0/10]", "0+1+1", 9),
                    new KeyValueTimestamp<>("[A@5/15]", "0+1", 9)
            );
            ...
            processors.get(0).checkAndClearProcessResult(
                    new KeyValueTimestamp<>("[A@0/10]", "0+1+1+1", 9),
                    new KeyValueTimestamp<>("[A@5/15]", "0+1+1", 9),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2", 6),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2", 6),
                    new KeyValueTimestamp<>("[D@0/10]", "0+4+4", 7),
                    new KeyValueTimestamp<>("[D@5/15]", "0+4", 7),
            ...
            processors.get(1).checkAndClearProcessResult(
                    new KeyValueTimestamp<>("[A@0/10]", "0+a", 0),
                    new KeyValueTimestamp<>("[B@0/10]", "0+b", 1),
                    new KeyValueTimestamp<>("[C@0/10]", "0+c", 2),
                    new KeyValueTimestamp<>("[D@15/25]", "0+d", 20),
                    new KeyValueTimestamp<>("[D@20/30]", "0+d", 20),
                    new KeyValueTimestamp<>("[A@15/25]", "0+a", 20),
                    new KeyValueTimestamp<>("[A@20/30]", "0+a", 20)
            );
            processors.get(2).checkAndClearProcessResult(
                    new KeyValueTimestamp<>("[A@0/10]", "0+1+1+1%0+a", 9),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2+2%0+b", 8),
                    new KeyValueTimestamp<>("[C@0/10]", "0+3+3%0+c", 9));
            ...
            processors.get(0).checkAndClearProcessResult(new KeyValueTimestamp[0]);
            processors.get(1).checkAndClearProcessResult(
                    new KeyValueTimestamp<>("[A@0/10]", "0+a+a", 5),
                    new KeyValueTimestamp<>("[A@5/15]", "0+a", 5),
                    new KeyValueTimestamp<>("[B@0/10]", "0+b+b", 6),
                    new KeyValueTimestamp<>("[B@5/15]", "0+b", 6),
                    new KeyValueTimestamp<>("[D@0/10]", "0+d", 7),
                    new KeyValueTimestamp<>("[D@5/15]", "0+d", 7),
                    new KeyValueTimestamp<>("[D@10/20]", "0+d", 18),
                    new KeyValueTimestamp<>("[D@15/25]", "0+d+d", 20),
                    new KeyValueTimestamp<>("[A@15/25]", "0+a+a", 21),
                    new KeyValueTimestamp<>("[A@20/30]", "0+a+a", 21)
            );
            processors.get(2).checkAndClearProcessResult(
                    new KeyValueTimestamp<>("[A@0/10]", "0+1+1+1%0+a+a", 9),
                    new KeyValueTimestamp<>("[A@5/15]", "0+1+1%0+a", 9),
                    new KeyValueTimestamp<>("[B@0/10]", "0+2+2+2%0+b+b", 8),
                    new KeyValueTimestamp<>("[B@5/15]", "0+2+2%0+b", 8),
                    new KeyValueTimestamp<>("[D@0/10]", "0+4+4%0+d", 7),
                    new KeyValueTimestamp<>("[D@5/15]", "0+4%0+d", 7)
            );
        }
    }
