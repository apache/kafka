 ...
 */
public class FetchResponse extends AbstractFetchResponse<AbstractFetchResponse.PartitionData> {
    ...
    public static FetchResponse constructFetchResponse(Struct struct) {
        ...
        return new FetchResponse(Errors.forCode(struct.getOrElse(ERROR_CODE, (short) 0)),
                responseData,
