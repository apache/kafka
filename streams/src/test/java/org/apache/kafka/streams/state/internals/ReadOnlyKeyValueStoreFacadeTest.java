...
public class ReadOnlyKeyValueStoreFacadeTest {
    ...
    public void shouldReturnPlainValueOnGet() {
        ...
        verify(mockedKeyValueTimestampStore, times(1)).get("key");
        verify(mockedKeyValueTimestampStore, times(1)).get("unknownKey");
    }
    ...
    public void shouldReturnPlainKeyValuePairsForRangeIterator() {
        ...
        verify(mockedKeyValueTimestampIterator, times(2)).next();
        verify(mockedKeyValueTimestampStore, times(1)).range("key1", "key2");
    }
    ...
    public void shouldReturnPlainKeyValuePairsForPrefixScan() {
        ...
        assertThat(iterator.next(), is(KeyValue.pair("key2", "value2")));
        verify(mockedKeyValueTimestampIterator, times(2)).next();
        verify(mockedKeyValueTimestampStore, times(1)).prefixScan("key", stringSerializer);
    }
    ...
    public void shouldReturnPlainKeyValuePairsForAllIterator() {
        ...
        assertThat(iterator.next(), is(KeyValue.pair("key2", "value2")));
        verify(mockedKeyValueTimestampIterator, times(2)).next();
        verify(mockedKeyValueTimestampStore, times(1)).all();
    }
    ...
    public void shouldForwardApproximateNumEntries() {
        ...
        verify(mockedKeyValueTimestampStore, times(1)).approximateNumEntries();
    }
}
