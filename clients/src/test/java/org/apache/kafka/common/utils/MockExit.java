 ...
 * <p>Instances of this class throw from {@link #exitOrThrow(int, String)} and {@link #haltOrThrow(int, String)},
 * killing the calling thread, but keeping the JVM alive. Call {@link #close()} at the end of the test to run
