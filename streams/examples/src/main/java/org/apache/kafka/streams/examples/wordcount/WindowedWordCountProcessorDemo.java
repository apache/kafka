 ...
 * that computes a simple word occurrence histogram from an input text. Also demonstrates the
 * use of specific store implementations, in this case, a windowed store.
 * <p>
 * <strong>Note: This is simplified code that only works correctly for single partition input topics.</strong>
 * <p>
 * Before running this example you must create the input topic and the output topic (e.g. via
 * {@code bin/kafka-topics.sh --create ...}), and write some data to the input topic (e.g. via
 * {@code bin/kafka-console-producer.sh}). Otherwise you won't see any data arriving in the output topic.
 */
public final class WindowedWordCountProcessorDemo {

    private WindowedWordCountProcessorDemo() {}
    ...
    public static void main(final String[] args) {
        ...
        builder.addStateStore(
            Stores.windowStoreBuilder(
                Stores.inMemoryWindowStore("WindowedCounts", Duration.ofHours(1), Duration.ofMillis(100), false),
                Serdes.String(),
                Serdes.Integer()
            ),
            "Process"
