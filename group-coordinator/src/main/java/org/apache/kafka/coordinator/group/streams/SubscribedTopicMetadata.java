...
/**
 * The subscribed topic metadata class is used by the {@link org.apache.kafka.coordinator.group.assignor.PartitionAssignor} to obtain
...
public class SubscribedTopicMetadata implements SubscribedTopicDescriber {
    /**
     * The topic Ids mapped to their corresponding {@link org.apache.kafka.coordinator.group.consumer.TopicMetadata}
     * object, which contains topic and partition metadata.
     */
    private final Map<Uuid, org.apache.kafka.coordinator.group.consumer.TopicMetadata> topicMetadata;

    public SubscribedTopicMetadata(Map<Uuid, org.apache.kafka.coordinator.group.consumer.TopicMetadata> topicMetadata) {
     ...
     */
    public Map<Uuid, org.apache.kafka.coordinator.group.consumer.TopicMetadata> topicMetadata() {
    ...
    public int numPartitions(Uuid topicId) {
        org.apache.kafka.coordinator.group.consumer.TopicMetadata topic = this.topicMetadata.get(topicId);
