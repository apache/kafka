...
public class ProducerConfig extends AbstractConfig {
    ...
    "This strategy send records to a partition until at least " + BATCH_SIZE_CONFIG + " bytes is produced to the partition. It works with the strategy: /n" +
              "1) If no partition is specified but a key is present, choose a partition based on a hash of the key. /n" +
                "2) If no partition or key is present, choose the sticky partition that changes when at least " + BATCH_SIZE_CONFIG + " bytes are produced to the partition./n" +
        "</li>" +
