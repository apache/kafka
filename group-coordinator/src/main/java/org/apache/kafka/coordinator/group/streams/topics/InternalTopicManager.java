...
public class InternalTopicManager {
    ...
    public static Map<String, CreatableTopic> missingTopics(Map<String, TopicsInfo> subtopologyMap,
                                                            MetadataImage metadataImage) {

        final Map<String, CreatableTopic> topicsToCreate = new HashMap<>();
        for (TopicsInfo subtopology : subtopologyMap.values()) {
    ...
    public static Map<String, TopicsInfo> configureTopics(LogContext logContext,
                                                          List<StreamsGroupTopologyValue.Subtopology> subtopologyList,
                                                          MetadataImage metadataImage) {

        final Logger log = logContext.logger(InternalTopicManager.class);

        final Map<String, TopicsInfo> configuredSubtopologies =
        ...
        final Map<String, InternalTopicConfig> configuredInternalTopics =
    ...
    private static void enforceCopartitioning(LogContext logContext,
        ...
        final Map<String, InternalTopicConfig> repartitionTopicConfigs =
            configuredSubtopologies.values().stream().flatMap(x ->
                x.repartitionSourceTopics().values().stream()
            ).collect(Collectors.toMap(InternalTopicConfig::name, x -> x));
    ...
    private static Integer getPartitionCount(MetadataImage metadataImage,
                                             String topic,
                                             Map<String, InternalTopicConfig> configuredInternalTopics) {
    ...
    private static TopicsInfo fromPersistedSubtopology(
