...
import org.apache.kafka.server.log.internals.{AbortedTxn, AppendOrigin, LogDirFailureChannel, OffsetMap, Throttler}
...
class LogCleanerTest {
  ...
  val throttler = new Throttler(Double.MaxValue, Long.MaxValue, time)
