...
public class BrokerApiVersionsCommand {
    ...
    protected static class AdminClient implements AutoCloseable {
        ...
        private static final ConfigDef ADMIN_CONFIG_DEF = new ConfigDef()
                .define(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, ConfigDef.Type.LIST, ConfigDef.NO_DEFAULT_VALUE, ConfigDef.ValidList.anyValues(false, false), ConfigDef.Importance.HIGH, CommonClientConfigs.BOOTSTRAP_SERVERS_DOC)
