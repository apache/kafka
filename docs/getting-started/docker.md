...
```bash
$ docker pull apache/kafka:4.5.0
```
...
```bash
$ docker run -p 9092:9092 apache/kafka:4.5.0
```
...
```bash
$ docker pull apache/kafka-native:4.5.0
```
...
```bash
$ docker run -p 9092:9092 apache/kafka-native:4.5.0
```
