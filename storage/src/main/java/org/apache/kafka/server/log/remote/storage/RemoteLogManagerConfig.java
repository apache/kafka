...
public final class RemoteLogManagerConfig extends AbstractConfig {
     ...
     */
    public static final String REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG = "remote.log.metadata.manager.impl.prefix";
    ...
    public static ConfigDef configDef() {
        return new ConfigDef()
                .define(REMOTE_LOG_STORAGE_SYSTEM_ENABLE_CONFIG,
                        BOOLEAN,
                ...
                .define(REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG,
                        STRING,
                ...
                .define(REMOTE_FETCH_MAX_WAIT_MS_CONFIG,
                        INT,
    ...
    public boolean isRemoteStorageSystemEnabled() {
        return getBoolean(REMOTE_LOG_STORAGE_SYSTEM_ENABLE_CONFIG);
    }

    public String remoteStorageManagerClassName() {
        return getString(REMOTE_STORAGE_MANAGER_CLASS_NAME_CONFIG);
    }

    public String remoteStorageManagerClassPath() {
        return getString(REMOTE_STORAGE_MANAGER_CLASS_PATH_CONFIG);
    }

    public String remoteLogMetadataManagerClassName() {
        return getString(REMOTE_LOG_METADATA_MANAGER_CLASS_NAME_CONFIG);
    }

    public String remoteLogMetadataManagerClassPath() {
        return getString(REMOTE_LOG_METADATA_MANAGER_CLASS_PATH_CONFIG);
    }

    public long remoteLogIndexFileCacheTotalSizeBytes() {
        return getLong(REMOTE_LOG_INDEX_FILE_CACHE_TOTAL_SIZE_BYTES_CONFIG);
    }

    public int remoteLogManagerThreadPoolSize() {
        return getInt(REMOTE_LOG_MANAGER_THREAD_POOL_SIZE_CONFIG);
    }

    public int remoteLogManagerCopierThreadPoolSize() {
        return getInt(REMOTE_LOG_MANAGER_COPIER_THREAD_POOL_SIZE_CONFIG);
    }

    public int remoteLogManagerExpirationThreadPoolSize() {
        return getInt(REMOTE_LOG_MANAGER_EXPIRATION_THREAD_POOL_SIZE_CONFIG);
    }

    public long remoteLogManagerTaskIntervalMs() {
        return getLong(REMOTE_LOG_MANAGER_TASK_INTERVAL_MS_CONFIG);
    }

    public long remoteLogManagerTaskRetryBackoffMs() {
        return getLong(REMOTE_LOG_MANAGER_TASK_RETRY_BACK_OFF_MS_CONFIG);
    }

    public long remoteLogManagerTaskRetryBackoffMaxMs() {
        return getLong(REMOTE_LOG_MANAGER_TASK_RETRY_BACK_OFF_MAX_MS_CONFIG);
    }

    public double remoteLogManagerTaskRetryJitter() {
        return getDouble(REMOTE_LOG_MANAGER_TASK_RETRY_JITTER_CONFIG);
    }

    public int remoteLogReaderThreads() {
        return getInt(REMOTE_LOG_READER_THREADS_CONFIG);
    }

    public int remoteLogReaderMaxPendingTasks() {
        return getInt(REMOTE_LOG_READER_MAX_PENDING_TASKS_CONFIG);
    }

    public String remoteLogMetadataManagerListenerName() {
        return getString(REMOTE_LOG_METADATA_MANAGER_LISTENER_NAME_CONFIG);
    }

    public int remoteLogMetadataCustomMetadataMaxBytes() {
        return getInt(REMOTE_LOG_METADATA_CUSTOM_METADATA_MAX_BYTES_CONFIG);
    }

    public String remoteStorageManagerPrefix() {
        return getString(REMOTE_STORAGE_MANAGER_CONFIG_PREFIX_CONFIG);
    }

    public String remoteLogMetadataManagerPrefix() {
        return getString(REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG);
    }

    public Map<String, Object> remoteStorageManagerProps() {
        return getConfigProps(REMOTE_STORAGE_MANAGER_CONFIG_PREFIX_CONFIG);
    }

    public Map<String, Object> remoteLogMetadataManagerProps() {
        return getConfigProps(REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG);
    }
    ...
    public long remoteLogManagerCopyMaxBytesPerSecond() {
        return getLong(REMOTE_LOG_MANAGER_COPY_MAX_BYTES_PER_SECOND_CONFIG);
    }

    public int remoteLogManagerCopyNumQuotaSamples() {
        return getInt(REMOTE_LOG_MANAGER_COPY_QUOTA_WINDOW_NUM_CONFIG);
    }

    public int remoteLogManagerCopyQuotaWindowSizeSeconds() {
        return getInt(REMOTE_LOG_MANAGER_COPY_QUOTA_WINDOW_SIZE_SECONDS_CONFIG);
    }

    public long remoteLogManagerFetchMaxBytesPerSecond() {
        return getLong(REMOTE_LOG_MANAGER_FETCH_MAX_BYTES_PER_SECOND_CONFIG);
    }

    public int remoteLogManagerFetchNumQuotaSamples() {
        return getInt(REMOTE_LOG_MANAGER_FETCH_QUOTA_WINDOW_NUM_CONFIG);
    }

    public int remoteLogManagerFetchQuotaWindowSizeSeconds() {
        return getInt(REMOTE_LOG_MANAGER_FETCH_QUOTA_WINDOW_SIZE_SECONDS_CONFIG);
    }
