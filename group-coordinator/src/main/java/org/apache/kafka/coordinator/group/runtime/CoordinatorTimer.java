...
public interface CoordinatorTimer<U> {
    /**
     * Generates the records nneded to implement this timeout write operation. In general,
    ...
    interface TimeoutOperation<U> {
        List<U> generateRecords() throws KafkaException;
    }
     ...
     */
    void schedule(String key, long delay, TimeUnit unit, TimeoutOperation<U> operation);
