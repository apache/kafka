...
public class CompositeReadOnlyKeyValueStoreTest {
    ...
    private KeyValueStore<String, String> newStoreInstance() {
        ...
        final InternalMockProcessorContext context = new InternalMockProcessorContext(new StateSerdes<>(ProcessorStateManager.storeChangelogTopic("appId", storeName, null),
