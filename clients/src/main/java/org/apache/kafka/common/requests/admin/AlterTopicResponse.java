...
public class AlterTopicResponse extends AbstractRequestResponse {
    private static final Schema CURRENT_SCHEMA = ProtoUtils.currentResponseSchema(ApiKeys.ALTER_TOPIC.id);
    ...
    public AlterTopicResponse(Map<String, Errors> errors) {
    ...
    public AlterTopicResponse(Struct struct) {
        super(struct);
    ...
    public static AlterTopicResponse parse(ByteBuffer buffer) {
        return new AlterTopicResponse((Struct) CURRENT_SCHEMA.read(buffer));
    }
}
