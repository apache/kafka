...
public class DistributedHerderTest extends ThreadedTest {
    ...
    @Test
    @Ignore(
            "When enabled, this test causes others in this test suite to hang. "
                    + "Trunk has been updated to handle this issue, but the changes "
                    + "required to accomplish that have not been backported. "
                    + "See https://github.com/apache/kafka/pull/12295, "
                    + "https://github.com/apache/kafka/pull/12828, and "
                    + "https://github.com/apache/kafka/pull/12817"
    )
