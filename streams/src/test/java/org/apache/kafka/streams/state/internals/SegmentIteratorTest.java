...
public class SegmentIteratorTest {
    ...
    private final KeyValueSegment segmentOne =
        new KeyValueSegment("one", "one", 0, SynchronizedPosition.emptyPosition(), rocksDBMetricsRecorder);
    private final KeyValueSegment segmentTwo =
        new KeyValueSegment("two", "window", 1, SynchronizedPosition.emptyPosition(), rocksDBMetricsRecorder);
