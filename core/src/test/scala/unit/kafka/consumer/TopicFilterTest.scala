...
class TopicFilterTest extends JUnitSuite {
  ...
  def testWhitelists() {
    ...
    assertFalse(topicFilter2.isTopicAllowed(CommonDefs.GROUP_METADATA_TOPIC_NAME, excludeInternalTopics = true))
    assertTrue(topicFilter2.isTopicAllowed(CommonDefs.GROUP_METADATA_TOPIC_NAME, excludeInternalTopics = false))
  ...
  def testBlacklists() {
    ...
    assertFalse(topicFilter1.isTopicAllowed(CommonDefs.GROUP_METADATA_TOPIC_NAME, excludeInternalTopics = true))
    assertTrue(topicFilter1.isTopicAllowed(CommonDefs.GROUP_METADATA_TOPIC_NAME, excludeInternalTopics = false))
  }
