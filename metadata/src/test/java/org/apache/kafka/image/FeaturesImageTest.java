...
public class FeaturesImageTest {
    ...
    static {
        ...
        IMAGE1 = new FeaturesImage(map1, MetadataVersion.latest(), ZkMigrationState.UNINITIALIZED);
        ...
        IMAGE2 = new FeaturesImage(map2, MetadataVersion.latest(), ZkMigrationState.UNINITIALIZED);
    }
