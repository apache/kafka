...
import org.apache.kafka.common.errors.{ApiException, ConfigurationMismatchException, OffsetNotAvailableException, ReplicaNotAvailableException}
...
class PartitionTest extends AbstractPartitionTest {
  ...
  def testAppendRecordsToLeaderThrowsExceptionWhenReplicationFactorLowerThanMinIsr(): Unit = {
    ...
    assertThrows[ConfigurationMismatchException] {
