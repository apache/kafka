...
public class CommonClientConfigs {
    ...
    public static final String METRICS_LOG_LEVEL_CONFIG = "metrics.log.level";
    public static final String METRICS_LOG_LEVEL_DOC = "The highest logging level for metrics.";
