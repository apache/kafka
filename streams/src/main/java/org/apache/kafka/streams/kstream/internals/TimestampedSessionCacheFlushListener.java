...
class TimestampedSessionCacheFlushListener<K, V> implements CacheFlushListener<Windowed<K>, ValueAndTimestamp<V>> {
    private final InternalProcessorContext context;
    private final ProcessorNode myNode;

    TimestampedSessionCacheFlushListener(final ProcessorContext context) {
