...
class LogLoaderTest {
  ...
  val producerStateManagerConfig: ProducerStateManagerConfig = new ProducerStateManagerConfig(JKafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT, false)
  val producerIdExpirationCheckIntervalMs: Int = JKafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT
  ...
  def testLogRecoveryIsCalledUponBrokerCrash(): Unit = {
    ...
    val producerIdExpirationCheckIntervalMs = JKafkaConfig.PRODUCER_ID_EXPIRATION_CHECK_INTERVAL_MS_DEFAULT
  ...
  def testRecoverAfterNonMonotonicCoordinatorEpochWrite(): Unit = {
    ...
    val maxProducerIdExpirationMs = JKafkaConfig.PRODUCER_ID_EXPIRATION_MS_DEFAULT
