...
public class PrintedTest {
    ...
    public void shouldCreateProcessorThatPrintsToFile() throws IOException {
        ...
        final TypedProcessorSupplier<String, Integer, Void, Void> processorSupplier = new PrintedInternal<>(
                Printed.<String, Integer>toFile(file.getPath()))
                .build("processor");
        final TypedProcessor<String, Integer, Void, Void> processor = processorSupplier.get();
    ...
    public void shouldCreateProcessorThatPrintsToStdOut() throws UnsupportedEncodingException {
        final TypedProcessorSupplier<String, Integer, Void, Void> supplier = new PrintedInternal<>(sysOutPrinter).build("processor");
        final TypedProcessor<String, Integer, Void, Void> processor = supplier.get();
    ...
    public void shouldPrintWithLabel() throws UnsupportedEncodingException {
        final TypedProcessor<String, Integer, Void, Void> processor = new PrintedInternal<>(sysOutPrinter.withLabel("label"))
                .build("processor")
                .get();
    ...
    public void shouldPrintWithKeyValueMapper() throws UnsupportedEncodingException {
        final TypedProcessor<String, Integer, Void, Void> processor = new PrintedInternal<>(sysOutPrinter.withKeyValueMapper(
