...
class FetchRequestTest extends BaseRequestTest {
  ...
  def testCreateIncrementalFetchWithPartitionsInError(): Unit = {
    ...
    assertTrue(resp2.responseData().containsKey(foo0))
    assertTrue(resp2.responseData().containsKey(foo1))
    ...
    assertTrue(resp3.responseData().containsKey(foo0))
    assertTrue(resp3.responseData().containsKey(foo1))
    ...
    assertTrue(resp4.responseData().containsKey(foo0))
    assertTrue(resp4.responseData().containsKey(foo1))
    assertTrue(resp4.responseData().containsKey(bar0))
  }
