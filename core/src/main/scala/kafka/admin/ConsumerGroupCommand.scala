...
object ConsumerGroupCommand extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    CommandLineUtils.printHelpAndExitIfNeeded(opts, "List all consumer groups, describe a consumer group, delete consumer group info, or reset consumer group offsets.")
