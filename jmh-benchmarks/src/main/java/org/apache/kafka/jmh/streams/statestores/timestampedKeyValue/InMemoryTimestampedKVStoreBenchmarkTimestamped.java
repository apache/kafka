...
public class InMemoryTimestampedKVStoreBenchmarkTimestamped extends TimestampedKeyValueStateStoreBenchmark {

    @Setup(Level.Trial)
    public void setUp() {
        storeKeys();
        this.timestampedKeyValueStore = Stores.timestampedKeyValueStoreBuilder(Stores.inMemoryKeyValueStore("in-memory"),
            Serdes.String(),
            Serdes.String())
            .withCachingDisabled()
            .withLoggingDisabled()
