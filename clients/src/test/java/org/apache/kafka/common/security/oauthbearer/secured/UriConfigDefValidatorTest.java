...
public class UriConfigDefValidatorTest extends ConfigDefValidatorTest {
    ...
    public void testMissingScheme() {
        assertThrowsWithMessage(ConfigException.class, () -> ensureValid("www.example.com"), "missing the scheme");
    }

    @Test
    public void testInvalidScheme() {
        assertThrowsWithMessage(ConfigException.class, () -> ensureValid("ftp://www.example.com"), "invalid scheme");
    }
