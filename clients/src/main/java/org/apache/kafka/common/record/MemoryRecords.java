...
public class MemoryRecords extends AbstractRecords {
    ...
    private static MemoryRecordsBuilder buildRetainedRecordsInto(RecordBatch originalBatch,
        ...
        CompressionConfig compressionConfig = CompressionConfig.of(originalBatch.compressionType());
    ...
    public static MemoryRecords withRecords(CompressionType compressionType, int partitionLeaderEpoch, SimpleRecord... records) {
        return withRecords(RecordBatch.CURRENT_MAGIC_VALUE, 0L, CompressionConfig.of(compressionType), TimestampType.CREATE_TIME,
    ...
    public static MemoryRecords withRecords(long initialOffset, CompressionType compressionType, SimpleRecord... records) {
        return withRecords(RecordBatch.CURRENT_MAGIC_VALUE, initialOffset, CompressionConfig.of(compressionType), TimestampType.CREATE_TIME,
                records);
    }
    ...
    public static MemoryRecords withRecords(byte magic, long initialOffset, CompressionType compressionType, SimpleRecord... records) {
        return withRecords(magic, initialOffset, CompressionConfig.of(compressionType), TimestampType.CREATE_TIME, records);
    }
    ...
    public static MemoryRecords withIdempotentRecords(CompressionType compressionType, long producerId,
        ...
        return withRecords(RecordBatch.CURRENT_MAGIC_VALUE, 0L, CompressionConfig.of(compressionType), TimestampType.CREATE_TIME, producerId, producerEpoch,
