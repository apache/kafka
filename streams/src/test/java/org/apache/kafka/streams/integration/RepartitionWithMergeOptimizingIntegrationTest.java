...
public class RepartitionWithMergeOptimizingIntegrationTest {
    ...
    private static final String EXPECTED_OPTIMIZED_TOPOLOGY = "Topologies:\n"
                                                              ...
                                                              + "    TypedProcessor: KSTREAM-MAP-0000000002 (stores: [])\n"
                                                              + "      --> KSTREAM-MERGE-0000000004\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000000\n"
                                                              + "    TypedProcessor: KSTREAM-MAP-0000000003 (stores: [])\n"
                                                              + "      --> KSTREAM-MERGE-0000000004\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000001\n"
                                                              + "    TypedProcessor: KSTREAM-MERGE-0000000004 (stores: [])\n"
                                                              + "      --> KSTREAM-FILTER-0000000021\n"
                                                              + "      <-- KSTREAM-MAP-0000000002, KSTREAM-MAP-0000000003\n"
                                                              + "    TypedProcessor: KSTREAM-FILTER-0000000021 (stores: [])\n"
                                                              ...
                                                              + "    TypedProcessor: KSTREAM-AGGREGATE-0000000013 (stores: [KSTREAM-AGGREGATE-STATE-STORE-0000000012])\n"
                                                              + "      --> KTABLE-TOSTREAM-0000000017\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000022\n"
                                                              + "    TypedProcessor: KSTREAM-AGGREGATE-0000000006 (stores: [KSTREAM-AGGREGATE-STATE-STORE-0000000005])\n"
                                                              + "      --> KTABLE-TOSTREAM-0000000010\n"
                                                              + "      <-- KSTREAM-SOURCE-0000000022\n"
                                                              + "    TypedProcessor: KTABLE-TOSTREAM-0000000017 (stores: [])\n"
                                                              + "      --> KSTREAM-MAPVALUES-0000000018\n"
                                                              + "      <-- KSTREAM-AGGREGATE-0000000013\n"
                                                              + "    TypedProcessor: KSTREAM-MAPVALUES-0000000018 (stores: [])\n"
                                                              + "      --> KSTREAM-SINK-0000000019\n"
                                                              + "      <-- KTABLE-TOSTREAM-0000000017\n"
                                                              + "    TypedProcessor: KTABLE-TOSTREAM-0000000010 (stores: [])\n"
    ...
    private static final String EXPECTED_UNOPTIMIZED_TOPOLOGY = "Topologies:\n"
                                                                ...
                                                                + "      <-- KSTREAM-MAP-0000000002, KSTREAM-MAP-0000000003\n"
                                                                + "    TypedProcessor: KSTREAM-FILTER-0000000008 (stores: [])\n"
                                                                + "      --> KSTREAM-SINK-0000000007\n"
                                                                + "      <-- KSTREAM-MERGE-0000000004\n"
                                                                + "    TypedProcessor: KSTREAM-FILTER-0000000015 (stores: [])\n"
